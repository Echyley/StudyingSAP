...
<body>
	...
	<div class="span-6 last" id="sidebar">
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<div class="quiet">
					This page provides the list of existing tenants. Here you can also activate a given tenant or view the list of active extensions for a given tenant.</br></br>
			...
			<div class="box">
				<div class="quiet">
					...
					<ul>
						 <li> <a href="${wikiSpringInHybrisCommerceSuite}" target="_blank" rel="noopener noreferrer" class="quiet">Spring Framework in SAP Commerce</a> </li>
					</ul>
				</div>
			</div>		
		</div>
