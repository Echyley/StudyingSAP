    ...
    <c:choose>
        <c:when test="${ scriptData != null }">
            <c:choose>
                ...
                <c:otherwise>
                    <span id="uploadResult" data-level="error" data-result="${scriptData.exception}"></span>
                </c:otherwise>
            </c:choose>
        </c:when>
    </c:choose>
		...
		<div class="prepend-top span-17 colborder" id="content" encryptUrl="<c:url value="/console/encrypt" />" decryptUrl="<c:url value="/console/decrypt" />">
			...
			<div class="marginLeft">
                ...
                <div id="tabsNoSidebar">
					...
					<div id="tabs-edit">
						<br/>
                        <c:set var="saveScriptUrl">
                            <c:url value="/console/scripting/save"/>
                        </c:set>
						<form:form action="${saveScriptUrl}" method="post">
...
return "Groovy Rocks!"</c:otherwise></c:choose></textarea>
                    ...
                    <div id="tabs-browse" >
                        ...
                        <form:form method="post" action="${fileImportUrl}" modelAttribute="scriptFileFormData"
		...
		<div class="span-6 last" id="sidebar">
			<div class="prepend-top" id="recent-reviews">
                ...
                <div class="box">
                    <ul>
                        <li><a href="${scriptingHelpUrl}" target="_blank" rel="noopener noreferrer" class="quiet">Scripting Engine</a></li>
                    </ul>
                </div>
			</div>
		</div>
