...
<head>
	...
	<script type="text/javascript" src="<c:url value="/static/js/monitoring/database.js?p=1"/>"></script>
</head>
	<body>
						...
						<div id="tabs-3">
							...
							<div id="loggingContentWrapper" data-refreshLoggingInfoUrl="<c:url value="/monitoring/database/logs/"/>">
								<p>
                                    ...
                                    <button id="toggleParams" class="floatLeft" data-url="<c:url value="/monitoring/database/params/"/>"></button>
			...
			<div class="span-6 last" id="sidebar3">
				<div class="prepend-top">
					...
					<div class="box">
						<ul>
							<li> <a href="${wikiJdbcLogging}" target="_blank" rel="noopener noreferrer" class="quiet" >JDBC Logs from Database Statements</a> </li>
						</ul>
					</div>
				</div>
			</div>		
