...
<body>
					...
					<form:form method="post" action="${url}" modelAttribute="flexQueryForm">
						...
						<fieldset>
							<p>
								...
								&nbsp;
								<form:label path="dataSource" for="dataSource1"><spring:message code="console.flexsearch.forms.labels.dataSource" /></form:label>
								<form:select path="dataSource" items="${existingDataSources}" id="dataSource1" />
							</p>
							<hr/>
							<p>
				...
				<div id="tabs-2">
						...
						<fieldset>
							<p>
                                ...
                                &nbsp;
                                <form:label path="dataSource" for="dataSource2"><spring:message code="console.flexsearch.forms.labels.dataSource" /></form:label>
                                <form:select path="dataSource" items="${existingDataSources}" id="dataSource2" />
							</p>
							<hr/>
							<p>
								<div class="onoffswitch-large" style="float:left;margin-top:7px">
	...
	<div class="span-6 last" id="sidebar">
		...
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<div class="quiet">
				 This page provides the FlexibleSearch console to test FlexibleSearch queries and plain SQL statements. FlexibleSearch queries can be executed on selected data source. For more complex queries, data source of read only type is recommended if available.
                    <br><br><hr />
			...
			<div class="box">
				<ul>
					<li> <a href="${wikiFlexibleSearch}" target="_blank" rel="noopener noreferrer" class="quiet" >FlexibleSearch</a> </li>
				</ul>
			</div>
		</div>
	</div>
