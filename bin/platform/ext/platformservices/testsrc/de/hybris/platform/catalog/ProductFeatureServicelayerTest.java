...
public class ProductFeatureServicelayerTest extends ServicelayerBaseTest
{
	...
	private final String value = "This is the String value for ProductFeature";
	...
	@Test
	public void shouldSaveProductFeatureAs_Jalo_AndReadAs_SLD()
	{
		persistenceLegacyMode.switchToValue("true");
		final ProductFeatureModel featureModel = createProductFeatureWithStringValue(value);
		persistenceLegacyMode.switchToValue("false");

		assertThat(featureModel.getValue()).isNotNull();
		assertThat(featureModel.getValue()).isEqualTo(value);
		assertThat(featureModel.getProduct()).isEqualTo(productModel);
	}

	@Test
	public void shouldSaveProductFeatureAs_SLD_AndReadAs_SLD()
	{
		persistenceLegacyMode.switchToValue("false");
		final ProductFeatureModel featureModel = createProductFeatureWithStringValue(value);
	...
	@Test
	public void shouldSaveProductFeatureAs_Jalo_AndReadAs_Jalo()
	{
		persistenceLegacyMode.switchToValue("true");
		final ProductFeatureModel featureModel = createProductFeatureWithStringValue(value);
	...
	@Test
	public void shouldSaveProductFeatureAs_SLD_AndReadAs_Jalo()
	{
		persistenceLegacyMode.switchToValue("false");
		final ProductFeatureModel featureModel = createProductFeatureWithStringValue(value);
		persistenceLegacyMode.switchToValue("true");
	...
	private ProductFeatureModel createProductFeatureWithStringValue(final String value)
	{
		final ProductFeatureModel feature = modelService.create(ProductFeatureModel.class);
		feature.setClassificationAttributeAssignment(caam);
		feature.setValue(value);
