...
public class ClassAttributeAssignmentModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ClassAttributeAssignment.referenceType</code> attribute defined at extension <code>catalog</code>. */
	public static final String REFERENCETYPE = "referenceType";
	
	/** <i>Generated constant</i> - Attribute key of <code>ClassAttributeAssignment.referenceIncludesSubTypes</code> attribute defined at extension <code>catalog</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ClassAttributeAssignment.referenceIncludesSubTypes</code> attribute defined at extension <code>catalog</code>. 
	 * @return the referenceIncludesSubTypes
	 */
	@Accessor(qualifier = "referenceIncludesSubTypes", type = Accessor.Type.GETTER)
	public Boolean getReferenceIncludesSubTypes()
	{
		return getPersistenceContext().getPropertyValue(REFERENCEINCLUDESSUBTYPES);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>ClassAttributeAssignment.referenceType</code> attribute defined at extension <code>catalog</code>. 
	...
	/**
	 * <i>Generated method</i> - Setter of <code>ClassAttributeAssignment.referenceIncludesSubTypes</code> attribute defined at extension <code>catalog</code>. 
	 *  
	 * @param value the referenceIncludesSubTypes
	 */
	@Accessor(qualifier = "referenceIncludesSubTypes", type = Accessor.Type.SETTER)
	public void setReferenceIncludesSubTypes(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(REFERENCEINCLUDESSUBTYPES, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>ClassAttributeAssignment.referenceType</code> attribute defined at extension <code>catalog</code>. 
	 *  
	 * @param value the referenceType
	 */
	@Accessor(qualifier = "referenceType", type = Accessor.Type.SETTER)
	public void setReferenceType(final ComposedTypeModel value)
	{
