...
public class ImpExMediaModel extends MediaModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>ImpExMedia.extractionId</code> attribute defined at extension <code>impex</code>. */
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public ImpExMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final String _extractionId, final int _linesToSkip, final ItemModel _owner, final boolean _removeOnSuccess)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ImpExMedia.extractionId</code> attribute defined at extension <code>impex</code>. 
	 * @return the extractionId - Unique Id of zip extraction process
	 */
	@Accessor(qualifier = "extractionId", type = Accessor.Type.GETTER)
	public String getExtractionId()
	{
		return getPersistenceContext().getPropertyValue(EXTRACTIONID);
	}
	...
	/**
	 * <i>Generated method</i> - Initial setter of <code>ImpExMedia.extractionId</code> attribute defined at extension <code>impex</code>. Can only be used at creation of model - before first save.  
	 *  
	 * @param value the extractionId - Unique Id of zip extraction process
	 */
	@Accessor(qualifier = "extractionId", type = Accessor.Type.SETTER)
	public void setExtractionId(final String value)
	{
