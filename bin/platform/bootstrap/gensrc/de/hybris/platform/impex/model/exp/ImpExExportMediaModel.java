...
public class ImpExExportMediaModel extends ImpExMediaModel
{
	 ...
	 */
	@Deprecated(since = "4.1.1", forRemoval = true)
	public ImpExExportMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final String _extractionId, final int _linesToSkip, final ItemModel _owner, final boolean _removeOnSuccess)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
