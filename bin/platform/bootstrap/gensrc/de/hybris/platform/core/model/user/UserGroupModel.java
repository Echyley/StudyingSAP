...
public class UserGroupModel extends PrincipalGroupModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>UserGroup.denyWritePermissionForAllLanguages</code> attribute defined at extension <code>core</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>UserGroup.denyWritePermissionForAllLanguages</code> attribute defined at extension <code>core</code>. 
	 * @return the denyWritePermissionForAllLanguages - When true and writeableLanguages is empty, deny any write permissions,
	 *                         instead of setting same as readableLanguages.
	 */
	...
	{
		return getPersistenceContext().getPropertyValue(DENYWRITEPERMISSIONFORALLLANGUAGES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>UserGroup.denyWritePermissionForAllLanguages</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the denyWritePermissionForAllLanguages - When true and writeableLanguages is empty, deny any write permissions,
	 *                         instead of setting same as readableLanguages.
	 */
	@Accessor(qualifier = "denyWritePermissionForAllLanguages", type = Accessor.Type.SETTER)
	public void setDenyWritePermissionForAllLanguages(final Boolean value)
	{
