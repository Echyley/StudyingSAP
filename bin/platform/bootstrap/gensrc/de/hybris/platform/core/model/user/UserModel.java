...
public class UserModel extends PrincipalModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>User.randomToken</code> attribute defined at extension <code>core</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>User.randomToken</code> attribute defined at extension <code>core</code>. 
	 * @return the randomToken - Random part of login token
	 */
	@Accessor(qualifier = "randomToken", type = Accessor.Type.GETTER)
	public String getRandomToken()
	{
		return getPersistenceContext().getPropertyValue(RANDOMTOKEN);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>User.randomToken</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the randomToken - Random part of login token
	 */
	@Accessor(qualifier = "randomToken", type = Accessor.Type.SETTER)
	public void setRandomToken(final String value)
	{
