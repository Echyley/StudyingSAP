...
public class RendererTemplateModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>RendererTemplate.defaultContent</code> attribute defined at extension <code>commons</code>. */
	...
	/** <i>Generated constant</i> - Attribute key of <code>RendererTemplate.defaultTemplateScript</code> attribute defined at extension <code>commons</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>RendererTemplate.defaultContent</code> attribute defined at extension <code>commons</code>. 
	 * @return the defaultContent
	 */
	@Accessor(qualifier = "defaultContent", type = Accessor.Type.GETTER)
	public MediaModel getDefaultContent()
	{
		return getPersistenceContext().getPropertyValue(DEFAULTCONTENT);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>RendererTemplate.defaultTemplateScript</code> dynamic attribute defined at extension <code>commons</code>. 
	 * @return the defaultTemplateScript
	 */
	@Accessor(qualifier = "defaultTemplateScript", type = Accessor.Type.GETTER)
	public String getDefaultTemplateScript()
	{
		return getPersistenceContext().getDynamicValue(this,DEFAULTTEMPLATESCRIPT);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>RendererTemplate.defaultContent</code> attribute defined at extension <code>commons</code>. 
	 *  
	 * @param value the defaultContent
	 */
	@Accessor(qualifier = "defaultContent", type = Accessor.Type.SETTER)
	public void setDefaultContent(final MediaModel value)
	{
		getPersistenceContext().setPropertyValue(DEFAULTCONTENT, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>RendererTemplate.defaultTemplateScript</code> dynamic attribute defined at extension <code>commons</code>. 
	 *  
	 * @param value the defaultTemplateScript
	 */
	@Accessor(qualifier = "defaultTemplateScript", type = Accessor.Type.SETTER)
	public void setDefaultTemplateScript(final String value)
	{
		getPersistenceContext().setDynamicValue(this,DEFAULTTEMPLATESCRIPT, value);
	}
