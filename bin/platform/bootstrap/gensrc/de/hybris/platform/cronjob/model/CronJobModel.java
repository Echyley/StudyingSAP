...
public class CronJobModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CronJob.useReadOnlyDatasource</code> attribute defined at extension <code>processing</code>. */
	public static final String USEREADONLYDATASOURCE = "useReadOnlyDatasource";
	
	/** <i>Generated constant</i> - Attribute key of <code>CronJob.numberOfRetries</code> attribute defined at extension <code>processing</code>. */
	public static final String NUMBEROFRETRIES = "numberOfRetries";
	
	/** <i>Generated constant</i> - Attribute key of <code>CronJob.currentRetry</code> attribute defined at extension <code>processing</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CronJob.currentRetry</code> attribute defined at extension <code>processing</code>. 
	 * @return the currentRetry - Shows current repeat of the cron job
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CronJob.numberOfRetries</code> attribute defined at extension <code>processing</code>. 
	 * @return the numberOfRetries - Determine whether cron job should be repeated and how many times in case of an database connection failure
	 */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CronJob.useReadOnlyDatasource</code> attribute defined at extension <code>processing</code>. 
	 * @return the useReadOnlyDatasource
	 */
	@Accessor(qualifier = "useReadOnlyDatasource", type = Accessor.Type.GETTER)
	public Boolean getUseReadOnlyDatasource()
	{
		return getPersistenceContext().getPropertyValue(USEREADONLYDATASOURCE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CronJob.currentRetry</code> attribute defined at extension <code>processing</code>. 
	 *  
	 * @param value the currentRetry - Shows current repeat of the cron job
	 */
	@Accessor(qualifier = "currentRetry", type = Accessor.Type.SETTER)
	public void setCurrentRetry(final int value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CronJob.numberOfRetries</code> attribute defined at extension <code>processing</code>. 
	 *  
	 * @param value the numberOfRetries - Determine whether cron job should be repeated and how many times in case of an database connection failure
	 */
	@Accessor(qualifier = "numberOfRetries", type = Accessor.Type.SETTER)
	public void setNumberOfRetries(final int value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CronJob.useReadOnlyDatasource</code> attribute defined at extension <code>processing</code>. 
	 *  
	 * @param value the useReadOnlyDatasource
	 */
	@Accessor(qualifier = "useReadOnlyDatasource", type = Accessor.Type.SETTER)
	public void setUseReadOnlyDatasource(final Boolean value)
	{
