...
public class DefaultSapquoteintegrationomsService implements SapquoteintegrationomsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapquoteintegrationomsService.class);
	...
	{
		return DefaultSapquoteintegrationomsService.class.getResourceAsStream("/sapquoteintegrationoms/sap-hybris-platform.png");
	}
