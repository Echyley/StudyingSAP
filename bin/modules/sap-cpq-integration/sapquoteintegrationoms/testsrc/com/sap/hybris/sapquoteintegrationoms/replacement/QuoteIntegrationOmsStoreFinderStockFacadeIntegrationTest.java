...
public class QuoteIntegrationOmsStoreFinderStockFacadeIntegrationTest extends StoreFinderStockFacadeIntegrationTest {
    ...
    private void insertExtraInformation() throws ImpExException {
        importCsv("/sapquoteintegrationoms/test/impex/replacement/replacement-store-finder-stock-test-data.impex", "utf-8");
