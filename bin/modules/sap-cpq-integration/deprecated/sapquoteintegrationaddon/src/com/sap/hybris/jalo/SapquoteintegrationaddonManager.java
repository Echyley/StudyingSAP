...
import com.sap.hybris.constants.SapquoteintegrationaddonConstants;



/**
 * This is the extension manager of the Sapquoteintegrationaddon extension.
 */
public class SapquoteintegrationaddonManager extends GeneratedSapquoteintegrationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapquoteintegrationaddonManager.class.getName());
	 ...
	 */
	public static SapquoteintegrationaddonManager getInstance()
	{
		return (SapquoteintegrationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapquoteintegrationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapquoteintegrationaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapquoteintegrationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapquoteintegrationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapquoteintegrationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
