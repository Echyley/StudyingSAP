 ...
 */
@UnitTest
public class SapCpiQuoteBuyerSubmitEventListenerTest {

    @InjectMocks
    private SapCpiQuoteBuyerSubmitEventListener listner = new SapCpiQuoteBuyerSubmitEventListener();
    @Mock
    ...
    public void testOnEvent() {
        SapCpiQuoteBuyerSubmitEvent event = mock(SapCpiQuoteBuyerSubmitEvent.class);
