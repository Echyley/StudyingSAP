...
/**
 * This is the extension manager of the Sapquoteintegration extension.
 */
public class SapquoteintegrationManager extends GeneratedSapquoteintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapquoteintegrationManager.class);
	...
	{
		return (SapquoteintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapquoteintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapquoteintegrationManager() // NOPMD 
	{
		LOG.debug("constructor of SapquoteintegrationManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapquoteintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapquoteintegrationManager called, current tenant: {}", getTenant().getTenantID());
	}
