...
/**
 * The <code>CacheAccessService</code> provides the direct access to a cache region.
 * 
 * @param <K>
 *           key
 * @param <V>
 *           value
 */
public interface CacheAccessService<K, V>
{
	/**
	...
	/**
	 * Gets a value from the cache for the given key. If the value is not present in the cache the supplier will be
	 * called and the returned value will be cached.
	 *
	 * @param key
	 *           key of value
	 * @param supplier
