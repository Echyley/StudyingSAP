...
@UnitTest
class KeyAttributeValueUnitTest extends JUnitPlatformSpecification {
    @Test
    ...
    def "is not equal when the other value #condition"() {
        ...
        'had different type'       | new IntegrationObjectItemAttributeModel(attributeName: 'one')
        'is null'                  | null
    }
    ...
    def attribute(String name) {
        new KeyAttribute(attributeDescriptor(name))
    }

    private TypeAttributeDescriptor attributeDescriptor(String name) {
