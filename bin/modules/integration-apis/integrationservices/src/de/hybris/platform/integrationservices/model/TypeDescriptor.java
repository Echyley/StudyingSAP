 ...
 * This metadata can be used for converting a custom payload to and from the platform's {@link ItemModel}.
 */
public interface TypeDescriptor
{
	 ...
	 * @return type code of the item in the type system. Keep in mind this value may be different from the integration object item
	 ...
	 * @see #isRoot()
	 * @see IntegrationObjectDescriptor#getRootType()
	 */
	List<ReferencePath> getPathsToRoot();

	/**
	 * Determines whether it's possible to navigate from an integration item or class described by this type descriptor to the
	 * root item/class of the integration object.
	 * @return {@code true}, if this type descriptor describes a root item type/class in the integration object, or it has a
	 * {@link ReferencePath} to the root.
	 * @see #isRoot()
	 * @see IntegrationObjectDescriptor#getRootType()
	 * @see #getPathsToRoot()
	 */
	 ...
	 * path or an empty list, if this type descriptor and the specified item type are not related, i.e. there is no a single path.
	 */
