...
import de.hybris.platform.integrationbackoffice.widgets.modeling.handlers.IntegrationObjectClassificationClassWizardHandler;
...
public class ClassificationAttributesWithoutLocalizationRendererTest extends ClassificationAttributesWithoutLocalizationRenderer
{
	...
	public void shouldRenderUseFullQualifierCheckboxOnWizard()
	{
		...
		// then
		assertThat(parent.query(".use-full-qualifier-container")).as("Use full qualifier contains is rendered").isNotNull();
		assertThat(parent.query(".use-full-qualifier-container").query(".ye-switch-checkbox"))
