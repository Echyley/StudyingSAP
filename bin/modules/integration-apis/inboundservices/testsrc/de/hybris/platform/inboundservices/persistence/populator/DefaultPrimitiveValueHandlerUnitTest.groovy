...
@UnitTest
class DefaultPrimitiveValueHandlerUnitTest extends JUnitPlatformSpecification {
    ...
    def "convert payload value with non-localized #clazz.simpleName attribute"() {
        ...
        Class      | getClass().getName()   | getClass()
    }
    ...
    def "convert payload value with localized #type.simpleName attribute having [en:#enValue, fr:#frValue] value"() {
        ...
        expect:
        handler.convert(descriptor, LocalizedValue.of(Locale.ENGLISH, enValue).combine(Locale.FRENCH, frValue)) ==
                [(Locale.ENGLISH): expectEnValue, (Locale.FRENCH): expectedFrValue]
        ...
        Class      | getClass().getName()                 | getClass().getName()                | getClass()            | getClass()
    }
    ...
    @Test
    def "convert value with invalid class type throws InvalidClassTypeException"() {
        given:
        def descriptor = attributeDescriptor Class
        def invalidClassType = 'some.invalid.class.type'

        when:
        handler.convert(descriptor, invalidClassType)

        then:
        def e = thrown InvalidClassTypeException
        e.message.contains invalidClassType
    }
