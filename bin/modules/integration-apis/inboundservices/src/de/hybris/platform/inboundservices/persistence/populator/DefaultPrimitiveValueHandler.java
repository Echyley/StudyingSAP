...
public class DefaultPrimitiveValueHandler implements PrimitiveValueHandler
{
	...
	private final List<ValueHandler> handlers =
			Lists.newArrayList(
					new ClassValueHandler(),
					new CalendarValueHandler(),
					new LocalizedValueHandler(),
					new CharacterValueHandler(),
	...
	private static class ClassValueHandler implements ValueHandler
	{
		@Override
		public boolean isApplicable(final TypeAttributeDescriptor attribute, final Object value)
		{
			return value instanceof String
					&& attribute.getAttributeType().getTypeCode().equals(Class.class.getName());
		}
		...
		public Object handleAttribute(final TypeAttributeDescriptor attribute, final Object value)
		{
			...
			{
				throw new InvalidClassTypeException(attribute, value);
			}
		}
	}
