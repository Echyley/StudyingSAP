...
public class SimplePropertyGenerator implements SchemaElementGenerator<SimpleProperty, TypeAttributeDescriptor>
{
	...
	public SimpleProperty generate(@NotNull final TypeAttributeDescriptor descriptor)
	{
		return new SimpleProperty()
				...
				.setType(EdmTypeUtils.convert(descriptor.getAttributeType().getItemCode()))
	...
	public void setAnnotationsGenerator(
			final SchemaElementGenerator<List<AnnotationAttribute>, TypeAttributeDescriptor> generator)
	{
