...
/**
 * This is the extension manager of the Sapproductavailability extension.
 */
public class SapproductavailabilityManager extends GeneratedSapproductavailabilityManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductavailabilityManager.class.getName());
	 ...
	 */
	public static SapproductavailabilityManager getInstance()
	{
		return (SapproductavailabilityManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproductavailabilityConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductavailabilityManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductavailabilityManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductavailabilityManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductavailabilityManager called, current tenant: " + getTenant().getTenantID());
		}
	}
