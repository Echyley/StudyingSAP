 ...
 */
package de.hybris.platform.sap.sapproductavailabilitybackoffice.jalo;
...
import de.hybris.platform.sap.sapproductavailabilitybackoffice.constants.SapproductavailabilitybackofficeConstants;
 ...
 */
public class SapproductavailabilitybackofficeManager extends GeneratedSapproductavailabilitybackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductavailabilitybackofficeManager.class.getName());
	 ...
	 */
	public static SapproductavailabilitybackofficeManager getInstance()
	{
		return (SapproductavailabilitybackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductavailabilitybackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductavailabilitybackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of sapproductavailabilitybackofficeManager called.");
		}
	}
