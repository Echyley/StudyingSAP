...
import de.hybris.platform.sap.b2bsapproductavailability.constants.B2bsapproductavailabilityConstants;



/**
 * This is the extension manager of the B2bsapproductavailability extension.
 */
public class B2bsapproductavailabilityManager extends GeneratedB2bsapproductavailabilityManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bsapproductavailabilityManager.class.getName());
	 ...
	 */
	public static B2bsapproductavailabilityManager getInstance()
	{
		return (B2bsapproductavailabilityManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2bsapproductavailabilityConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bsapproductavailabilityManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bsapproductavailabilityManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bsapproductavailabilityManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bsapproductavailabilityManager called, current tenant: " + getTenant().getTenantID());
		}
	}
