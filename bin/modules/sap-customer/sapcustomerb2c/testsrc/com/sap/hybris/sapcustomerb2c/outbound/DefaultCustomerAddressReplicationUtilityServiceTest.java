...
public class DefaultCustomerAddressReplicationUtilityServiceTest {
  ...
  public void findDefaultAddressAfterSettingDefaultFlagToTrue() {
  	...
  	Mockito.lenient().when(defaultAddressModel.getVisibleInAddressBook()).thenReturn(true);
  	Mockito.lenient().when(addressModel.getVisibleInAddressBook()).thenReturn(true);
  	Mockito.lenient().when(customerAccountService.getAddressBookEntries(any())).thenReturn(Arrays.asList(addressModel, defaultAddressModel));
