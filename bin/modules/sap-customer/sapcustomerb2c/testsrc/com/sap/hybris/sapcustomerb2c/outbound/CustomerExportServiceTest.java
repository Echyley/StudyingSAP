...
public class CustomerExportServiceTest implements CustomerConstantsUtils
{
	...
	public void checkIfCustomerIsTransferredCorrectly()
	{
		...
		given(spyCustomerExportService.getBatchIdAttributes()).willReturn(batchIdAttributes);
	...
	public void checkIfCustomerIsTransferredCorrectlyInTwoCalls()
	{
		...
		Map<String, String> batchIdAttributes = new HashMap<String, String>();
		batchIdAttributes.put("dh_bacthId", "000001");
		batchIdAttributes.put("dh_sourceId", "HYBRIS");
		batchIdAttributes.put("dh_type", "DH_TYPE");
	...
	public void checkIfMapIsCorrecltyForAddress()
	{
		...
		given(regionModel.getIsocodeShort()).willReturn(REGION);
		final Map<String, Object> target = new HashMap<String, Object>();
