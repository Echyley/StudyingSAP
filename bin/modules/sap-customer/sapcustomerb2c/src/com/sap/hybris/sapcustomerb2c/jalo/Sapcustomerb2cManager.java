 ...
 */
package com.sap.hybris.sapcustomerb2c.jalo;
...
/**
 * This is the extension manager of the Sapcustomerb2c extension.
 */
public class Sapcustomerb2cManager extends GeneratedSapcustomerb2cManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapcustomerb2cManager.class.getName());
	 ...
	 */
	public static Sapcustomerb2cManager getInstance()
	{
		return (Sapcustomerb2cManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapcustomerb2cConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapcustomerb2cManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapcustomerb2cManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapcustomerb2cManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapcustomerb2cManager called, current tenant: " + getTenant().getTenantID());
		}
	}
