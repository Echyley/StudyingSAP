...
/**
 * This is the extension manager of the Sapcustomerb2b extension.
 */
public class Sapcustomerb2bManager extends GeneratedSapcustomerb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapcustomerb2bManager.class.getName());
	 ...
	 */
	public static Sapcustomerb2bManager getInstance()
	{
		return (Sapcustomerb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapcustomerb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapcustomerb2bManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapcustomerb2bManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapcustomerb2bManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapcustomerb2bManager called, current tenant: " + getTenant().getTenantID());
		}
	}
