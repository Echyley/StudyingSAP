...
public class B2BCustomerRegistrationEventListener extends AbstractEventListener<B2BRegistrationEvent>
{
	...
	{
		LOGGER.warn("The SAP B2BRegistrationEvent listener B2BCustomerRegistrationEventListener has been deprecated and the onEvent logic is removed!");
	}

	protected void onEventDeprecated(final B2BRegistrationEvent registerEvent)
	{
