...
public class DefaultB2BCustomerAddressInterceptorTest {
  ...
  public void testExportDataIfPhoneIsModified() throws InterceptorException {
    ...
    Mockito.lenient().when(addressModel.getPublicKey()).thenReturn(PUBLIC_KEY);
    ...
    Mockito.lenient().when(b2bCustomerModel.getDefaultShipmentAddress()).thenReturn(addressModel);
