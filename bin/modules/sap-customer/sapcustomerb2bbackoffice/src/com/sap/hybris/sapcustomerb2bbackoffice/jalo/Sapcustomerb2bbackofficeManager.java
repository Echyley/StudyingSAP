 ...
 */
package com.sap.hybris.sapcustomerb2bbackoffice.jalo;
...
import com.sap.hybris.sapcustomerb2bbackoffice.constants.Sapcustomerb2bbackofficeConstants;
 ...
 */
public class Sapcustomerb2bbackofficeManager extends GeneratedSapcustomerb2bbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapcustomerb2bbackofficeManager.class.getName());
	 ...
	 */
	public static Sapcustomerb2bbackofficeManager getInstance()
	{
		return (Sapcustomerb2bbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapcustomerb2bbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapcustomerb2bbackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapcustomerb2bbackofficeManager called.");
		}
	}
