...
public class DefaultSyncConfigServiceTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldCreateDefaultColumnDefintionsForComposedType() throws Exception
	{
		...
		// then
		final ColumnDefinitionsAssert columnDefinitionsAssert = assertThat(defaultColumnDefinitions).hasSize(5);

		columnDefinitionsAssert.containsDefintionFor(titleDescriptor("owner")) //
		                       .withoutLanguage() //
		                       .withColumnName("owner") //
		                       .withImpexHeader("owner()");
		columnDefinitionsAssert.containsDefintionFor(titleDescriptor("creationtime")) //
		                       .withoutLanguage() //
		                       .withColumnName("creationtime") //
		                       .withImpexHeader("creationtime[dateformat=dd.MM.yyyy hh:mm:ss]");
		columnDefinitionsAssert.containsDefintionFor(titleDescriptor("name")) //
		                       .withLanguage(currentLang) //
		                       .withColumnName("name_en") //
		                       .withImpexHeader("name[lang=en]");
		columnDefinitionsAssert.containsDefintionFor(titleDescriptor("modifiedtime")) //
		                       .withoutLanguage() //
		                       .withColumnName("modifiedtime") //
		                       .withImpexHeader("modifiedtime[dateformat=dd.MM.yyyy hh:mm:ss]");
		columnDefinitionsAssert.containsDefintionFor(titleDescriptor("code")) //
		                       .withoutLanguage() //
		                       .withColumnName("code") //
		                       .withImpexHeader("code[unique=true]");
	}
