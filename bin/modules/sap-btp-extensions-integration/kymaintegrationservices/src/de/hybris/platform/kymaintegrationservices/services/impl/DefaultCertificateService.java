...
public class DefaultCertificateService implements CertificateService
{
			...
			final ConsumedCertificateCredentialModel certificationCredential) throws CredentialException
	{
		...
		try
		{
			...
			final KymaApiData apiData = Objects.requireNonNull(kymaSecurityData).getApi();
			...
			throws CredentialException
	{
		...
		return Objects.requireNonNull(response.getBody()).getCertificate();
	}
			...
			throws CredentialException
	{
		...
		return Objects.requireNonNull(response.getBody()).getCrt();
	}
