...
@IntegrationTest
public class KymaEventEmitTaskRunnerTest extends ServicelayerTransactionalTest
{
    ...
    private final int maxConsecutiveRetries = Config.getInt(MAX_CONSECUTIVE_RETRIES, 3);
    private final int maxRetries = Config.getInt(MAX_RETRIES, 3);
