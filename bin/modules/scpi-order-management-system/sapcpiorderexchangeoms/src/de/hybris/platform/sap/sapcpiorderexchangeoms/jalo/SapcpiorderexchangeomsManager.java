 ...
 */
package de.hybris.platform.sap.sapcpiorderexchangeoms.jalo;
...
/**
 * This is the extension manager of the Sapcpiorderexchangeoms extension.
 */
public class SapcpiorderexchangeomsManager extends GeneratedSapcpiorderexchangeomsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpiorderexchangeomsManager.class);
	 ...
	 */
	public static SapcpiorderexchangeomsManager getInstance()
	{
		return (SapcpiorderexchangeomsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpiorderexchangeomsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpiorderexchangeomsManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpiorderexchangeomsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpiorderexchangeomsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpiorderexchangeomsManager called, current tenant: {}", getTenant().getTenantID());
	}
