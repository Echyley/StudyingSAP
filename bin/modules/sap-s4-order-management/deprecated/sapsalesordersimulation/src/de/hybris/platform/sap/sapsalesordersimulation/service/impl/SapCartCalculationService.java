...
public class SapCartCalculationService extends DefaultCalculationService
{
	...
	{
		if (!(getSapSimulateSalesOrderEnablementService().isCartPricingEnabled()) || ( entry instanceof OrderEntryModel && ((OrderModel)entry.getOrder()).getQuoteReference() != null) )
		{
	...
	{
		if(getSapSimulateSalesOrderEnablementService().isCatalogPricingEnabled() && entry.getProduct().getSapProductTypes().contains(SAPProductType.PHYSICAL)) {
