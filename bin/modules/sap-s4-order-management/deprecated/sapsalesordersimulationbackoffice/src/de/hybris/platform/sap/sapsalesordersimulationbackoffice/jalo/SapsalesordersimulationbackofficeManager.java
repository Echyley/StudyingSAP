 ...
 */
package de.hybris.platform.sap.sapsalesordersimulationbackoffice.jalo;
...
import de.hybris.platform.sap.sapsalesordersimulationbackoffice.constants.SapsalesordersimulationbackofficeConstants;
 ...
 */
public class SapsalesordersimulationbackofficeManager extends GeneratedSapsalesordersimulationbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapsalesordersimulationbackofficeManager.class.getName());
	 ...
	 */
	public static SapsalesordersimulationbackofficeManager getInstance()
	{
		return (SapsalesordersimulationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapsalesordersimulationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapsalesordersimulationbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapsalesordersimulationbackofficeManager called.");
		}
	}
