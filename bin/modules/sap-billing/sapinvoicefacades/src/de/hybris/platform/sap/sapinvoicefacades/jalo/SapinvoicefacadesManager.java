 ...
 */
package de.hybris.platform.sap.sapinvoicefacades.jalo;
...
import de.hybris.platform.sap.sapinvoicefacades.constants.SapinvoicefacadesConstants;



/**
 * This is the extension manager of the Sapinvoicefacades extension.
 */
public class SapinvoicefacadesManager extends GeneratedSapinvoicefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapinvoicefacadesManager.class.getName());
	 ...
	 */
	public static SapinvoicefacadesManager getInstance()
	{
		return (SapinvoicefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapinvoicefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapinvoicefacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapinvoicefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapinvoicefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapinvoicefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
