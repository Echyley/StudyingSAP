 ...
 */
package de.hybris.platform.sap.sapinvoiceaddon.jalo;
...
import de.hybris.platform.sap.sapinvoiceaddon.jalo.GeneratedSapinvoiceaddonManager;



/**
 * This is the extension manager of the Sapinvoiceaddon extension.
 */
public class SapinvoiceaddonManager extends GeneratedSapinvoiceaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapinvoiceaddonManager.class.getName());
	 ...
	 */
	public static SapinvoiceaddonManager getInstance()
	{
		return (SapinvoiceaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapinvoiceaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapinvoiceaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapinvoiceaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapinvoiceaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapinvoiceaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
