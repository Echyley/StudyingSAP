 ...
 */
package de.hybris.platform.sap.sapinvoicebol.jalo;
...
import de.hybris.platform.sap.sapinvoicebol.constants.SapinvoicebolConstants;



/**
 * This is the extension manager of the Sapinvoicebol extension.
 */
public class SapinvoicebolManager extends GeneratedSapinvoicebolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapinvoicebolManager.class.getName());
	 ...
	 */
	public static SapinvoicebolManager getInstance()
	{
		return (SapinvoicebolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapinvoicebolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapinvoicebolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapinvoicebolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapinvoicebolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapinvoicebolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
