 ...
 */
package de.hybris.platform.sap.sapinvoiceservices.jalo;
...
/**
 * This is the extension manager of the Sapinvoiceservices extension.
 */
public class SapinvoiceservicesManager extends GeneratedSapinvoiceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapinvoiceservicesManager.class.getName());
	 ...
	 */
	public static SapinvoiceservicesManager getInstance()
	{
		return (SapinvoiceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapinvoiceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapinvoiceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapinvoiceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapinvoiceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapinvoiceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
