		...
		implements VendorProductSearchFacade
{
	...
	public VendorData getVendorCategories(final String vendorCode)
	{
		...
		if (optional.isPresent())
		{
			...
			final ProductCategorySearchPageData<SearchStateData, ProductData, CategoryData> searchPageData = getProductCategorySearchPageConverter()
					.convert(getProductSearchService().searchAgain(searchQueryData, null));
