...
public class DataHubTransferHandlerTest extends SapcoreconfigurationSpringJUnitTest
{
	...
	public void setUp()
	{
		...
		converter.setTargetClass((new HashMap<String, Object>()).getClass());
	...
	private class PopulatingConverterMock extends AbstractPopulatingConverter<ItemModel, Map<String, Object>>
	{
	}
