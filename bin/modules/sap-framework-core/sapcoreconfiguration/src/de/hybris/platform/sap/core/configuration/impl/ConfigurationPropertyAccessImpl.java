...
public class ConfigurationPropertyAccessImpl implements ConfigurationPropertyAccess
{
	...
	public ConfigurationPropertyAccess getPropertyAccess(final String propertyAccessName)
	{
		...
		if (!propertyAccesses.containsKey(propertyAccessName))
		{
			...
			{
				value = assignConfigurationPropertyAccess(propertyAccessName, value, readMethod);
			}
	...
	private ConfigurationPropertyAccess assignConfigurationPropertyAccess(String propertyAccessName, ConfigurationPropertyAccess value, Method readMethod) {
		try
        {
	...
	public Collection<ConfigurationPropertyAccess> getPropertyAccessCollection(final String propertyAccessCollectionName)
	{
		...
		if (!propertyAccessCollections.containsKey(propertyAccessCollectionName))
		{
			...
			{
				value = addConfigurationPropertyAccess(propertyAccessCollectionName, value, readMethod);
			}
	...
	private Collection<ConfigurationPropertyAccess> addConfigurationPropertyAccess(String propertyAccessCollectionName, Collection<ConfigurationPropertyAccess> value, Method readMethod) {
		try
        {
	...
	private void createPropertyMaps()
	{
		...
		try
		{
			...
			for (final PropertyDescriptor propertyDescriptor : propertyDescriptors)
			{
				...
				{
					propertyAccessForCollection(readMethod, name);
				}
				else
				{
	...
	private void propertyAccessForCollection(Method readMethod, String name) {
