 ...
 */
package de.hybris.platform.sap.core.addon.jalo;
...
import de.hybris.platform.sap.core.addon.constants.SapcoreaddonConstants;



/**
 * This is the extension manager of the Sapcoreaddon extension.
 */
public class SapcoreaddonManager extends GeneratedSapcoreaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoreaddonManager.class.getName());
	 ...
	 */
	public static SapcoreaddonManager getInstance()
	{
		return (SapcoreaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcoreaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoreaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoreaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcoreaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcoreaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
