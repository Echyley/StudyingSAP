 ...
 */
package de.hybris.platform.sap.core.odata.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sap.core.odata.constants.SapcoreodataConstants;
...
/**
 * This is the extension manager of the Sapcoreodata extension.
 */
public class SapcoreodataManager extends GeneratedSapcoreodataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoreodataManager.class.getName());
	 ...
	 */
	public static SapcoreodataManager getInstance()
	{
		return (SapcoreodataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcoreodataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoreodataManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoreodataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcoreodataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcoreodataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
