 ...
 */
package de.hybris.platform.sap.core.jalo;
...
/**
 * This is the extension manager of the Sapcore extension.
 */
public class SapcoreManager extends GeneratedSapcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoreManager.class.getName());
	 ...
	 */
	public static SapcoreManager getInstance()
	{
		return (SapcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoreManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
