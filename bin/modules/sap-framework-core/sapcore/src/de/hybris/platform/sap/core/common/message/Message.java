...
public class Message implements Serializable
{
	...
	public boolean equals(final Object obj)
	{
		...
		else if (obj.getClass() == this.getClass())
		{
			...
			{
				return compareMessageFields(message);
			}
		}
		return false;
	}

	private boolean compareMessageFields(Message message) {
		...
		if (StringUtils.isBlank(resourceKey) && message.description != null)
        {
        	result &= message.description.equals(description);
        }
        else if(!StringUtils.isBlank(resourceKey))
        {
	...
	private void setHashCodeIfApplicable() {
		if (resourceArgs != null)
		{
	...
	public String toString()
	{
		...
		StringBuilder str = new StringBuilder("Message Type: ");
