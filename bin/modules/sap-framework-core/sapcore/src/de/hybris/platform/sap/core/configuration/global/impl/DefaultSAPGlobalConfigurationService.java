...
/**
 * Default Implementation to read global configuration properties.
 */
public class DefaultSAPGlobalConfigurationService implements SAPGlobalConfigurationService
{
