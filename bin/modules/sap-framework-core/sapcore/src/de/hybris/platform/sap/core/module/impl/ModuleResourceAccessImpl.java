...
public class ModuleResourceAccessImpl implements ModuleResourceAccess
{
	...
	{
		final ResourceBundle resourceBundle = (locale == null ? l10nService.getResourceBundle()
				: l10nService.getResourceBundle(new Locale[]
				{ locale }));
		...
		{
			returnValue = null;
			log.error("A required resource is missing or an illegal argument was provided");
			log.error(exception);
		}
