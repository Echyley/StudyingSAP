...
public class JCoConnectionParameterImpl implements JCoConnectionParameter {
    ...
    /**
     * If cacheType is set to {@link JCoManagedFunctionCache.DEFAULT_CACHE_TYPE}
     * cache is activated for this function module configuration.
     */
    ...
    /**
     * Comma separated list of import parameters which should be excluded from
     * the trace.
     */
    private String traceExcludeImportParameters = null;
    /**
     * Comma separated list of export parameters which should be excluded from
     * the trace.
     */
    private String traceExcludeExportParameters = null;
    /**
     * Comma separated list of table parameters which should be excluded from
     * the trace.
     */
    ...
    public void setConnectionParameters(
            final JCoConnectionParameters connectionParameters) {
     ...
     */
    protected List<String> createListFromCommaSeparatedValue(
        ...
        return Collections.unmodifiableList(Arrays.asList(commaSeparatedString
                .split(",")));
    }
     ...
     */
    public void setFunctionModuleToBeReplaced(
            final String functionModuleToBeReplaced) {
     ...
     */
    public void setTraceExcludeImportParameters(
            final String traceExcludeImportParameters) {
     ...
     */
    public void setTraceExcludeExportParameters(
            final String traceExcludeExportParameters) {
     ...
     */
    public void setTraceExcludeTableParameters(
            final String traceExcludeTableParameters) {
     ...
     */
    public void setTraceExcludeImportParametersList(
            final List<String> traceExcludeImportParametersList) {
     ...
     */
    public void setTraceExcludeExportParametersList(
            final List<String> traceExcludeExportParametersList) {
     ...
     */
    public void setTraceExcludeTableParametersList(
            final List<String> traceExcludeTableParametersList) {
        this.traceExcludeTableParametersList = traceExcludeTableParametersList;
    }

    @Override
    public String toString() {
        return "JCoConnectionParameterImpl [functionModule=" + functionModule
                + ", cacheType=" + cacheType + ", eventListener="
                + eventListener + ", traceBefore=" + traceBefore
