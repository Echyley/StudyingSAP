		...
		implements SAPRFCDestinationService
{
	...
	private static final int JCO_TRACE_LEVEL_ZERO = 0;
	private static final int JCO_TRACE_LEVEL_ONE = 1;
	private static final int JCO_TRACE_LEVEL_TWO = 2;
	private static final int JCO_TRACE_LEVEL_THREE = 3;
	private static final int JCO_TRACE_LEVEL_FOUR = 4;
	private static final int JCO_TRACE_LEVEL_FIVE = 5;
	private static final int JCO_TRACE_LEVEL_SIX = 6;
	private static final int JCO_TRACE_LEVEL_SEVEN = 7;
	private static final int JCO_TRACE_LEVEL_EIGHT = 8;
	private static final int JCO_TRACE_LEVEL_ELEVEN = 11;
	...
	public String getSncLibraryPath()
	{
		if (this.sncLibraryPath == null || this.sncLibraryPath.isEmpty())
		{
			...
			DefaultSAPRFCDestinationService.sncLibraryPath = System.getenv(SNC_LIB);
		}
	...
	protected void onEvent(final SAPRFCDestinationEvent event)
	{
		...
		else if (event instanceof SAPRFCDestinationJCoTraceEvent)
		{
			...
			if (jcoTraceLevel >= 0 && jcoTraceLevel < JCO_TRACE_LEVEL_ELEVEN)
			{
				String path = null;
