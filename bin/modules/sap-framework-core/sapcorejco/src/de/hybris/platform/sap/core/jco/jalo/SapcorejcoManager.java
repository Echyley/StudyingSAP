 ...
 */
package de.hybris.platform.sap.core.jco.jalo;
...
/**
 * This is the extension manager of the Sapcorejco extension.
 */
public class SapcorejcoManager extends GeneratedSapcorejcoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcorejcoManager.class.getName());
	 ...
	 */
	public static SapcorejcoManager getInstance()
	{
		return (SapcorejcoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcorejcoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcorejcoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcorejcoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcorejcoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcorejcoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
