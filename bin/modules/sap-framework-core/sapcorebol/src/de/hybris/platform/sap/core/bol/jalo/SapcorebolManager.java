 ...
 */
package de.hybris.platform.sap.core.bol.jalo;
...
import de.hybris.platform.sap.core.bol.constants.SapcorebolConstants;



/**
 * This is the extension manager of the Sapcorebol extension.
 */
public class SapcorebolManager extends GeneratedSapcorebolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcorebolManager.class.getName());
	 ...
	 */
	public static SapcorebolManager getInstance()
	{
		return (SapcorebolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcorebolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcorebolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcorebolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcorebolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcorebolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
