...
public class JCoHelper
{
	 ...
	 * 
	 * @param out
	 *           the StringBuilder to be logged
	 * @param field
	 *           the field to be logged
	 */
	private static void logField(final StringBuilder out, final JCoField field)
	{
	 ...
	 */
	private static void logRecordFieldIterator(final StringBuilder out, final JCoRecordFieldIterator recordFieldIterator)
	{
	...
	static public String obfuscate(final String value)
	{
		...
		{
			final StringBuilder strBuf = new StringBuilder(value);
