 ...
 */
package de.hybris.platform.sap.sapcoreconfigurationbackoffice.jalo;
...
import de.hybris.platform.sap.sapcoreconfigurationbackoffice.constants.SapcoreconfigurationbackofficeConstants;
 ...
 */
public class SapcoreconfigurationbackofficeManager extends GeneratedSapcoreconfigurationbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoreconfigurationbackofficeManager.class.getName());
	 ...
	 */
	public static SapcoreconfigurationbackofficeManager getInstance()
	{
		return (SapcoreconfigurationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcoreconfigurationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoreconfigurationbackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoreconfigurationbackofficeManager called.");
		}
	}
