...
class PropertyAccessImpl implements PropertyAccess
{
	...
	protected LinkedProperties allProperties;
	protected List<String> propertiesFilePaths;
	protected String propertiesPathPrefix;
	...
	{
		propertiesFilePaths = new ArrayList<String>(LIST_SIZE);
	...
	{
		return Boolean.parseBoolean(allProperties.getProperty(key));
	}
	...
	public String toString()
	{
		...
		while (properties != null)
		{
			if (!properties.isEmpty())
			{
				...
				sortProperties(properties, output, propertiesAsStrings);
			}
	...
	private void sortProperties(LinkedProperties properties, StringBuilder output, List<String> propertiesAsStrings) {
