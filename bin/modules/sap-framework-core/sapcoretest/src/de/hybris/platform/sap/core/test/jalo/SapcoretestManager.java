 ...
 */
package de.hybris.platform.sap.core.test.jalo;
...
import de.hybris.platform.sap.core.test.constants.SapcoretestConstants;



/**
 * This is the extension manager of the Sapcoretest extension.
 */
public class SapcoretestManager extends GeneratedSapcoretestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoretestManager.class.getName());
	 ...
	 */
	public static SapcoretestManager getInstance()
	{
		return (SapcoretestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcoretestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoretestManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoretestManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcoretestManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcoretestManager called, current tenant: " + getTenant().getTenantID());
		}
	}
