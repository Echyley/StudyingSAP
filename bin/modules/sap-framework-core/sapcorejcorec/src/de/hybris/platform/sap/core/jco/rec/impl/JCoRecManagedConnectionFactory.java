...
public class JCoRecManagedConnectionFactory implements JCoManagedConnectionFactory
{
	 ...
	 * Logger.
	 */
	private static final Logger LOG = Logger.getLogger(JCoRecManagedConnectionFactory.class.getName());
	...
	public void startRecorder(final JCoRecMode recordingMode, final String directoryPath, final String key)
	{
        ...
        {
            LOG.debug("JCoRecorder disabled for " + key);
		...
		else if (this.recordingMode == JCoRecMode.PLAYBACK)
		{
