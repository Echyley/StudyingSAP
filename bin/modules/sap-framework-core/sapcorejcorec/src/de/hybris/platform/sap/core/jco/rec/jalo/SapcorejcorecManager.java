 ...
 */
package de.hybris.platform.sap.core.jco.rec.jalo;
...
/**
 * This is the extension manager of the Sapcorejcorec extension.
 */
public class SapcorejcorecManager extends GeneratedSapcorejcorecManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcorejcorecManager.class.getName());
	 ...
	 */
	public static SapcorejcorecManager getInstance()
	{
		return (SapcorejcorecManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcorejcorecConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcorejcorecManager() // NOPMD  
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcorejcorecManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcorejcorecManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcorejcorecManager called, current tenant: " + getTenant().getTenantID());
		}
	}
