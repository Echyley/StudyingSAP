import { ContextMenuDto } from 'personalizationcommons';
...
describe('personalizationsmarteditContextMenu', () => {
    ...
    describe('inner proxy', () => {
        ...
        describe('openEditComponentAction', () => {
            it('should be defined', () => {
                expect(
                    personalizationsmarteditContextMenuProxy.openEditComponentAction
                ).toBeDefined();
            });
        });
    });
    ...
    describe('ContextualMenuService', () => {
        ...
        beforeEach(() => {
            ...
            personalizationsmarteditContextService = jasmine.createSpyObj(
                ...
                ['getCombinedView', 'getCustomize', 'isCurrentPageActiveWorkflowRunning']
            );
            ...
            personalizationsmarteditComponentHandlerService = jasmine.createSpyObj(
            ...
            personalizationsmarteditContextMenu = jasmine.createSpyObj(
                'personalizationsmarteditContextMenu',
                ['openDeleteAction', 'openAddAction', 'openEditAction', 'openEditComponentAction']
            );
        ...
        describe('openDeleteAction', () => {
            it('should be defined', () => {
                expect(
                    personalizationsmarteditContextualMenuService.openDeleteAction
                ).toBeDefined();
            });
        ...
        describe('openAddAction', () => {
            ...
            it('should call proper service with parameters', () => {
                ...
                (personalizationsmarteditComponentHandlerService.getParentSlotForComponent as any).and.callFake(
                    () => {
                        return {};
                    }
                );
        ...
        describe('openEditComponentAction', () => {
            ...
            it('should call proper service', () => {
                ...
                expect(
                    personalizationsmarteditContextMenu.openEditComponentAction
