...
public class DefaultAbstractOrderEntryPopulatorTest
{
	 ...
	 *
	 */
	private static final BigDecimal NET_PRICE_WO_FREIGHT = new BigDecimal(5);
	...
	public void testPopulateAbstractOrderEntryPopulator()
	{
		...
		item.setNetPriceWOFreight(NET_PRICE_WO_FREIGHT);
		...
		Assert.assertEquals(orderEntry.getBasePrice().getValue(), NET_PRICE_WO_FREIGHT);
