		...
		Populator<SOURCE, TARGET>
{
	...
	protected void populateHeader(final SOURCE source, final TARGET target)
	{
		...
		target.setSubTotalWithDiscounts(priceFactory.create(PriceDataType.BUY, header.getNetValueWOFreight(), header.getCurrency()));
		...
		target.setTotalPrice(priceFactory.create(PriceDataType.BUY, header.getNetValue(), header.getCurrency()));
