 ...
 */
package de.hybris.platform.sap.sapordermgmtservices.jalo;
...
/**
 * This is the extension manager of the Sapordermgmtservices extension.
 */
public class SapordermgmtservicesManager extends GeneratedSapordermgmtservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapordermgmtservicesManager.class.getName());
	 ...
	 */
	public static SapordermgmtservicesManager getInstance()
	{
		return (SapordermgmtservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapordermgmtservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapordermgmtservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapordermgmtservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapordermgmtservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapordermgmtservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
