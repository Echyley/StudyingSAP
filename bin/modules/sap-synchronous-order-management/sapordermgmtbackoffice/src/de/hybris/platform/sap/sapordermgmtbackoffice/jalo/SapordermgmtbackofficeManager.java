 ...
 */
package de.hybris.platform.sap.sapordermgmtbackoffice.jalo;
...
import de.hybris.platform.sap.sapordermgmtbackoffice.constants.SapordermgmtbackofficeConstants;
 ...
 */
public class SapordermgmtbackofficeManager extends GeneratedSapordermgmtbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapordermgmtbackofficeManager.class.getName());
	 ...
	 */
	public SapordermgmtbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapordermgmtbackofficeManager called.");
		}
	}
	 ...
	 */
	public static SapordermgmtbackofficeManager getInstance()
	{
		return (SapordermgmtbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapordermgmtbackofficeConstants.EXTENSIONNAME);
	}
