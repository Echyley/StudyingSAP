...
public class SapOrdermgmtB2BCheckoutFacade extends SapCreditCheckB2BCheckoutFacade
{
	...
	public boolean setDeliveryAddress(final AddressData usedAddress)
	{
		...
		//fix for FUSION-289
		setDeliveryAddressOnCart(usedAddress);
		return true;
	}
	 ...
	 * @param addressData
	 */
	public void setDeliveryAddressOnCart(final AddressData addressData)
	{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.commercefacades.order.CheckoutFacade#createPaymentSubscription(de.hybris.platform.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.b2bacceleratorfacades.api.cart.CheckoutFacade#updateCheckoutCart(de.hybris.platform.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.b2bacceleratorfacades.api.cart.CheckoutFacade#placeOrder(de.hybris.platform.
	 * b2bacceleratorfacades .checkout.data.PlaceOrderData)
	 */
	@Override
	public <T extends AbstractOrderData> T placeOrder(final PlaceOrderData placeOrderData) throws InvalidCartException
	{
		...
		return (T) checkoutService.placeOrder();
	}
}
