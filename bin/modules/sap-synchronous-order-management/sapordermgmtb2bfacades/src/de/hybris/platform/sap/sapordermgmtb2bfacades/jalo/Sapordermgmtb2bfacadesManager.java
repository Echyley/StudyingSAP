 ...
 */
package de.hybris.platform.sap.sapordermgmtb2bfacades.jalo;
...
import de.hybris.platform.sap.sapordermgmtb2bfacades.constants.Sapordermgmtb2bfacadesConstants;



/**
 * This is the extension manager of the Sapordermgmtb2bfacades extension.
 */
public class Sapordermgmtb2bfacadesManager extends GeneratedSapordermgmtb2bfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapordermgmtb2bfacadesManager.class.getName());
	 ...
	 */
	public Sapordermgmtb2bfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapordermgmtb2bfacadesManager called.");
		}
	}
	 ...
	 */
	public static Sapordermgmtb2bfacadesManager getInstance()
	{
		return (Sapordermgmtb2bfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapordermgmtb2bfacadesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapordermgmtb2bfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapordermgmtb2bfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
