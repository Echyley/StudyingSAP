...
import de.hybris.platform.sap.ysapordermgmtb2baddon.constants.Ysapordermgmtb2baddonConstants;



/**
 * This is the extension manager of the Ysapordermgmtb2baddon extension.
 */
public class Ysapordermgmtb2baddonManager extends GeneratedYsapordermgmtb2baddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ysapordermgmtb2baddonManager.class.getName());
	 ...
	 */
	public static Ysapordermgmtb2baddonManager getInstance()
	{
		return (Ysapordermgmtb2baddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ysapordermgmtb2baddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ysapordermgmtb2baddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ysapordermgmtb2baddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Ysapordermgmtb2baddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Ysapordermgmtb2baddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
