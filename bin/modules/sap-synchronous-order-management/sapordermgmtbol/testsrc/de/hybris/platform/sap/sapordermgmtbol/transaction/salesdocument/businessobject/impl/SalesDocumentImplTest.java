...
public class SalesDocumentImplTest extends SapordermanagmentBolSpringJunitTest
{
	...
	public void testHandleNotUniqueProductsFalse() throws CommunicationException
	{
		...
		assertFalse(SalesDocumentUtil.applyAlternativeProducts(classUnderTest.getItemList()));
	}
	...
	public void testHandleNotUniqueProductsTrue() throws CommunicationException
	{
		...
		assertTrue(SalesDocumentUtil.applyAlternativeProducts(classUnderTest.getItemList()));
	...
	public void testHandleNotUniqueProduct_resetTransferItem() throws BusinessObjectException
	{
		...
		assertTrue("There is a substition product, hence not unique",
				SalesDocumentUtil.applyAlternativeProducts(classUnderTest.getItemList()));
	...
	public void testCopyAttributesOfItem()
	{
		...
		SalesDocumentUtil.copyAttributesOfItem(source, destination);
	...
	public void testCheckQuantityUOM_noRounding() throws Exception
	{
		...
		classUnderTest.addItem(item);
		final Converter converter = injectConverter(0);

		final Map<TechKey, Message> messages = SalesDocumentUtil.checkQuantityUOM(classUnderTest.getItemList(), converter);
	...
	public void testCheckQuantityUOM_noRoundingScale3() throws Exception
	{
		...
		classUnderTest.addItem(item);
		final Converter converter = injectConverter(3);
	...
	public void testCheckQuantityUOM_belowMinimum() throws Exception
	{
		...
		classUnderTest.addItem(item);
		final Converter converter = injectConverter(2);
	...
	private Converter injectConverter(final int allowedScale) throws BusinessObjectException
	{
