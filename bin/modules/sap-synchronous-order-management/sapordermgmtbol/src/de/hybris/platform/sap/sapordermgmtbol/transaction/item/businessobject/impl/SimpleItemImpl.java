...
public class SimpleItemImpl extends BusinessObjectBase implements SimpleItem
{
	...
	public void setProductId(final String productId)
	{
		...
		if (isProductChanged(pId, oldProductId))
		{
	...
	/**
	 * Set the internal number for the item. The internal number is the item number (Positionsnummer) displayed on the front
	 * end and generated by the backend system. In the default case the numbers are starting with 10 and increased by 10,
	 * e.g. 10, 20, 30, 40....
	 */
	@Override
	...
	/**
	 * Get the internal number for the item. The internal number is the item number (Positionsnummer) displayed on the front
	 * end and generated by the backend system. In the default case the numbers are starting with 10 and increased by 10,
	 * e.g. 10, 20, 30, 40....
	 */
	@Override
