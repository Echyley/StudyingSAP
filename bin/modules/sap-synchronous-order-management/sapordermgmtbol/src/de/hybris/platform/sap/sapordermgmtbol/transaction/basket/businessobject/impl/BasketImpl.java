...
public class BasketImpl extends SalesDocumentImpl implements Basket
{
	...
	public int hashCode()
	{
		...
		result = prime * result + ((basketOrderConsistency == null) ? 0 : basketOrderConsistency.hashCode());
		return result;
	}
	...
	public boolean equals(final Object obj)
	{
		...
		final BasketImpl other = (BasketImpl) obj;
		if (basketOrderConsistency == null)
		{
			if (other.basketOrderConsistency != null)
			{
				return false;
			}
		}
		else if (!basketOrderConsistency.equals(other.basketOrderConsistency))
		{
			return false;
		}
		return true;
