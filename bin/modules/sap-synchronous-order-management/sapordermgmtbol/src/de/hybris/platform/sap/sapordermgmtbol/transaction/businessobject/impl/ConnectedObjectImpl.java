...
public abstract class ConnectedObjectImpl extends BusinessObjectBase implements ConnectedObject
{
	 ...
	 *
	 * @return document type charaterizes the document in the backend (e.g., order, order template)
	 */
	@Override
	 ...
	 *
	 * @return displayable property determines if the document may be displayed in the order status
	 */
	@Override
