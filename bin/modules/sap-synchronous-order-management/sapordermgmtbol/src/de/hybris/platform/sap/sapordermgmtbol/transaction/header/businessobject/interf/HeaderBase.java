...
public interface HeaderBase extends SimpleHeader
{
	...
	/**
	 * Adds a <code>ConnectedDocument</code> to the predecessor list. A <code>null</code> reference passed to this function
	 ...
	 *
	 * @param changeable
	 *           <code>" "</code> or <code>""</code> indicates that the document is changeable, all other values that it is
	 *           changeable.
	 */
