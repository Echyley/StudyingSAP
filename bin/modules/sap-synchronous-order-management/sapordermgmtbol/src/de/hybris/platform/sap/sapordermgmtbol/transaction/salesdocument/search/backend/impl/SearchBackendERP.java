...
public class SearchBackendERP extends BackendBusinessObjectBaseJCo implements SearchBackend
{
	...
	protected void performLogging(final SearchResultList resultList, final int maxHits)
	{
		...
		{
			sapLogger.log(LogSeverity.ERROR, LogCategories.APPLICATIONS, "Result list size exceeds maximum number of hits");
		}
		else if (isWarningStatus(resultList, maxHits))
		{
			sapLogger.log(LogSeverity.WARNING, LogCategories.APPLICATIONS,
	...
	{
		return (SearchResult) genericFactory.getBean(SapordermgmtbolConstants.ALIAS_BEAN_SEARCH_RESULT_ENTRY);
	}
