...
/**
 * This is the extension manager of the Sapordermgmtbol extension.
 */
public class SapordermgmtbolManager extends GeneratedSapordermgmtbolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapordermgmtbolManager.class.getName());
	 ...
	 */
	public static SapordermgmtbolManager getInstance()
	{
		return (SapordermgmtbolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapordermgmtbolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapordermgmtbolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapordermgmtbolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapordermgmtbolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapordermgmtbolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
