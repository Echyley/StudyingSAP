...
public class BillingItemStatusImpl extends BillingStatusImpl implements BillingItemStatus
{
	...
	public boolean isNotRelevant()
	{
		...
		return (this.ordInvoiceStatus == EStatus.NOT_RELEVANT && this.dlvInvoiceStatus == EStatus.NOT_RELEVANT
				&& (this.dlvStatus == EStatus.NOT_RELEVANT || this.dlvStatus == EStatus.PARTIALLY_PROCESSED
	...
	public boolean isNotProcessed()
	{
		...
		return this.ordInvoiceStatus == EStatus.NOT_PROCESSED
				...
				|| (this.ordInvoiceStatus == EStatus.NOT_RELEVANT && this.dlvInvoiceStatus == EStatus.NOT_RELEVANT
						&& this.dlvStatus == EStatus.NOT_PROCESSED);
	}
	...
	public boolean isProcessed()
	{
		...
		// Empty C C
		// -------------------------------------
		return this.ordInvoiceStatus == EStatus.PROCESSED || (this.ordInvoiceStatus == EStatus.NOT_RELEVANT
				&& this.dlvInvoiceStatus == EStatus.PROCESSED && this.dlvStatus == EStatus.PROCESSED);
	}
