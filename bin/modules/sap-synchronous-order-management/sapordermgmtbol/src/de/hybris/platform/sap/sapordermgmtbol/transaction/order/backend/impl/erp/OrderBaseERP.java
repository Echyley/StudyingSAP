...
public abstract class OrderBaseERP extends SalesDocumentERP implements OrderBaseBackend
{
	...
	public boolean isCancelable(final Order order)
	{
		...
		if (overallStatus != null)
		{
			...
			final boolean overallsatusIsNotProcessed = overallStatus.isNotProcessed();
			final boolean overallsatusIsPratiallyProcessed = overallStatus.isPartiallyProcessed();
			final boolean billingStatusNotProcessed = null == billingStatus || billingStatus.isNotProcessed();
			final boolean shippingStatusNotProcessed = null == shippingStatus || shippingStatus.isNotProcessed();

			isCancelable = overallsatusIsNotProcessed
					|| (overallsatusIsPratiallyProcessed && billingStatusNotProcessed && shippingStatusNotProcessed);
