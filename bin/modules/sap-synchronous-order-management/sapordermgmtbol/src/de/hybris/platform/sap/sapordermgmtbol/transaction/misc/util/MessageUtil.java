...
public class MessageUtil
{
	...
	public static boolean hasMessage(final String msgType, final String msgId, final String msgNo, final JCoRecord messageRecord)
	{
		log.entering("hasMessage");
		...
		final BackendMessage messageToCompare = new BackendMessage(msgType, msgId, msgNo);
		...
		for (int i = 0; i < numMessage; i++)
		{
			...
			final boolean messageFound = backendMessage.equalsInfo(messageToCompare);
