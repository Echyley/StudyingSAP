...
public interface AlternativeProductList extends SimpleListAccess<AlternativeProduct>, Cloneable
{
	 ...
	 * @return AlternativProduct which can added to the AlternativProductList
	 */
	AlternativeProduct createAlternativProduct(String systemProductId, TechKey systemProductGUID, String description,
	 ...
	 *           if the system product is a substitute product, this is the id for the substitution reason
	 */
	void addAlternativProduct(String systemProductId, TechKey systemProductGUID, String description, String enteredProductIdType,
			String substitutionReasonId);
	 ...
	 */
	void setList(List<AlternativeProduct> altProdList);
