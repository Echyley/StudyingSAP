...
public abstract class BusinessStatusImpl implements BusinessStatus
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #getStatus()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #isNotRelevant()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #isNotProcessed()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #isPartiallyProcessed()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #isProcessed()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.businessobject.impl .BusinessStatus #clone()
	 */
	@Override
