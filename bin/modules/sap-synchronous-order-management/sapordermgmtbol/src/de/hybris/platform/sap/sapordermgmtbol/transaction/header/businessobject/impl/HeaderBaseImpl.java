...
public class HeaderBaseImpl extends SimpleHeaderImpl implements HeaderBase
{
	...
	protected List<ConnectedDocument> predecessorList = new ArrayList<ConnectedDocument>(0);
	/**
	 * List of successors
	 */
	@SuppressWarnings("squid:S1948")
	protected List<ConnectedDocument> successorList = new ArrayList<ConnectedDocument>(0);
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase
	 * #addSuccessor(com.sap.wec.app.common.module.transaction.businessobject .interf.ConnectedDocument)
	 */
	@Override
	...
	/**
	 * Drops the state of the object. All reference fields, except partnerList, are set to null, all primitive types are set
	 * to the default values they would have after the creation of a new instance. Use this method to reset the state to the
	 * state a newly created object would have. The advantage is, that the overhead caused by the normal object creation is
	 * omitted.
	 */
	@Override
	public void clear()
	...
	public Object clone()
	{
		...
		{
			myClone.predecessorList = new ArrayList<ConnectedDocument>(predecessorList.size());
		...
		{
			myClone.successorList = new ArrayList<ConnectedDocument>(successorList.size());
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#createConnectedDocumentData()
	 */
	@Override
	public ConnectedDocument createConnectedDocument()
	{
		...
		return (ConnectedDocument) genericFactory.getBean(SapordermgmtbolConstants.ALIAS_BEAN_CONNECTED_DOCUMENT);
	}

	/*
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getChangedAt()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getCreatedAt()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getCurrency()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getDeliveryPriority()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getDisChannel()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getDivision()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getDocumentType()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getFreightValue()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getGrossValue()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getNetValue()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getNetValueWOFreight()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getPartnerId(java.lang.String)
	 */
	@Override
	public String getPartnerId(final String partnerFunction)
	{
		...
		if (partnerList != null)
		{
			final PartnerListEntry partner = partnerList.getPartnerData(partnerFunction);
			if (partner != null)
			{
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getPartnerKey(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getPartnerList()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getPostingDate()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getProcessType()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getPurchaseOrderExt()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getSalesDocNumber()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getSalesDocumentsOrigin()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getSalesOffice()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getSalesOrg()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getShipCond()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getSuccessorList()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getTaxValue()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getTotalDiscount()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#isChangeable()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setChangeable(boolean)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setChangedAt(java.util.Date)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setCreatedAt(java.util.Date)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setCreatedAt(java.lang.String)
	 */
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setCurrency(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setDeliveryPriority(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setDisChannel(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setDivision(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setDocumentType(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setFreightValue(java.math.BigDecimal)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setGrossValue(java.math.BigDecimal)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setNetValue(java.math.BigDecimal)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setNetValueWOFreight(java.math.BigDecimal)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase
	 * #setPartnerList(com.sap.wec.app.common.module.transaction.order .businessobject.interf.PartnerList)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setPostingDate(java.util.Date)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setProcessType(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setProcessTypeDesc(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setPurchaseOrderExt(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setReqDeliveryDate(java.util.Date)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setSalesDocNumber(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setSalesDocumentsOrigin(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setSalesOffice(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setSalesOrg(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setShipCond(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setTaxValue(java.math.BigDecimal)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setTotalDiscount(java.math.BigDecimal)
	 */
	@Override
	...
	/**
	 * Returns a simplifies string representation of the object. Useful for debugging/logging purpose, but not for display
	...
	{
		final StringBuilder buf = new StringBuilder(STRING_BUFFER_INIT_SIZE_FOR_TOSTRING);
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#getGrossValueWOFreight()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setGrossValueWOFreight(java.math.BigDecimal)
	 */
	@Override
	 ...
	 */
	protected Date consolidateDate(final Date date)
	{
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getValidFrom()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf .HeaderBase#getValidTo()
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setValidFrom(java.util.Date)
	 */
	@Override
	 ...
	 *
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject .interf
	 * .HeaderBase#setValidTo(java.util.Date)
	 */
	@Override
