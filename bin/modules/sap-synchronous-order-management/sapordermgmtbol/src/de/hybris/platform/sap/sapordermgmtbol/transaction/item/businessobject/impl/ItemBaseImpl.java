...
public class ItemBaseImpl extends SimpleItemImpl implements ItemBase
{
	 ...
	 */
	@SuppressWarnings("squid:S1948")
	protected List<ConnectedDocumentItem> predecessorList = new ArrayList<ConnectedDocumentItem>();

	/**
	 * List of successors
	 */
	@SuppressWarnings("squid:S1948")
	protected List<ConnectedDocumentItem> successorList = new ArrayList<ConnectedDocumentItem>();
	...
	private BigDecimal netPriceWOFreight;
	...
	/**
	 * Performs a deep-copy rather than a shallow copy. For sake of performance you should avoid haevy usage of this method,
	 * as creating a deep copy is quite expensive.<br>
	...
	public Object clone()
	{
		...
		clonePredecessorList(myClone);

		cloneScheduleLines(myClone);

		cloneSuccessorList(myClone);
	 ...
	 * @param myClone
	 */
	final public void cloneSuccessorList(final ItemBaseImpl myClone)
	{
	 ...
	 * @param myClone
	 */
	final public void cloneScheduleLines(final ItemBaseImpl myClone)
	{
	 ...
	 * @param myClone
	 */
	final public void clonePredecessorList(final ItemBaseImpl myClone)
	{
	...
	@Override
	public void setNetPriceWOFreight(final BigDecimal netPriceWOFreight)
	{
		this.netPriceWOFreight = netPriceWOFreight;
	}
