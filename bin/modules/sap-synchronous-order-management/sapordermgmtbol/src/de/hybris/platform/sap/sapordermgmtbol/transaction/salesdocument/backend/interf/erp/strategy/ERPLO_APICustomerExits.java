...
public interface ERPLO_APICustomerExits
{
	 ...
	 */
	void customerExitBeforeGetAll(SalesDocument salesDocument, JCoFunction function, JCoConnection connection,
	 ...
	 */
	void customerExitAfterGetAllJCOCall(SalesDocument salesdocument, JCoFunction function, JCoConnection connection,
			Log4JWrapper logging);
	 ...
	 *           if additional tracing/logging is needed
	 */
	void customerExitAfterGetAll(SalesDocument salesdocument, JCoFunction function, JCoConnection connection,
			Log4JWrapper logging);
	 ...
	 */
	Map<LrdFieldExtension.FieldType, LrdFieldExtension> customerExitGetExtensionFields();
	 ...
	 */
	void customerExitBeforeLoad(SalesDocument salesDoc, JCoFunction function, JCoConnection connection, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitAfterLoad(SalesDocument salesDoc, JCoFunction function, JCoConnection connection, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitAfterSave(boolean commit, JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitBeforeSave(boolean commit, JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitBeforeSetActiveFields(JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitAfterSetActiveFields(JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitAfterSet(SalesDocument salesDoc, JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 *           if additional tracing/logging is necessary
	 */
	void customerExitBeforeSet(SalesDocument salesDoc, JCoFunction function, JCoConnection cn, Log4JWrapper log);
	 ...
	 */
	boolean customerExitIsItemChanged(Item currentItem, Item existingItem);
	 ...
	 *           Map of attributes
	 */
	void customerExitAfterGetAllItemRPricingAttributes(JCoTable ttItemComR, Item itm, Map<String, String> ipcPriceAttributes);
	 ...
	 *           Map of attributes
	 */
	void customerExitAfterGetAllItemVPricingAttributes(JCoTable ttItemComV, Item itm, Map<String, String> ipcPriceAttributes);
