...
public class BackendMessage
{
	 ...
	 * Message parameters
	 */
	protected final String[] vars = new String[FOUR];
	/**
	 * Message text
	 */
	...
	public BackendMessage(final JCoRecord struct)
	{
		...
		if ("A".equals(beSeverity) || "E".equals(beSeverity))
		{
			...
			{
				LOC.log(LogSeverity.ERROR, LogCategories.APPLICATIONS, beMessage + struct.getString("TEXT"));
			}
			else
			{
				LOC.log(LogSeverity.ERROR, LogCategories.APPLICATIONS, beMessage + beClass + "," + beNumber);
			}
		}
