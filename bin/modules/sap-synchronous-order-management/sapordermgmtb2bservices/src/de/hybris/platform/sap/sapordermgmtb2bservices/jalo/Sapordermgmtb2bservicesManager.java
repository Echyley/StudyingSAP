...
/**
 * This is the extension manager of the Sapordermgmtb2bservices extension.
 */
public class Sapordermgmtb2bservicesManager extends GeneratedSapordermgmtb2bservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapordermgmtb2bservicesManager.class.getName());
	 ...
	 */
	public Sapordermgmtb2bservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapordermgmtb2bservicesManager called.");
		}
	}
	 ...
	 */
	public static Sapordermgmtb2bservicesManager getInstance()
	{
		return (Sapordermgmtb2bservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapordermgmtb2bservicesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapordermgmtb2bservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapordermgmtb2bservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
