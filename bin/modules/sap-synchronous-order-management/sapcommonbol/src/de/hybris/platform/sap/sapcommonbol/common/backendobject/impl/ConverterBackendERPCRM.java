...
public abstract class ConverterBackendERPCRM extends
	...
	protected static final class UomLocalization {
	...
	protected static final class CurrencyLocalization {
	...
	@Override
	public abstract Object loadUOMsByLanguageFromBackend(String applicationID,
			String language) throws BackendException;

	@Override
	public abstract Object loadCurrenciesByLanguageFromBackend(
		...
		synchronized (ConverterBackendERPCRM.class) {
			...
			if (currencies == null) {
				try {
					...
					sapLogger. traceThrowable(LogSeverity.DEBUG, e.getMessage(), e);
	...
	private String getSAPLanguage() {
		...
		return ConversionTools.getR3LanguageCode(isoLanguage);
	}
