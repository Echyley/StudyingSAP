...
@SuppressWarnings({"squid:ClassCyclomaticComplexity","squid:S2160"})
public class AddressImpl extends BusinessObjectBase implements Address
{
	...
	public String get(final String fieldName)
	{
		...
		catch (final IllegalAccessException | IllegalArgumentException | SecurityException | NoSuchFieldException ex)
		{
					LOG.traceThrowable(LogSeverity.DEBUG, ex.getMessage(), ex);
		}
		return null;
	}
