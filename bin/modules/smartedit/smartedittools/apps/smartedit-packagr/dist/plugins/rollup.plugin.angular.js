...
async function transformHelper(filter, map, source, options) {
    if (!filter(map)) {
    ...
    const replaceTemplateUrl = async (subString, url) => {
        ...
        if (fileExt === 'js' && options.replace === true) {
            ...
            console.info(`templateUrl in file ${map} has been changed from ${chalk.green(subString)}  to ${chalk.green(toReplace)}`);
        }
        return toReplace;
    };
    const replaceStyleUrls = async (subString, urls) => {
        ...
        if (fileExt === 'js' && options.replace === true) {
            ...
            console.info(`styleUrls in file ${map} has been changed from ${chalk.green(subString)} to ${chalk.green(toReplace)}`);
        }
        return toReplace;
    };
    const replaceModuleId = (_subString, _moduleId) => {
        hasReplacements = true;
        return '';
    };
