import { ChangeDetectorRef, ComponentFactoryResolver, EventEmitter, OnChanges, OnDestroy, SimpleChanges } from '@angular/core';
...
export declare class MediaUploadFormComponent implements OnChanges, OnDestroy {
    private cdr;
