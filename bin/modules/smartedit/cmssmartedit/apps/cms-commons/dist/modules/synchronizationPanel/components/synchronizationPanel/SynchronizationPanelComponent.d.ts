...
import { CrossFrameEventService, IAlertService, ICatalogService, ISharedDataService, IWaitDialogService, LogService, SystemEventService, TimerService, TypedMap, IUserTrackingService } from 'smarteditcommons';
...
export declare class SynchronizationPanelComponent implements OnInit, OnDestroy {
    ...
    syncItemsUpdated: EventEmitter<void>;
