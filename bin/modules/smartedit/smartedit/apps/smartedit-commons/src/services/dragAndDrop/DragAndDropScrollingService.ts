...
export class DragAndDropScrollingService {
    ...
    initialize(): void {
        this.scrollable = this.getFromElementSelector(
    ...
    private addScrollAreas(): Promise<void> {
        this.topScrollArea = this.getFromSelector(
            '<div id="' +
                DragAndDropScrollingService.TOP_SCROLL_AREA_ID +
                '" class="' +
                SCROLL_AREA_CLASS +
        ...
        this.bottomScrollArea = this.getFromSelector(
            '<div id="' +
                DragAndDropScrollingService.BOTTOM_SCROLL_AREA_ID +
                '" class="' +
                SCROLL_AREA_CLASS +
    ...
    private onDragEnter(event: DragEvent): void {
        ...
        const scrollArea = this.getFromSelector(event.target as HTMLElement);
    ...
    private getFromSelector(selector: string | HTMLElement): JQuery {
    ...
    private getFromHTMLSelector(selector: HTMLElement): JQuery {
        return this.yjQuery(selector);
    }

    private getFromElementSelector(selector: Element): JQuery<Element> {
        return this.yjQuery(selector);
    }
