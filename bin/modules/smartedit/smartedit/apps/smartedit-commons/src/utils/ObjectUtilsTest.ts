...
describe('Object Utils Test', () => {
    ...
    it('uniqueArray will return an array of unique items from a given pair of input arrays', () => {
        ...
        expect(uniqueArr).toEqual(['item1', 'item2', 'item3', 'item4', 'item6']);
    });
...
describe('Object Utils Test - readObjectStructure', () => {
...
describe('Object Utils Test - orderBy', () => {
