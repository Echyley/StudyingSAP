...
/* @internal  */
export interface GenericEditorFieldComponentScope<T = any, D = any>
...
export class GenericEditorFieldComponent<T> implements ControlValueAccessor, OnDestroy {
    ...
    ngAfterViewInit(): void {
        ...
        ) as Partial<GenericEditorFieldComponentScope>;
        ...
        this.elementRef.nativeElement.isFieldDisabled = (): boolean => this.isFieldDisabled();
            ...
            providers: [
                {
                    ...
                    useValue: {
                        ...
                        isFieldDisabled: (): boolean => this.isFieldDisabled()
                    }
                }
            ]
        });
