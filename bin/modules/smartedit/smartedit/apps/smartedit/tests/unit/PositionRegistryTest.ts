...
describe('positionRegistry', () => {
    ...
    beforeEach(() => {
        ...
        body.getBoundingClientRect.and.returnValue(bodyBoundingRect as DOMRect);
        element1 = jasmine.createSpyObj('element1', ['getBoundingClientRect', 'height']);
        element1.getBoundingClientRect.and.returnValue(element1BoundingRect as DOMRect);
        element2 = jasmine.createSpyObj('element2', ['getBoundingClientRect', 'height']);
        element2.getBoundingClientRect.and.returnValue(element2BoundingRect as DOMRect);
        element3 = jasmine.createSpyObj('element3', ['getBoundingClientRect', 'height']);
        element3.getBoundingClientRect.and.returnValue(element3BoundingRect as DOMRect);
    ...
    it('when element positions change they are detected', () => {
        ...
        expect(repositionedComponents.length).toEqual(2);
    ...
    it('positions change less than a 100th pixel are not detected', () => {
        ...
        expect(positionRegistry.getRepositionedComponents().length).toEqual(0);
    });
    ...
    it('positions change are only detected once', () => {
        ...
        expect(repositionedComponents.length).toEqual(0);
    });
