...
import { IDecoratorDisplayCondition, StringUtils, PromiseUtils, TypedMap } from 'smarteditcommons';
...
describe('decoratorService', () => {
    ...
    beforeEach(() => {
        ...
        decoratorService = new DecoratorService(promiseUtils, stringUtils);
