...
describe('componentHandlerService - inner', () => {
    ...
    const DATA_SMARTEDIT_COMPONENT_ID = 'data-smartedit-component-id';
    const DATA_SMARTEDIT_COMPONENT_TYPE = 'data-smartedit-component-type';
    const DATA_SMARTEDIT_CONTAINER_ID = 'data-smartedit-container-id';
    const DATA_SMARTEDIT_CONTAINER_TYPE = 'data-smartedit-container-type';
    const UNEXPECTED_ERROR = 'unexpected selector';
    const attrCallFakeFun = function (attribute: string) {
        switch (attribute) {
            case DATA_SMARTEDIT_COMPONENT_ID:
                return 'theid';
            case DATA_SMARTEDIT_COMPONENT_TYPE:
                return 'thetype';
            default:
    ...
    it('getOverlayComponent will fetch component under slot in the overlay', () => {
        ...
        originalComponent.attr.and.callFake(attrCallFakeFun);
    ...
    it('getParent of an original component will fetch closest parent in the storefront layer', () => {
        ...
        component.attr.and.callFake(attrCallFakeFun);
    ...
    it('setId will set the data-smartedit-component-id field of a given component', () => {
        ...
        expect(component.attr).toHaveBeenCalledWith(DATA_SMARTEDIT_COMPONENT_ID, 'theid');
    ...
    it('setType will set the data-smartedit-component-type field of a given component', () => {
        ...
        expect(component.attr).toHaveBeenCalledWith(DATA_SMARTEDIT_COMPONENT_TYPE, 'thetype');
        expect(yjQuery).toHaveBeenCalledWith(originalComponent);
    });
    ...
    it('getSlotOperationRelatedId will get the data-smartedit-container-id when it is defined AND data-smartedit-container-type is defined', () => {
        ...
        component.attr.and.callFake(function (attr: string) {
            switch (attr) {
                case DATA_SMARTEDIT_COMPONENT_ID:
                    return 'theid';
                case DATA_SMARTEDIT_CONTAINER_ID:
                    return 'thecontainerid';
                case DATA_SMARTEDIT_CONTAINER_TYPE:
