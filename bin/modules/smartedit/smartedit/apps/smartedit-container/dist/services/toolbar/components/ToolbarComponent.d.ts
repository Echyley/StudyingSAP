...
import { IIframeClickDetectionService, IToolbarServiceFactory, SmarteditRoutingService, SystemEventService, ToolbarItemInternal, IUserTrackingService } from 'smarteditcommons';
...
export declare class ToolbarComponent implements OnInit, OnDestroy {
    ...
    constructor(toolbarServiceFactory: IToolbarServiceFactory<ToolbarService>, iframeClickDetectionService: IIframeClickDetectionService, systemEventService: SystemEventService, injector: Injector, cdr: ChangeDetectorRef, routingService: SmarteditRoutingService, userTrackingService: IUserTrackingService);
    ngOnInit(): void;
    ngOnDestroy(): void;
