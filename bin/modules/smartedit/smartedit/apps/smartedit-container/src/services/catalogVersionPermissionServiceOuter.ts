...
export class CatalogVersionPermissionService extends ICatalogVersionPermissionService {
    ...
    public async hasPermission(
        ...
        if (this.isCatalogVersionPermissionResponse(response)) {
            ...
            return value === 'true' || (shouldOverride as any);
        }
        return false;
    }
    ...
    public async hasSyncPermissionToActiveCatalogVersion(
        ...
        const targetCatalogVersion =
            await this.catalogService.getActiveContentCatalogVersionByCatalogId(catalogId);
    ...
    public async hasSyncPermission(
        ...
        const response =
            await this.catalogVersionPermissionRestService.getCatalogVersionPermissions(
                catalogId,
