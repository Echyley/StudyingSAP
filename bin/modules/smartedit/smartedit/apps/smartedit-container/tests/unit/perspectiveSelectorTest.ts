...
describe('PerspectiveSelector', () => {
    ...
    let userTrackingService: IUserTrackingService;
    ...
    const SOME_DESCRIPTION_KEY = 'some.description.key';
    ...
    describe('filterPerspectives', () => {
        it('expect active perspective to not be displayed', () => {
            // GIVEN
            const PERSPECTIVE_1: any = {
                key: 'perspective1'
            };

            const PERSPECTIVE_2: any = {
                key: 'perspective2'
            };
    ...
    describe('isTooltipVisible', () => {
        ...
        it('returns true WHEN no perspective is active and has a description key', () => {
            ...
            const PERSPECTIVE_1: any = {
                key: 'perspective1',
                descriptionI18nKey: SOME_DESCRIPTION_KEY
            };
