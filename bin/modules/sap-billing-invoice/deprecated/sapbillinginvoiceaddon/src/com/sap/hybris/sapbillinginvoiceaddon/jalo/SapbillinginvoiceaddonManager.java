 ...
 */
package com.sap.hybris.sapbillinginvoiceaddon.jalo;
...
import com.sap.hybris.sapbillinginvoiceaddon.constants.SapbillinginvoiceaddonConstants;



/**
 * This is the extension manager of the Sapbillinginvoiceaddon extension.
 */
public class SapbillinginvoiceaddonManager extends GeneratedSapbillinginvoiceaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapbillinginvoiceaddonManager.class.getName());
	 ...
	 */
	public static SapbillinginvoiceaddonManager getInstance()
	{
		return (SapbillinginvoiceaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapbillinginvoiceaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapbillinginvoiceaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapbillinginvoiceaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapbillinginvoiceaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapbillinginvoiceaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
