...
public class SapBillingInvoiceSalesStrategyImplTest
{
	...
	public void setUp()
	{
		...
		sapBillingInvoiceSalesStrategyImpl.setPriceFactory(priceFactory);
		sapBillingInvoiceSalesStrategyImpl.setConfigurationService(configurationService);
	}
	...
	public void getBillingDocuments()
	{
		...
		given(sapBillingInvoiceService.callS4forBillingDocuments(Mockito.any(), Mockito.any())).willReturn(mockParametersMap);
