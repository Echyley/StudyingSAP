...
public class SapOmsSendOrderToDataHubAction extends AbstractProceduralAction<OrderProcessModel> {
  ...
  protected Set<Set<ConsignmentModel>> groupOrderConsignments(OrderModel order) {
    ...
    /*
     * Sample data for mapByLogSysSalesOrg in resources/saporderexchangeoms/sample_data.txt
     */
    ...
    Set<Set<ConsignmentModel>> consignmentSets = new ConcurrentHashSet<>();
    ...
    /*
     * Sample data for consignmentSets
     *
     * [
     * [ConsignmentModel (8797240100819), ConsignmentModel(8797240100888)],
     * [ConsignmentModel(8797240068051)],
  ...
  protected void sendOrder(final OrderModel order, List<SendToDataHubResult> results,
	...
	final Optional<ConsignmentModel> consignmentModel = consignments.stream().findFirst();
    SAPPlantLogSysOrgModel sapPlantLogSysOrgModel = getSapPlantLogSysOrgService().getSapPlantLogSysOrgForPlant(
            order.getStore(), (consignmentModel.isPresent() ? consignmentModel.get().getWarehouse().getCode() : ""));
