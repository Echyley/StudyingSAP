 ...
 */
package de.hybris.platform.sap.saporderexchangeoms.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sap.saporderexchangeoms.constants.SaporderexchangeomsConstants;
...
/**
 * This is the extension manager of the Saporderexchangeoms extension.
 */
public class SaporderexchangeomsManager extends GeneratedSaporderexchangeomsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaporderexchangeomsManager.class.getName());
	 ...
	 */
	public static SaporderexchangeomsManager getInstance()
	{
		return (SaporderexchangeomsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaporderexchangeomsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaporderexchangeomsManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaporderexchangeomsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SaporderexchangeomsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SaporderexchangeomsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
