...
@IntegrationTest(replaces = OrderCancelIntegrationTest.class)
public class SapOrderCancelIntegrationTest extends OrderCancelIntegrationTest {
    ...
    public void testCancellableOrders() throws Exception
    {
        ...
        Assert.assertFalse("Sample order [" + cancellableOrder1.getCode() + "] should be fully cancellable", decision.isAllowed());
