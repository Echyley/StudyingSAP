...
public class DefaultB2BPartnerContributorTest
{
	...
	public void setUp()
	{
		...
		partnerContributor = new DefaultB2BPartnerContributor(){
			@Override
		...
		partnerContributor.setB2bUnitService(b2bUnitService);
	...
	{
		final Set<String> columns = partnerContributor.getColumns();
	...
	public void testCreateB2BRows()
	{
		...
		final List<Map<String, Object>> rows = partnerContributor.createRows(order);
	...
	public void testCreateB2CRows()
	{
		...
		partnerContributor.setB2CCustomerHelper(b2CCustomerHelper);
		Map<String, String> batchIdAttributes = new HashMap<String, String>();
		batchIdAttributes.put("dh_batchId", "000001");
		batchIdAttributes.put("dh_sourceId", "HYBRIS");
		batchIdAttributes.put("dh_type", "SALESORDER_CREATE");
		
		partnerContributor.setBatchIdAttributes(batchIdAttributes);
