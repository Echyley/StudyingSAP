 ...
 */
package de.hybris.platform.sap.orderexchangeb2b.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sap.orderexchangeb2b.constants.Saporderexchangeb2bConstants;
...
/**
 * This is the extension manager of the Saporderexchangeb2b extension.
 */
public class Saporderexchangeb2bManager extends GeneratedSaporderexchangeb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Saporderexchangeb2bManager.class.getName());
	 ...
	 */
	public static Saporderexchangeb2bManager getInstance()
	{
		return (Saporderexchangeb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Saporderexchangeb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Saporderexchangeb2bManager()  
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Saporderexchangeb2bManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Saporderexchangeb2bManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Saporderexchangeb2bManager called, current tenant: " + getTenant().getTenantID());
		}
	}
