 ...
 */
package de.hybris.platform.sap.saporderexchangebackoffice.jalo;
...
import de.hybris.platform.sap.saporderexchangebackoffice.constants.SaporderexchangebackofficeConstants;
 ...
 */
public class SaporderexchangebackofficeManager extends GeneratedSaporderexchangebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaporderexchangebackofficeManager.class.getName());
	 ...
	 */
	public static SaporderexchangebackofficeManager getInstance()
	{
		return (SaporderexchangebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaporderexchangebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaporderexchangebackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaporderexchangebackofficeManager called.");
		}
	}
