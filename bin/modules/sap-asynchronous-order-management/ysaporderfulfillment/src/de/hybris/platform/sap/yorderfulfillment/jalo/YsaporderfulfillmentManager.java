 ...
 */
package de.hybris.platform.sap.yorderfulfillment.jalo;
...
/**
 * This is the extension manager of the Ysaporderfulfillment extension.
 */
public class YsaporderfulfillmentManager extends GeneratedYsaporderfulfillmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YsaporderfulfillmentManager.class.getName());
	 ...
	 */
	public static YsaporderfulfillmentManager getInstance()
	{
		return (YsaporderfulfillmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YsaporderfulfillmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YsaporderfulfillmentManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YsaporderfulfillmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YsaporderfulfillmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YsaporderfulfillmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
