 ...
 */
package de.hybris.platform.sap.sapcarintegrationaddon.jalo;
...
import de.hybris.platform.sap.sapcarintegrationaddon.constants.SapcarintegrationaddonConstants;



/**
 * This is the extension manager of the Sapcarintegrationaddon extension.
 */
public class SapcarintegrationaddonManager extends GeneratedSapcarintegrationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcarintegrationaddonManager.class.getName());
	 ...
	 */
	public static SapcarintegrationaddonManager getInstance()
	{
		return (SapcarintegrationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcarintegrationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcarintegrationaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcarintegrationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcarintegrationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcarintegrationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
