...
/**
 * This is the extension manager of the Sappostransactionaddon extension.
 */
public class SappostransactionaddonManager extends GeneratedSappostransactionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SappostransactionaddonManager.class.getName());
	 ...
	 */
	public static SappostransactionaddonManager getInstance()
	{
		return (SappostransactionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SappostransactionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SappostransactionaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SappostransactionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SappostransactionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SappostransactionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
