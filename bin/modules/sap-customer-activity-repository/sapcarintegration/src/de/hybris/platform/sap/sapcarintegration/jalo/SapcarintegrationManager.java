 ...
 */
package de.hybris.platform.sap.sapcarintegration.jalo;
...
/**
 * This is the extension manager of the Sapcarintegration extension.
 */
public class SapcarintegrationManager extends GeneratedSapcarintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcarintegrationManager.class.getName());
	 ...
	 */
	public static SapcarintegrationManager getInstance()
	{
		return (SapcarintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcarintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcarintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcarintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcarintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcarintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
