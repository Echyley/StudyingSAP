 ...
 * {@link de.hybris.platform.sap.sapcarintegration.services.CarConnectionService}
 */
public class DefaultCarConnectionService implements CarConnectionService
{
	 ...
	 * 
	 * @see
	 * de.hybris.platform.sap.sapcarintegration.services.impl.CarConnectionService1#createConnection(java.lang.String,
			...
			throws IOException, MalformedURLException
	{
		...
		if (SapcarintegrationConstants.HTTP_METHOD_POST.equals(httpMethod)
				|| SapcarintegrationConstants.HTTP_METHOD_PUT.equals(httpMethod))
		{
...

		{
			...
			authorization += new String(Base64.encodeBase64(
					(getCarConfigurationService().getUsername() + ":" + getCarConfigurationService().getPassword()).getBytes()));
