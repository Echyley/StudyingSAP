...
import de.hybris.platform.sap.sapcarcommercefacades.constants.SapcarcommercefacadesConstants;



/**
 * This is the extension manager of the Sapcarcommercefacades extension.
 */
public class SapcarcommercefacadesManager extends GeneratedSapcarcommercefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcarcommercefacadesManager.class.getName());
	 ...
	 */
	public static SapcarcommercefacadesManager getInstance()
	{
		return (SapcarcommercefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcarcommercefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcarcommercefacadesManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcarcommercefacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcarcommercefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcarcommercefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
