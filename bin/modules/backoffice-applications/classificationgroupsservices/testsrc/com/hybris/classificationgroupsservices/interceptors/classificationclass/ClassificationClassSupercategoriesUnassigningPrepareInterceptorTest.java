...
public class ClassificationClassSupercategoriesUnassigningPrepareInterceptorTest
{
	...
	public void shouldRemoveFeatureGroupAssignments()
	{
		...
		final List<ClassAttributeAssignmentModel> attributeAssignmentOfCategory1 = mock(List.class);
		final List<ClassAttributeAssignmentModel> attributeAssignmentOfCategory2 = mock(List.class);
