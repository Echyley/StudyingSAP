 ...
 */
public class CouponNotificationEmailContext extends ChineseAbstractEmailContext<CouponNotificationProcessModel>
{
	...
	protected void updateCouponLink(final CouponNotificationProcessModel businessProcessModel)
	{
		...
		if (couponData != null)
		{
			put(COUPON_LINK, couponData.getProductUrl());
		}
	}
	...
	{
		String title = "";
		if (businessProcessModel.getCouponNotification() != null
				&& businessProcessModel.getCouponNotification().getCustomer().getTitle() != null)
		{
