 ...
 */
package de.hybris.platform.sap.sapcpireturnsexchange.jalo;
...
/**
 * This is the extension manager of the Sapcpireturnsexchange extension.
 */
public class SapcpireturnsexchangeManager extends GeneratedSapcpireturnsexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpireturnsexchangeManager.class);
	 ...
	 */
	public static SapcpireturnsexchangeManager getInstance()
	{
		return (SapcpireturnsexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpireturnsexchangeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpireturnsexchangeManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpireturnsexchangeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpireturnsexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpireturnsexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
