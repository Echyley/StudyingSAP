 ...
 *
 */
public class SapReturnOrderBackendConfimationForCancelChecker extends AbstractSimpleDecisionAction<ReturnProcessModel>
{
	@Override
	public Transition executeAction(final ReturnProcessModel returnProcess)
	{
		...
		if (returnRequest
				...
				.stream()
				.allMatch(
						returnStatus -> returnStatus.getSapReturnRequestOrderStatus().equals(
								SAPReturnRequestOrderStatus.CANCELLED_FROM_BACKEND)))
		{
