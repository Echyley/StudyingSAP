 ...
 */
package com.sap.hybris.returnssupport.jalo;
...
import com.sap.hybris.returnssupport.constants.ReturnssupportConstants;
 ...
 */
public class ReturnssupportManager extends GeneratedReturnssupportManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ReturnssupportManager.class.getName());
	 ...
	 */
	public static ReturnssupportManager getInstance()
	{
		return (ReturnssupportManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ReturnssupportConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ReturnssupportManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ReturnssupportManager called.");
		}
	}
