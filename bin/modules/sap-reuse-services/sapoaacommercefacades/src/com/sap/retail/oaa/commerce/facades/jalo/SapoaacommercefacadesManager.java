 ...
 */
package com.sap.retail.oaa.commerce.facades.jalo;
...
import com.sap.retail.oaa.commerce.facades.constants.SapoaacommercefacadesConstants;



/**
 * This is the extension manager of the Sapoaacommercefacades extension.
 */
public class SapoaacommercefacadesManager extends GeneratedSapoaacommercefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapoaacommercefacadesManager.class.getName());
	 ...
	 */
	public SapoaacommercefacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapoaacommercefacadesManager called.");
		}
	}
	 ...
	 */
	public static SapoaacommercefacadesManager getInstance()
	{
		return (SapoaacommercefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaacommercefacadesConstants.EXTENSIONNAME);
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapoaacommercefacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapoaacommercefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
