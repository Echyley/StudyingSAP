...
public class DefaultCosSourcingRequestMapperTest
{
	...
	public void setUp()
	{
		...
		Mockito.lenient().when(addressConverter.convert(any(AddressModel.class), any(AddressData.class))).thenReturn(addressData);
		Mockito.lenient().when(cosServiceUtils.fetchDestinationCoordinates(any(AddressData.class))).thenReturn(gps);
	...
	public void prepareCosSourcingRequestTest()
	{
		...
		final Double latitude = 0.0d;
		final Double longitude = 0.0d;
		//Execute
