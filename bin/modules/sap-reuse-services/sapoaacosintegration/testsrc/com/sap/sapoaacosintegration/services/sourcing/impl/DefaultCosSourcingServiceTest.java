...
public class DefaultCosSourcingServiceTest
{
	...
	public void setUp()
	{
		...
		defaultCosSourcingService.setCommonUtils(commonUtils);
		...
		Mockito.lenient().when(reservationService.updateReservation(any(AbstractOrderModel.class), anyString()))
	...
	public void callRestServiceAndPersistResultTest()
	{
		...
		//Verify
		Assert.assertTrue(abstractOrderModel.getSapCosSystemUsed());
	}
