...
import com.sap.sapoaacosintegration.services.stock.impl.DefaultSapCosOaaCommerceStockService;
 ...
 */
@UnitTest
public class DefaultSapCosCartValidationStrategyTest
{
	...
	private DefaultSapCosCartValidationStrategy classUnderTest = null;
	private ATPAggregationStrategy aggregationStrategy;

	@Before
	public void setup()
	{
		classUnderTest = new DefaultSapCosCartValidationStrategy();
	...
	public void validateCartTest()
	{
		...
		classUnderTest = EasyMock.createMockBuilder(DefaultSapCosCartValidationStrategy.class).addMockedMethod("cleanCart")
	...
	public void checkAvailabilityOfCartItemsShipToAndPOSNoStockTest()
	{
		...
		// create partial mock to mock the internal method calls
		classUnderTest = EasyMock.createMockBuilder(DefaultSapCosCartValidationStrategy.class).addMockedMethod("validateCartEntry")
				.createMock();
		EasyMock
		...
		// Stock Service Mock
		final DefaultSapCosOaaCommerceStockService stockServiceMock = EasyMock
				.createNiceMock(DefaultSapCosOaaCommerceStockService.class);
