...
public class DefaultReservationStrategy implements ReservationStrategy
{
	...
	private AtomicReference<ReservationService> atomicRefReservationService = new AtomicReference<>(reservationService);
	...
	{
		return this.atomicRefReservationService.get();
	}
	...
	{
		this.atomicRefReservationService.set(reservationService);
	}
