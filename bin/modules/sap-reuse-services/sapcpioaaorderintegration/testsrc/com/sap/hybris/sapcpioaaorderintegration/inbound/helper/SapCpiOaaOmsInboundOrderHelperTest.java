...
public class SapCpiOaaOmsInboundOrderHelperTest {

  @InjectMocks
  private SapCpiOaaOmsInboundOrderHelper sapCipOmsInboundOrderHelper;
  @Mock
  ...
  public void setUp() {
    ...
    orderModel.setSapCosSystemUsed(Boolean.FALSE);
    ...
    consignmentModel.setConsignmentEntries(Collections.set(new ConsignmentEntryModel()));
    consignmentModel.setConsignmentProcesses(Collections.set(consignmentProcessModel));

    sapOrderModel.setConsignments(Collections.set(consignmentModel));
  ...
  public void cancelOrder() throws OrderCancelException {
    ...
    assertThat(eventArgumentCaptor.getValue().getChoice()).isEqualTo(SapcpioaaorderintegrationConstants.CANCEL_CONSIGNMENT);
