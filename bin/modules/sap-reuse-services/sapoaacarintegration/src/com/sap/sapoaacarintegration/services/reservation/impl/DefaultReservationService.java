...
public class DefaultReservationService extends DefaultRestService implements ReservationService {
	...
	public ReservationResponse updateReservation(final AbstractOrderModel abstractOrderModel,
		...
		if (getCommonUtils().isCAREnabled()) {
			final String reservationServicePath = getConfigurationService().getConfiguration().getString(SERVICE_PATH)
	...
	public void deleteReservationItem(final AbstractOrderModel abstractOdrerModel,
		...
		if (getCommonUtils().isCAREnabled()) {
		final String reservationServicePath = getConfigurationService().getConfiguration().getString(SERVICE_PATH) + abstractOdrerModel.getGuid().replace("-", "").toUpperCase()
				+ getConfigurationService().getConfiguration().getString(SERVICE_PATH_ITEMS) + serviceUtils.createExternalIdForItem(
