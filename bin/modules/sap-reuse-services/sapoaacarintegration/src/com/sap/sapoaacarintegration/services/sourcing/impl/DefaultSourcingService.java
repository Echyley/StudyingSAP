...
public class DefaultSourcingService extends DefaultCosSourcingService
{
	...
	private static final String SERVICE_RESOURCE_PATH = "service.resource.path.sourcing";
			...
			throws URISyntaxException, BackendDownException
	{
		...
		if (authenticationResult == null)
		{
			...
			getOaaRestService().getRestServiceConfiguration().getPassword(), getOaaRestService().getRestServiceConfiguration().getTargetUrl(),
					getConfigurationService().getConfiguration().getString(SERVICE_RESOURCE_PATH),
		...
		final ResponseEntity<SourcingResponse> response = getOaaRestService().getRestTemplate()
				.exchange(urlProvider.compileURI(getOaaRestService().getRestServiceConfiguration().getTargetUrl(),
						getConfigurationService().getConfiguration().getString(SERVICE_RESOURCE_PATH),
