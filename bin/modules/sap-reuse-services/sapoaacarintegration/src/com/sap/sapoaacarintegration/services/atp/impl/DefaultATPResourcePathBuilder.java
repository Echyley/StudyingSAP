...
{
	private static final String SERVICE_PATH = "service.resource.path.availability";
	...
	public String buildBatchRessourceServicePath(final ProductModel product, final List<String> sourcesList)
	{
		...
		strBuilder.append(getConfigurationService().getConfiguration().getString(SERVICE_PATH));
		strBuilder.append('/');
