...
public class DefaultSourcingServiceTest
{
	...
	{
		DefaultSourcingService classUnderTest = new DefaultSourcingService();
				
		oaaRestService = EasyMock.createMockBuilder(DefaultRestService.class)
		...
		EasyMock.expect(requestMapperMock.mapCartModelToSourcingRequest(cartModel, false, false,
				oaaRestService.getRestServiceConfiguration())).andReturn(new SourcingAbapRequest());
