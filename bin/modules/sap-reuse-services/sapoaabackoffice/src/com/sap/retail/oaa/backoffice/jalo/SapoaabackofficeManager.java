 ...
 */
package com.sap.retail.oaa.backoffice.jalo;
...
import com.sap.retail.oaa.backoffice.constants.SapoaabackofficeConstants;



/**
 * This is the extension manager of the Sapoaabackoffice extension.
 */
public class SapoaabackofficeManager extends GeneratedSapoaabackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapoaabackofficeManager.class);
	 ...
	 */
	public static SapoaabackofficeManager getInstance()
	{
		return (SapoaabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapoaabackofficeManager() 
	{
		LOG.debug("constructor of SapoaabackofficeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapoaabackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapoaabackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
