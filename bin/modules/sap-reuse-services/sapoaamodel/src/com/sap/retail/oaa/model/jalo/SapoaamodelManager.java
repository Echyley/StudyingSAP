...
/**
 * This is the extension manager of the Sapoaamodel extension.
 */
public class SapoaamodelManager extends GeneratedSapoaamodelManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapoaamodelManager.class.getName());
	 ...
	 */
	public SapoaamodelManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapoaamodelManager called.");
		}
	}
	 ...
	 */
	public static SapoaamodelManager getInstance()
	{
		return (SapoaamodelManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaamodelConstants.EXTENSIONNAME);
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapoaamodelManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapoaamodelManager called, current tenant: " + getTenant().getTenantID());
		}
	}
