 ...
 */
package com.sap.retail.oaa.commerce.services.jalo;
...
/**
 * This is the extension manager of the Sapoaacommerceservices extension.
 */
public class SapoaacommerceservicesManager extends GeneratedSapoaacommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapoaacommerceservicesManager.class.getName());
	 ...
	 */
	public SapoaacommerceservicesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapoaacommerceservicesManager called.");
		}
	}
	 ...
	 */
	public static SapoaacommerceservicesManager getInstance()
	{
		return (SapoaacommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaacommerceservicesConstants.EXTENSIONNAME);
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapoaacommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapoaacommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
