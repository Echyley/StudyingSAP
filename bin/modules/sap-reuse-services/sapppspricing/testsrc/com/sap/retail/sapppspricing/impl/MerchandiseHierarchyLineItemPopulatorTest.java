...
public class MerchandiseHierarchyLineItemPopulatorTest
{
	...
	@Test
	public void testIsErpMerchCat1()
	{
	...
	@Test
	public void testSetGetHierarchyId()
	{
	...
	@Test
	public void testIsErpMerchCat2()
	{
	...
	@Test
	public void testIsSureErpMerchCat1()
	{
		final ClassificationClassModel cat = new ClassificationClassModel();
	...
	@Test
	public void testDetermineBaseMaterialGroupNoCategoriesMap()
	{
	...
	@Test
	public void testDetermineBaseMaterialGroupFalseCategory()
	{
	...
	@Test
	public void testDetermineBaseMaterialGroupRightCategory()
	{
		final ProductModel product = createProductWithBaseMaterialGroup();
		cut.setMerchGroupCatalogId("4712");
	...
	@Test
	public void testDetermineBaseMaterialGroupVariantProduct()
	{
		final ProductModel product = createProductWithBaseMaterialGroup();
	...
	@Test
	public void testPopulateNoERPBaseCatAssigned()
	{
		final LineItemDomainSpecific lineItem = new LineItemDomainSpecific();
		
		List<MerchandiseHierarchyCommonData> merchandiseHierarchyCommonDatas=new ArrayList<>();
		lineItem.setMerchandiseHierarchy(merchandiseHierarchyCommonDatas);
		
		final ProductModel product = new ProductModel();
		final SaleBase sale = new SaleBase();
		sale.setMerchandiseHierarchy(merchandiseHierarchyCommonDatas);
		...
		SaleBase salebase=cut.getHelper().getLineItemContent(lineItem);
		assertTrue(salebase.getMerchandiseHierarchy().isEmpty());
	}

	@Test
	public void testPopulateERPBaseCatAssigned()
	{
		final LineItemDomainSpecific lineItem = new LineItemDomainSpecific();
		final ProductModel product = new ProductModel();
	...
	@Test
	public void testPopulateERPBaseCatAssignedWithoutHierarchy()
	{
		final LineItemDomainSpecific lineItem = new LineItemDomainSpecific();
		final ProductModel product = new ProductModel();
	...
	@Test
	public void testPopulateERPBaseCatAndCharProfileAssigned()
	{
		final LineItemDomainSpecific lineItem = new LineItemDomainSpecific();
		final ProductModel product = new ProductModel();
