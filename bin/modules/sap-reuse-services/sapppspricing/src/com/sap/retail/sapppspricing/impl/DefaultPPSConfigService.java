...
public class DefaultPPSConfigService implements PPSConfigService
{
	...
	private AtomicReference<BaseStoreService> atomicRefBaseStoreService = new AtomicReference<>(baseStoreService);

	public BaseStoreService getBaseStoreService()
	{
		return this.atomicRefBaseStoreService.get();
	}

	public void setBaseStoreService(final BaseStoreService baseStoreService)
	{
		this.atomicRefBaseStoreService.set(baseStoreService);
	}
