 ...
 */
@Schema(description = "A flavor of a line item whereby customers purchase an item that will be delivered to a location on a future date and time. SaleForDelivery is currently not supported. ")
...
public class SaleForDeliveryBase {
  @JsonProperty("any")
  ...
  public SaleForDeliveryBase any(List<Object> any) {
    this.any = any;
    return this;
  }

  public SaleForDeliveryBase addAnyItem(Object anyItem) {
    if (this.any == null) {
  ...
  **/
  ...
  public SaleForDeliveryBase itemID(List<ItemID> itemID) {
    this.itemID = itemID;
    return this;
  }

  public SaleForDeliveryBase addItemIDItem(ItemID itemIDItem) {
    if (this.itemID == null) {
  ...
  **/
  ...
  public SaleForDeliveryBase merchandiseHierarchy(List<MerchandiseHierarchyCommonData> merchandiseHierarchy) {
    this.merchandiseHierarchy = merchandiseHierarchy;
    return this;
  }

  public SaleForDeliveryBase addMerchandiseHierarchyItem(MerchandiseHierarchyCommonData merchandiseHierarchyItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase regularSalesUnitPrice(UnitPriceCommonData regularSalesUnitPrice) {
  ...
  **/
  ...
  public SaleForDeliveryBase extendedAmount(ExtendedAmountType extendedAmount) {
  ...
  **/
  ...
  public SaleForDeliveryBase extendedDiscountAmount(AmountCommonData extendedDiscountAmount) {
  ...
  **/
  ...
  public SaleForDeliveryBase quantity(List<QuantityCommonData> quantity) {
    this.quantity = quantity;
    return this;
  }

  public SaleForDeliveryBase addQuantityItem(QuantityCommonData quantityItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase retailPriceModifier(List<RetailPriceModifierDomainSpecific> retailPriceModifier) {
    this.retailPriceModifier = retailPriceModifier;
    return this;
  }

  public SaleForDeliveryBase addRetailPriceModifierItem(RetailPriceModifierDomainSpecific retailPriceModifierItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase itemLink(List<ItemLink> itemLink) {
    this.itemLink = itemLink;
    return this;
  }

  public SaleForDeliveryBase addItemLinkItem(ItemLink itemLinkItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase itemType(String itemType) {
  ...
  **/
  ...
  public SaleForDeliveryBase nonDiscountableFlag(Boolean nonDiscountableFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase fixedPriceFlag(Boolean fixedPriceFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase taxIncludedInPriceFlag(Boolean taxIncludedInPriceFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase nonPieceGoodFlag(Boolean nonPieceGoodFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase frequentShopperPointsEligibilityFlag(Boolean frequentShopperPointsEligibilityFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase discountTypeCode(String discountTypeCode) {
  ...
  **/
  ...
  public SaleForDeliveryBase priceTypeCode(String priceTypeCode) {
  ...
  **/
  ...
  public SaleForDeliveryBase notConsideredByPriceEngineFlag(Boolean notConsideredByPriceEngineFlag) {
  ...
  **/
  ...
  public SaleForDeliveryBase frequentShopperPointsModifier(List<FrequentShopperPointsModifierType> frequentShopperPointsModifier) {
    this.frequentShopperPointsModifier = frequentShopperPointsModifier;
    return this;
  }

  public SaleForDeliveryBase addFrequentShopperPointsModifierItem(FrequentShopperPointsModifierType frequentShopperPointsModifierItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase promotionPriceDerivationRuleReference(List<PromotionPriceDerivationRuleReferenceType> promotionPriceDerivationRuleReference) {
    this.promotionPriceDerivationRuleReference = promotionPriceDerivationRuleReference;
    return this;
  }

  public SaleForDeliveryBase addPromotionPriceDerivationRuleReferenceItem(PromotionPriceDerivationRuleReferenceType promotionPriceDerivationRuleReferenceItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase promotionManualTrigger(List<PromotionManualTriggerType> promotionManualTrigger) {
    this.promotionManualTrigger = promotionManualTrigger;
    return this;
  }

  public SaleForDeliveryBase addPromotionManualTriggerItem(PromotionManualTriggerType promotionManualTriggerItem) {
  ...
  **/
  ...
  public SaleForDeliveryBase lineItemAttribute(List<LineItemAttributeType> lineItemAttribute) {
    this.lineItemAttribute = lineItemAttribute;
    return this;
  }

  public SaleForDeliveryBase addLineItemAttributeItem(LineItemAttributeType lineItemAttributeItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SaleForDeliveryBase saleForDeliveryBase = (SaleForDeliveryBase) o;
    return Objects.equals(this.any, saleForDeliveryBase.any) &&
        Objects.equals(this.itemID, saleForDeliveryBase.itemID) &&
        Objects.equals(this.merchandiseHierarchy, saleForDeliveryBase.merchandiseHierarchy) &&
        Objects.equals(this.regularSalesUnitPrice, saleForDeliveryBase.regularSalesUnitPrice) &&
        Objects.equals(this.extendedAmount, saleForDeliveryBase.extendedAmount) &&
        Objects.equals(this.extendedDiscountAmount, saleForDeliveryBase.extendedDiscountAmount) &&
        Objects.equals(this.quantity, saleForDeliveryBase.quantity) &&
        Objects.equals(this.retailPriceModifier, saleForDeliveryBase.retailPriceModifier) &&
        Objects.equals(this.itemLink, saleForDeliveryBase.itemLink) &&
        Objects.equals(this.itemType, saleForDeliveryBase.itemType) &&
        Objects.equals(this.nonDiscountableFlag, saleForDeliveryBase.nonDiscountableFlag) &&
        Objects.equals(this.fixedPriceFlag, saleForDeliveryBase.fixedPriceFlag) &&
        Objects.equals(this.taxIncludedInPriceFlag, saleForDeliveryBase.taxIncludedInPriceFlag) &&
        Objects.equals(this.nonPieceGoodFlag, saleForDeliveryBase.nonPieceGoodFlag) &&
        Objects.equals(this.frequentShopperPointsEligibilityFlag, saleForDeliveryBase.frequentShopperPointsEligibilityFlag) &&
        Objects.equals(this.discountTypeCode, saleForDeliveryBase.discountTypeCode) &&
        Objects.equals(this.priceTypeCode, saleForDeliveryBase.priceTypeCode) &&
        Objects.equals(this.notConsideredByPriceEngineFlag, saleForDeliveryBase.notConsideredByPriceEngineFlag) &&
        Objects.equals(this.frequentShopperPointsModifier, saleForDeliveryBase.frequentShopperPointsModifier) &&
        Objects.equals(this.promotionPriceDerivationRuleReference, saleForDeliveryBase.promotionPriceDerivationRuleReference) &&
        Objects.equals(this.promotionManualTrigger, saleForDeliveryBase.promotionManualTrigger) &&
        Objects.equals(this.lineItemAttribute, saleForDeliveryBase.lineItemAttribute);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleForDeliveryBase {\n");
