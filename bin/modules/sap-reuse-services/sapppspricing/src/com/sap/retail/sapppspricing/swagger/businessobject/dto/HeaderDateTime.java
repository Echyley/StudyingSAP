 ...
 */
@Schema(description = "Defines the timestamp of the request or the response. It is not used as pricing date.")
...
public class HeaderDateTime {
  ...
  public HeaderDateTime value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(description = "In format yyyy-MM-dd HH:mm:ss.SSS")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HeaderDateTime headerDateTime = (HeaderDateTime) o;
