 ...
 */
@Schema(description = "A flavor of a line item whereby customers return an item that they brought at the same location. ReturnForDelivery is currently not supported. ")
...
public class ReturnBase {
  ...
  public ReturnBase any(List<Object> any) {
    this.any = any;
    return this;
  }

  public ReturnBase addAnyItem(Object anyItem) {
    if (this.any == null) {
  ...
  **/
  ...
  public ReturnBase itemID(List<ItemID> itemID) {
    this.itemID = itemID;
    return this;
  }

  public ReturnBase addItemIDItem(ItemID itemIDItem) {
    if (this.itemID == null) {
  ...
  **/
  ...
  public ReturnBase merchandiseHierarchy(List<MerchandiseHierarchyCommonData> merchandiseHierarchy) {
    this.merchandiseHierarchy = merchandiseHierarchy;
    return this;
  }

  public ReturnBase addMerchandiseHierarchyItem(MerchandiseHierarchyCommonData merchandiseHierarchyItem) {
  ...
  **/
  ...
  public ReturnBase regularSalesUnitPrice(UnitPriceCommonData regularSalesUnitPrice) {
  ...
  **/
  ...
  public ReturnBase extendedAmount(ExtendedAmountType extendedAmount) {
  ...
  **/
  ...
  public ReturnBase extendedDiscountAmount(AmountCommonData extendedDiscountAmount) {
  ...
  **/
  ...
  public ReturnBase quantity(List<QuantityCommonData> quantity) {
    this.quantity = quantity;
    return this;
  }

  public ReturnBase addQuantityItem(QuantityCommonData quantityItem) {
  ...
  **/
  ...
  public ReturnBase retailPriceModifier(List<RetailPriceModifierDomainSpecific> retailPriceModifier) {
    this.retailPriceModifier = retailPriceModifier;
    return this;
  }

  public ReturnBase addRetailPriceModifierItem(RetailPriceModifierDomainSpecific retailPriceModifierItem) {
  ...
  **/
  ...
  public ReturnBase itemLink(List<ItemLink> itemLink) {
    this.itemLink = itemLink;
    return this;
  }

  public ReturnBase addItemLinkItem(ItemLink itemLinkItem) {
  ...
  **/
  ...
  public ReturnBase itemType(String itemType) {
  ...
  **/
  ...
  public ReturnBase nonDiscountableFlag(Boolean nonDiscountableFlag) {
  ...
  **/
  ...
  public ReturnBase fixedPriceFlag(Boolean fixedPriceFlag) {
  ...
  **/
  ...
  public ReturnBase taxIncludedInPriceFlag(Boolean taxIncludedInPriceFlag) {
  ...
  **/
  ...
  public ReturnBase nonPieceGoodFlag(Boolean nonPieceGoodFlag) {
  ...
  **/
  ...
  public ReturnBase frequentShopperPointsEligibilityFlag(Boolean frequentShopperPointsEligibilityFlag) {
  ...
  **/
  ...
  public ReturnBase discountTypeCode(String discountTypeCode) {
  ...
  **/
  ...
  public ReturnBase priceTypeCode(String priceTypeCode) {
  ...
  **/
  ...
  public ReturnBase notConsideredByPriceEngineFlag(Boolean notConsideredByPriceEngineFlag) {
  ...
  **/
  ...
  public ReturnBase frequentShopperPointsModifier(List<FrequentShopperPointsModifierType> frequentShopperPointsModifier) {
    this.frequentShopperPointsModifier = frequentShopperPointsModifier;
    return this;
  }

  public ReturnBase addFrequentShopperPointsModifierItem(FrequentShopperPointsModifierType frequentShopperPointsModifierItem) {
  ...
  **/
  ...
  public ReturnBase promotionPriceDerivationRuleReference(List<PromotionPriceDerivationRuleReferenceType> promotionPriceDerivationRuleReference) {
    this.promotionPriceDerivationRuleReference = promotionPriceDerivationRuleReference;
    return this;
  }

  public ReturnBase addPromotionPriceDerivationRuleReferenceItem(PromotionPriceDerivationRuleReferenceType promotionPriceDerivationRuleReferenceItem) {
  ...
  **/
  ...
  public ReturnBase promotionManualTrigger(List<PromotionManualTriggerType> promotionManualTrigger) {
    this.promotionManualTrigger = promotionManualTrigger;
    return this;
  }

  public ReturnBase addPromotionManualTriggerItem(PromotionManualTriggerType promotionManualTriggerItem) {
  ...
  **/
  ...
  public ReturnBase lineItemAttribute(List<LineItemAttributeType> lineItemAttribute) {
    this.lineItemAttribute = lineItemAttribute;
    return this;
  }

  public ReturnBase addLineItemAttributeItem(LineItemAttributeType lineItemAttributeItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReturnBase returnBase = (ReturnBase) o;
