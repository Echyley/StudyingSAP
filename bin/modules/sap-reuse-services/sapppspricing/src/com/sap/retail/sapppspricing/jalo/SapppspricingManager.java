 ...
 */
public class SapppspricingManager extends GeneratedSapppspricingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapppspricingManager.class);
	 ...
	 */
	public SapppspricingManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapppspricingManager called.");
		}
	}
	 ...
	 */
	public static SapppspricingManager getInstance()
	{
		return (SapppspricingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapppspricingConstants.EXTENSIONNAME);
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapppspricingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapppspricingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
