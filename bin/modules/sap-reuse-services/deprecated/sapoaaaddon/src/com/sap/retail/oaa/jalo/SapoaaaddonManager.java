 ...
 */
package com.sap.retail.oaa.jalo;
...
import com.sap.retail.oaa.constants.SapoaaaddonConstants;



/**
 * This is the extension manager of the Sapoaaaddon extension.
 */
public class SapoaaaddonManager extends GeneratedSapoaaaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapoaaaddonManager.class.getName());
	 ...
	 */
	public SapoaaaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapoaaaddonManager called.");
		}
	}
	 ...
	 */
	public static SapoaaaddonManager getInstance()
	{
		return (SapoaaaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaaaddonConstants.EXTENSIONNAME);
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapoaaaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapoaaaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
