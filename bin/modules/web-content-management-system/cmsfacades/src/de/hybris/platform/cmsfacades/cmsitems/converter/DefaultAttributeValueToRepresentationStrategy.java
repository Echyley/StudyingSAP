...
public class DefaultAttributeValueToRepresentationStrategy implements AttributeValueToRepresentationStrategy
{
			...
			final Function<Object, Object> transform)
	{
		final BiFunction<String, Object, Object> transformValue = (language, value) ->
		{
			...
			{
				buildConversionException(attribute, language, value, e);
			}
			return null;
		};
	...
	protected void buildConversionException(final AttributeDescriptorModel attribute, final String language, final Object value, final ConversionException e)
	{
		LOGGER.error("Error converting attribute for [{}] and language [{}] with value [{}]", attribute.getQualifier(), language, value, e);
