...
/**
 * This class is used by adapters to convert {@link de.hybris.platform.cmsocc.data.ComponentWsDTO} into XML/JSON
 * objects. Map<String, Object> are represented as a list of
 * {@link de.hybris.platform.cmsocc.jaxb.adapters.KeyMapAdaptedEntryAdapter.KeyMapAdaptedEntry} objects.
 */
public class ComponentAdapterUtil
{
	 ...
	 * list of {@link de.hybris.platform.cmsocc.jaxb.adapters.KeyMapAdaptedEntryAdapter.KeyMapAdaptedEntry} entries
	...
	public static class ComponentAdaptedData
	{
		...
		List<KeyMapAdaptedEntry> entries = new ArrayList<>();
	...
	public static ComponentAdaptedData convert(final ComponentWsDTO componentDTO)
	{
		...
		if (componentDTO.getOtherProperties() != null)
		{
			...
			firstNavigationNodeAdaptedDataOptional.ifPresent(navigationNodeAdaptedData -> adaptedComponent.navigationNode = navigationNodeAdaptedData);
