...
import de.hybris.platform.cmsocc.jaxb.adapters.pages.PageListWsDTOAdapter;
import de.hybris.platform.cmsocc.jaxb.adapters.pages.PageListWsDTOAdapter.ListAdaptedPages;
...
public class PageWithUserController
{
	...
	@Operation(summary = "Get a list of page data.", //
			...
			operationId = "getAllPagesWithUser")
	@ApiBaseSiteIdAndUserIdParam
