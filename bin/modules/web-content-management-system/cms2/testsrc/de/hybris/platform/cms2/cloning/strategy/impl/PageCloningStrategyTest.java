...
public class PageCloningStrategyTest
{
	...
	public void shouldClonePageAndRemoveIdenticalPrimaryPage()
	{
		...
		verify(contentPage).setApprovalStatus(CmsApprovalStatus.CHECK);
	...
	public void shouldCloneContentSlotAndCloneComponents()
	{
		...
		verify(cmsItemCloningService).cloneContentSlotComponents(sourceContentSlotModel, expectedClonedContentSlotModel,
