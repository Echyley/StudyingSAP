...
public class DefaultCMSItemCloningServiceTest
{
	...
	{
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, "blah")), is(false));
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, "")), is(false));
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, null)), is(false));
	}

	@Test
	public void shouldReturnValueFromContext()
	{
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, true)), is(true));
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, "true")), is(true));
		assertThat(cmsItemCloningService.shouldCloneComponents(Maps.newHashMap(Cms2Constants.CLONE_ACTION, "TRUE")), is(true));
	}
