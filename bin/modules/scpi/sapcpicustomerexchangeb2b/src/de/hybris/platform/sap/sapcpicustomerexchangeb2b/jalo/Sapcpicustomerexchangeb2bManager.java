 ...
 */
package de.hybris.platform.sap.sapcpicustomerexchangeb2b.jalo;
...
import de.hybris.platform.sap.sapcpicustomerexchangeb2b.constants.Sapcpicustomerexchangeb2bConstants;



/**
 * This is the extension manager of the Sapcpicustomerexchangeb2b extension.
 */
public class Sapcpicustomerexchangeb2bManager extends GeneratedSapcpicustomerexchangeb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Sapcpicustomerexchangeb2bManager.class);
	 ...
	 */
	public static Sapcpicustomerexchangeb2bManager getInstance()
	{
		return (Sapcpicustomerexchangeb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapcpicustomerexchangeb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapcpicustomerexchangeb2bManager() // NOPMD 
	{
		LOG.debug("constructor of Sapcpicustomerexchangeb2bManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Sapcpicustomerexchangeb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Sapcpicustomerexchangeb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
