...
/**
 * This is the extension manager of the Sapcpiorderexchange extension.
 */
public class SapcpiorderexchangeManager extends GeneratedSapcpiorderexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpiorderexchangeManager.class);
	 ...
	 */
	public static SapcpiorderexchangeManager getInstance()
	{
		return (SapcpiorderexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpiorderexchangeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpiorderexchangeManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpiorderexchangeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpiorderexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpiorderexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
