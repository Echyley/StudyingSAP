...
public class SapCpiOmmOrderMapperService implements SapCpiOrderMapperService<OrderModel, SAPCpiOutboundOrderModel> {
  ...
  protected Set<SAPCpiOutboundAddressModel> mapOrderAddresses(List<SapCpiOrderAddress> sapCpiOrderAddresses) {
    ...
    sapCpiOrderAddresses.forEach(address -> {
      ...
      setName(address,sapCpiOutboundAddress);
      setAddress(address,sapCpiOutboundAddress);
  ...
  private void setName(final SapCpiOrderAddress address, final SAPCpiOutboundAddressModel sapCpiOutboundAddress) {
  ...
  private void setAddress(final SapCpiOrderAddress address, final SAPCpiOutboundAddressModel sapCpiOutboundAddress) {
