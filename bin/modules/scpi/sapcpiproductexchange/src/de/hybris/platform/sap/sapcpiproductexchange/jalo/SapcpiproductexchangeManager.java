 ...
 */
package de.hybris.platform.sap.sapcpiproductexchange.jalo;
...
import de.hybris.platform.sap.sapcpiproductexchange.constants.SapcpiproductexchangeConstants;



/**
 * This is the extension manager of the Sapcpiproductexchange extension.
 */
public class SapcpiproductexchangeManager extends GeneratedSapcpiproductexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpiproductexchangeManager.class);
	 ...
	 */
	public static SapcpiproductexchangeManager getInstance()
	{
		return (SapcpiproductexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpiproductexchangeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpiproductexchangeManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpiproductexchangeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpiproductexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpiproductexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
