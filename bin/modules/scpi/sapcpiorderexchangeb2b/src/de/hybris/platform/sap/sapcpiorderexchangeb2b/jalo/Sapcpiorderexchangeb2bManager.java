 ...
 */
package de.hybris.platform.sap.sapcpiorderexchangeb2b.jalo;
...
/**
 * This is the extension manager of the Sapcpiorderexchangeb2b extension.
 */
public class Sapcpiorderexchangeb2bManager extends GeneratedSapcpiorderexchangeb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Sapcpiorderexchangeb2bManager.class);
	 ...
	 */
	public static Sapcpiorderexchangeb2bManager getInstance()
	{
		return (Sapcpiorderexchangeb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapcpiorderexchangeb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapcpiorderexchangeb2bManager() // NOPMD 
	{
		LOG.debug("constructor of Sapcpiorderexchangeb2bManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Sapcpiorderexchangeb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Sapcpiorderexchangeb2bManager called, current tenant: {}", getTenant().getTenantID());
	}
