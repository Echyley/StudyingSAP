...
public interface SapCpiOutboundService
{
	 ...
	 * @return Observable<ResponseEntity < Map>>
	 */
	Observable<ResponseEntity<Map>> sendOrderCancellation(
	...
	{
		return SUCCESS.equalsIgnoreCase(getPropertyValue(responseEntityMap, RESPONSE_STATUS)) && responseEntityMap.getStatusCode()
		                                                                                                          .is2xxSuccessful();
	}
