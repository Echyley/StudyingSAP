...
/**
 * This is the extension manager of the Sapcpiadapter extension.
 */
public class SapcpiadapterManager extends GeneratedSapcpiadapterManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpiadapterManager.class);
	 ...
	 */
	public static SapcpiadapterManager getInstance()
	{
		return (SapcpiadapterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpiadapterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpiadapterManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpiadapterManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpiadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpiadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
