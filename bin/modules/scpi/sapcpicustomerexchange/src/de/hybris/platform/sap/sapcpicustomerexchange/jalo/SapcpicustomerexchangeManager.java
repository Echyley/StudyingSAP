 ...
 */
package de.hybris.platform.sap.sapcpicustomerexchange.jalo;
...
import de.hybris.platform.sap.sapcpicustomerexchange.constants.SapcpicustomerexchangeConstants;



/**
 * This is the extension manager of the Sapcpicustomerexchange extension.
 */
public class SapcpicustomerexchangeManager extends GeneratedSapcpicustomerexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapcpicustomerexchangeManager.class);
	 ...
	 */
	public static SapcpicustomerexchangeManager getInstance()
	{
		return (SapcpicustomerexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcpicustomerexchangeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpicustomerexchangeManager() // NOPMD 
	{
		LOG.debug("constructor of SapcpicustomerexchangeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapcpicustomerexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapcpicustomerexchangeManager called, current tenant: {}", getTenant().getTenantID());
	}
