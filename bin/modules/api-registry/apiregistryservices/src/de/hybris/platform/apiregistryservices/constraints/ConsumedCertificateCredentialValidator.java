		...
		implements ConstraintValidator<ConsumedCertificateCredentialValid, ConsumedCertificateCredentialModel>
{
	...
	private static final int DEFAULT_CERTIFICATE_RETRIEVAL_DELAY = 3000;
			...
			throws CertificateExpiredException, CertificateNotYetValidException
	{
		try
		{
			Thread.sleep(Config.getInt(CERTIFICATE_RETRIEVAL_DELAY, DEFAULT_CERTIFICATE_RETRIEVAL_DELAY));
		}
