...
public class DefaultDestinationTargetCloningStrategyIT extends ServicelayerTransactionalTest
{
	...
	private static final String TEST_END_POINT_ID = "e1";
	...
	public void testCreateDestinationsWithNullDestinationList()
	{
		...
		assertEquals(5, clonedDestinations.size());
	...
	public void endpointDeletedWithDestinationTargetDeletedAndEndpointCanBeNull()
	{
		...
		endpoint.setId(TEST_END_POINT_ID);

		flexibleSearchService.getModelByExample(endpoint);
	}
