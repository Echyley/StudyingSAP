...
public class DefaultEventConfigurationDaoTest extends ServicelayerTransactionalTest
{
	...
	public void findActiveEventConfigsByClassWithOneChannel()
	{
		...
		assertEquals(DestinationChannel.DEFAULT, eventConfigsByClassWith1Version.get(0).getDestinationTarget().getDestinationChannel());
		assertEquals(1, eventConfigsByClassWith1Version.get(0).getVersion());
	}
