...
/**
 * This is the extension manager of the Sapc4ccustomerb2c extension.
 */
public class Sapc4ccustomerb2cManager extends GeneratedSapc4ccustomerb2cManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Sapc4ccustomerb2cManager.class);
	 ...
	 */
	public static Sapc4ccustomerb2cManager getInstance()
	{
		return (Sapc4ccustomerb2cManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapc4ccustomerb2cConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapc4ccustomerb2cManager() // NOPMD 
	{
		LOG.debug("constructor of Sapc4ccustomerb2cManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Sapc4ccustomerb2cManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Sapc4ccustomerb2cManager called, current tenant: {}", getTenant().getTenantID());
	}
