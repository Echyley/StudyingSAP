...
public class MultipartMixedHttpMessageConverter implements HttpMessageConverter<MultiValueMap<String, ?>>
{
	...
	{
	    final Object partBody = partEntity != null ? partEntity.getBody() : null;
	    final Class<?> partType = partBody != null ? partBody.getClass() : null;
	    if (partEntity == null || partType == null) {
		return;
	    }
	...
	{
	    final MediaType contentType = inputMessage != null && inputMessage.getHeaders() != null
		    ? inputMessage.getHeaders().getContentType()
		    : null;
	    final Charset charset = contentType != null && contentType.getCharset() != null ? contentType.getCharset()
		    : DEFAULT_CHARSET;
	    final InputStream inputStream = inputMessage != null ? inputMessage.getBody() : null;
