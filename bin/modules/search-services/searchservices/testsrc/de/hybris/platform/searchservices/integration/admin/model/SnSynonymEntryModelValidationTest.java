...
public class SnSynonymEntryModelValidationTest extends ServicelayerTransactionalTest
{
	...
	private static final String SYNONYMENTRY_ID_QUALIFIER = String.join(".", SnSynonymEntryModel._TYPECODE,
			SnSynonymEntryModel.ID);
	...
	public void testMissingId() {
		...
		Assert.assertThat(getQualifiers(validations),
				Matchers.contains(SYNONYMENTRY_ID_QUALIFIER));
	}
