...
@IntegrationTest
public class SnIndexConfigurationModelValidationTest extends ServicelayerTransactionalTest
{
	private static final String INDEXCONFIGURATION_ID_QUALIFIER = String.join(".", SnIndexConfigurationModel._TYPECODE,
			SnIndexConfigurationModel.ID);
	...
	public void testMissingId() {
		...
		//when
		final Set<HybrisConstraintViolation> validations = validationService.validate(indexConfiguration);
		...
		Assert.assertThat(getQualifiers(validations),
				Matchers.contains(INDEXCONFIGURATION_ID_QUALIFIER));
	}
