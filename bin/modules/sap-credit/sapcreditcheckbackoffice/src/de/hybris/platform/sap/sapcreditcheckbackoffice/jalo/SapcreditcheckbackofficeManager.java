 ...
 */
package de.hybris.platform.sap.sapcreditcheckbackoffice.jalo;
...
import de.hybris.platform.sap.sapcreditcheckbackoffice.constants.SapcreditcheckbackofficeConstants;
 ...
 */
public class SapcreditcheckbackofficeManager extends GeneratedSapcreditcheckbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcreditcheckbackofficeManager.class.getName());
	 ...
	 */
	public static SapcreditcheckbackofficeManager getInstance()
	{
		return (SapcreditcheckbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcreditcheckbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcreditcheckbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcreditcheckbackofficeManager called.");
		}
	}
