...
/**
 * This is the extension manager of the Sapcreditcheck extension.
 */
public class SapcreditcheckManager extends GeneratedSapcreditcheckManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcreditcheckManager.class.getName());
	 ...
	 */
	public static SapcreditcheckManager getInstance()
	{
		return (SapcreditcheckManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcreditcheckConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcreditcheckManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcreditcheckManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcreditcheckManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcreditcheckManager called, current tenant: " + getTenant().getTenantID());
		}
	}
