 ...
 */
package de.hybris.platform.sapmodelbackoffice.jalo;
...
import de.hybris.platform.sapmodelbackoffice.constants.SapmodelbackofficeConstants;
 ...
 */
public class SapmodelbackofficeManager extends GeneratedSapmodelbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapmodelbackofficeManager.class.getName());
	 ...
	 */
	public static SapmodelbackofficeManager getInstance()
	{
		return (SapmodelbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapmodelbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapmodelbackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapmodelbackofficeManager called.");
		}
	}
