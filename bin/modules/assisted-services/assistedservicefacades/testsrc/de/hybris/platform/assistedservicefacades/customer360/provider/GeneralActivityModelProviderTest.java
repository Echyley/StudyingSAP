...
import de.hybris.platform.assistedservicefacades.customer360.providers.GeneralActivityModelProvider;
...
public class GeneralActivityModelProviderTest
{
	...
	public void testDataProviding()
	{
		...
		final GeneralActivityData resultCart = provider.getModel(parameters).getGeneralActivities().get(1);
		final GeneralActivityData resultOrder = provider.getModel(parameters).getGeneralActivities().get(0);
