 ...
 */
package de.hybris.platform.assistedservicewebservices.context;
...
public interface ContextInformationLoader {
     ...
     *
     * @param request - request from which we should get language information
     ...
     *
     * @param request - request from which we should get currency information
