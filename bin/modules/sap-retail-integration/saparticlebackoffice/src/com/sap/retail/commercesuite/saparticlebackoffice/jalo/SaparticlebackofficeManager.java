 ...
 */
package com.sap.retail.commercesuite.saparticlebackoffice.jalo;
...
import com.sap.retail.commercesuite.saparticlebackoffice.constants.SaparticlebackofficeConstants;
 ...
 */
public class SaparticlebackofficeManager extends GeneratedSaparticlebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaparticlebackofficeManager.class.getName());
	 ...
	 */
	public static SaparticlebackofficeManager getInstance()
	{
		return (SaparticlebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaparticlebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaparticlebackofficeManager() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of saparticlebackofficeManager called.");
		}
	}
