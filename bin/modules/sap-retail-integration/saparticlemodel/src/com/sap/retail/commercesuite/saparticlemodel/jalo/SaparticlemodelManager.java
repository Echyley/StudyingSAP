...
/**
 * This is the extension manager of the saparticlemodel extension.
 */
public class SaparticlemodelManager extends GeneratedSaparticlemodelManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaparticlemodelManager.class.getName());
	 ...
	 */
	public static SaparticlemodelManager getInstance()
	{
		return (SaparticlemodelManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(
SaparticlemodelConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaparticlemodelManager() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of saparticlemodelManager called.");
		}
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of saparticlemodelManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of saparticlemodelManager called, current tenant: " + getTenant().getTenantID());
		}
	}
