 ...
 */
package com.sap.retail.commercesuite.saparticlesearch.jalo;
...
import com.sap.retail.commercesuite.saparticlesearch.constants.SaparticlesearchConstants;



/**
 * This is the extension manager of the Saparticlesearch extension.
 */
public class SaparticlesearchManager extends GeneratedSaparticlesearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaparticlesearchManager.class.getName());
	 ...
	 */
	public static SaparticlesearchManager getInstance()
	{
		return (SaparticlesearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SaparticlesearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaparticlesearchManager() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaparticlesearchManager called.");
		}
	}
	...
	public void init() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SaparticlesearchManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy() //NOSONAR
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SaparticlesearchManager called, current tenant: " + getTenant().getTenantID());
		}
	}
