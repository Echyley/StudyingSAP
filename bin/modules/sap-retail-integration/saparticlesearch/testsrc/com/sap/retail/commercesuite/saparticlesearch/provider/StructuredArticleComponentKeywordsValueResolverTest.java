 ...
 * {@link StructuredArticleComponentKeywordsValueResolver}.
 */
@UnitTest
@SuppressWarnings("javadoc")
public class StructuredArticleComponentKeywordsValueResolverTest
		extends BaseStructuredArticleComponentValueResolverTest {
	...
	@Test
	public void resolveNoKeyword() throws FieldValueProviderException {
		// given
	...
	@Test
	public void resolveNoKeywordForNotStructuredArticle() throws FieldValueProviderException {
		// given

		final Collection<IndexedProperty> indexedProperties = getIndexedProperties(Arrays.asList("componentKeywords"),
				true, false);
		if (product != null) {
	...
	@Test
	public void resolveKeywordsMultivalueNoLocale() throws FieldValueProviderException {
		// given
		final Collection<IndexedProperty> indexedProperties = getIndexedProperties(Arrays.asList("componentKeywords"),
				true, false);
		...
		if (product != null) {
			...
			verify(getInputDocument()).addField(indexedPropertiesArray[0],
					keyword1.getKeyword() + " " + keyword2.getKeyword(), null);
			verify(getInputDocument()).addField(indexedPropertiesArray[0], keyword3.getKeyword(), null);
		}
	}

	@Test
	public void resolveKeywordsSinglevalueNoLocale() throws FieldValueProviderException {
		// given
		final Collection<IndexedProperty> indexedProperties = getIndexedProperties(Arrays.asList("componentKeywords"),
				false, false);
	...
	@Test
	public void resolveKeywordsMultivalueLocale() throws FieldValueProviderException {
		// given
		final Collection<IndexedProperty> indexedProperties = getIndexedProperties(Arrays.asList("componentKeywords"),
				true, true);
		...
		if (product != null) {
			...
			final IndexedProperty[] indexedPropertiesArray = indexedProperties
					.toArray(new IndexedProperty[indexedProperties.size()]);
			verify(getInputDocument()).addField(indexedPropertiesArray[0],
					keyword1EN.getKeyword() + " " + keyword2EN.getKeyword(), getLanguageModelEN().getIsocode());
			verify(getInputDocument()).addField(indexedPropertiesArray[0],
					keyword1DE.getKeyword() + " " + keyword2DE.getKeyword(), getLanguageModelDE().getIsocode());
			verify(getInputDocument()).addField(indexedPropertiesArray[0], keyword3EN.getKeyword(),
					getLanguageModelEN().getIsocode());
			verify(getInputDocument()).addField(indexedPropertiesArray[0], keyword3DE.getKeyword(),
	...
	@Test
	public void resolveKeywordsSinglevalueLocale() throws FieldValueProviderException {
		// given
		final Collection<IndexedProperty> indexedProperties = getIndexedProperties(Arrays.asList("componentKeywords"),
				false, true);
