 ...
 */
package de.hybris.platform.sap.sappricingbackoffice.jalo;
...
import de.hybris.platform.sap.sappricingbackoffice.constants.SappricingbackofficeConstants;
 ...
 */
public class SappricingbackofficeManager extends GeneratedSappricingbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SappricingbackofficeManager.class.getName());
	 ...
	 */
	public static SappricingbackofficeManager getInstance()
	{
		return (SappricingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SappricingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SappricingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SappricingbackofficeManager called.");
		}
	}
