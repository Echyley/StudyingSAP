...
/**
 * This is the extension manager of the Sappricingproductcarouseladdon extension.
 */
public class SappricingproductcarouseladdonManager extends GeneratedSappricingproductcarouseladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SappricingproductcarouseladdonManager.class.getName());
	 ...
	 */
	public static SappricingproductcarouseladdonManager getInstance()
	{
		return (SappricingproductcarouseladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SappricingproductcarouseladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SappricingproductcarouseladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SappricingproductcarouseladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SappricingproductcarouseladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SappricingproductcarouseladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
