...
/**
 * This is the extension manager of the Sappricingbol extension.
 */
public class SappricingbolManager extends GeneratedSappricingbolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SappricingbolManager.class.getName());
	 ...
	 */
	public static SappricingbolManager getInstance()
	{
		return (SappricingbolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SappricingbolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SappricingbolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SappricingbolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SappricingbolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SappricingbolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
