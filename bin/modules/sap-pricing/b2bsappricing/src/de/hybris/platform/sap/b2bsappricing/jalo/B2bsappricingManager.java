 ...
 */
package de.hybris.platform.sap.b2bsappricing.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sap.b2bsappricing.constants.B2bsappricingConstants;
...
/**
 * This is the extension manager of the B2bsappricing extension.
 */
public class B2bsappricingManager extends GeneratedB2bsappricingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bsappricingManager.class.getName());
	 ...
	 */
	public static B2bsappricingManager getInstance()
	{
		return (B2bsappricingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bsappricingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bsappricingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bsappricingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bsappricingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bsappricingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
