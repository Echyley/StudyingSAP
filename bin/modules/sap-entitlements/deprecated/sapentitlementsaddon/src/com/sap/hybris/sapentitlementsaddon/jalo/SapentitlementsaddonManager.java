 ...
 */
package com.sap.hybris.sapentitlementsaddon.jalo;
...
import com.sap.hybris.sapentitlementsaddon.constants.SapentitlementsaddonConstants;



/**
 * This is the extension manager of the Sapentitlementsaddon extension.
 */
public class SapentitlementsaddonManager extends GeneratedSapentitlementsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapentitlementsaddonManager.class.getName());
	 ...
	 */
	public static SapentitlementsaddonManager getInstance()
	{
		return (SapentitlementsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapentitlementsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapentitlementsaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapentitlementsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapentitlementsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapentitlementsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
