...
/**
 * JUnit Tests for the Sapentitlementsfacades extension.
 */
@IntegrationTest
public class SapEntitlementFacadeIntegrationTest extends BaseCommerceBaseTest
{
	...
	public void testGetEntitlementsforCurrentCustomers()
	{
		...
		final List<EntitlementData> entitlementData = sapEntitlementFacade.getEntitlementsForCurrentCustomer(1, PAGE_SIZE);

		Assert.assertNotNull(defaultSapEntitlementOutboundService.getDestinationService());
	...
	public void testgetEntitlementForNumber()
	{
		...
		final EntitlementData entitlementData = sapEntitlementFacade.getEntitlementForNumber(dummyText);
