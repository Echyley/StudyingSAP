...
class FlowTests extends BaseWSTest {
	...
	void testCartFlowJSON() {
		...
		def password = customerTests.password

		//add something to a cart
		def postBody = "code=3429337"
		def con = testUtil.getSecureConnection('/cart/entry', 'POST', 'JSON', HttpURLConnection.HTTP_OK, postBody)
		...
		con = testUtil.getSecureConnection('/cart/entry', 'POST', 'JSON', HttpURLConnection.HTTP_OK, postBody, cookieNoPath)
		...
		con = testUtil.getSecureConnection('/cart/entry/0', 'PUT', 'JSON', HttpURLConnection.HTTP_OK, updateBody, cookieNoPath)
		...
		//remove one item
		con = testUtil.getSecureConnection('/cart/entry/0', 'DELETE', 'JSON', HttpURLConnection.HTTP_OK, null, cookieNoPath)
		response = testUtil.verifiedJSONSlurper(con)
	...
	void testCartFlowXML() {
		...
		//add something to a cart
		def postBody = "code=3429337"
		def con = testUtil.getSecureConnection('/cart/entry', 'POST', 'XML', HttpURLConnection.HTTP_OK, postBody)
		...
		//add another product, keep session
		postBody = "code=1934795&qty=2"
		con = testUtil.getSecureConnection('/cart/entry', 'POST', 'XML', HttpURLConnection.HTTP_OK, postBody, cookieNoPath)
		...
		//remove one item
		con = testUtil.getSecureConnection('/cart/entry/0', 'DELETE', 'XML', HttpURLConnection.HTTP_OK, null, cookieNoPath)
		response = testUtil.verifiedXMLSlurper(con)
