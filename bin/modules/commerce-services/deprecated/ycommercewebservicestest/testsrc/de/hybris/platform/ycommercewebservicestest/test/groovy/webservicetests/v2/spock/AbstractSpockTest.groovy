...
import de.hybris.platform.ycommercewebservicestest.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
...
abstract class AbstractSpockTest extends JUnitPlatformSpecification {
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("v2", "/ycommercewebservicestest/groovytests-property-file.groovy");
	...
	protected static final String getBasePathWithIntegrationSite() {
		def enableWsIntegrationTest = Config.getBoolean("ycommercewebservicestest.enableWsIntegrationTest", false);
