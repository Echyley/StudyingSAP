...
public class TestSetupUtils
{
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		{ "Go" });
		params.put("commercewebservicestests_sample", new String[]
		{ "true" });
	...
	public static void updateCaptchaCheckEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/captcha/captchaEnabled.impex", false);
		}
		else
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/captcha/captchaDisabled.impex", false);
		}
	}
	...
	public static void updateSapInvoiceEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/invoice/invoiceEnabled.impex", false);
		}
		else
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/invoice/invoiceDisabled.impex", false);
		}
	}
	...
	public static void updateCartRerievalDateCheckEnabled(final boolean enable)
	{
		...
		if (enable)
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/cartretrievaldate/cartRetrievalDateEnabled.impex",
					false);
		}
		else
		{
			setupImpexService.importImpexFile("/commercewebservicestests/import/cartretrievaldate/cartRetrievalDateDisabled.impex",
					false);
		}
	}
