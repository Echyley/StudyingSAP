...
abstract class AbstractUserTest extends AbstractSpockFlowTest {
	...
	protected static final GOOD_ADDRESS_DE = [
			...
			'postalCode'     : '80331',
			'phone'          : '11123234545',
			'cellphone'      : '11123234546',
			'town'           : 'Muenchen',
			'country.isocode': 'DE'
	]
	protected static final GOOD_ADDRESS_DE_JSON = "{ \"titleCode\" : \"mrs\",\"firstName\" : \"Jane\",\"lastName\" : \"Smith\",\"line1\" : \"Nymphenburger Str. 86 - Maillingerstrasse\",\"line2\" : \"pietro 2\",\"postalCode\" : \"80331\",\"phone\" : \"11123234545\",\"cellphone\" : \"11123234546\",\"town\" : \"Muenchen\",\"country\": {\"isocode\": \"DE\"}}"
	protected static final GOOD_ADDRESS_DE_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><address><titleCode>mrs</titleCode><firstName>Jane</firstName><lastName>Smith</lastName><line1>Nymphenburger Str. 86 - Maillingerstrasse</line1><line2>pietro 2</line2><postalCode>80331</postalCode><phone>11123234545</phone><cellphone>11123234546</cellphone><town>Muenchen</town><country><isocode>DE</isocode></country></address>"

	protected static final GOOD_ADDRESS_DE_NO_TITLECODE = [
			'firstName'      : 'Jane',
			'lastName'       : 'Smith',
			'line1'          : 'Nymphenburger Str. 86 - Maillingerstrasse',
			'line2'          : 'pietro 2',
	...
	protected static final GOOD_ADDRESS_DE_JSON_NO_TITLECODE = "{ \"firstName\" : \"Jane\",\"lastName\" : \"Smith\",\"line1\" : \"Nymphenburger Str. 86 - Maillingerstrasse\",\"line2\" : \"pietro 2\",\"postalCode\" : \"80331\",\"phone\" : \"11123234545\",\"town\" : \"Muenchen\",\"country\": {\"isocode\": \"DE\"}}"
	protected static final GOOD_ADDRESS_DE_XML_NO_TITLECODE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><address><firstName>Jane</firstName><lastName>Smith</lastName><line1>Nymphenburger Str. 86 - Maillingerstrasse</line1><line2>pietro 2</line2><postalCode>80331</postalCode><phone>11123234545</phone><town>Muenchen</town><country><isocode>DE</isocode></country></address>"
	...
	protected static final String DEFAULT_PAYMENT_JSON_NO_TITLECODE = "{\"accountHolderName\" : \"John Doe\", \"cardNumber\" : \"4111111111111111\", \"cardType\" : {\"code\":\"visa\"}, \"expiryMonth\" : \"01\", \"expiryYear\" : \"2117\", \"defaultPayment\" : true, \"saved\" : true,\"billingAddress\" : { \"firstName\" : \"John\", \"lastName\" : \"Doe\", \"line1\" : \"test1\", \"line2\" : \"test2\", \"postalCode\" : \"12345\", \"phone\" : \"11123234545\", \"town\" : \"somecity\",\"country\":{\"isocode\" : \"US\"},\"region\":{\"isocode\" : \"US-NY\"}}}";
	protected static final String DEFAULT_PAYMENT_XML_NO_TITLECODE = "<paymentDetails><accountHolderName>John Doe</accountHolderName><cardNumber>4111111111111111</cardNumber><cardType><code>visa</code></cardType><expiryMonth>1</expiryMonth><expiryYear>2117</expiryYear><defaultPayment>true</defaultPayment><saved>true</saved><billingAddress><firstName>John</firstName><lastName>Doe</lastName><country><isocode>US</isocode></country><region><isocode>US-NY</isocode></region><postalCode>12345</postalCode><phone>11123234545</phone><town>somecity</town><line1>test1</line1><line2>test2</line2></billingAddress></paymentDetails>"
	...
	protected static final String SECOND_PAYMENT_NON_DEFAULT_JSON = "{\"accountHolderName\" : \"Jane Smith\", \"cardNumber\" : \"4111111111111111\", \"cardType\" : {\"code\":\"visa\"}, \"expiryMonth\" : \"05\", \"expiryYear\" : \"2117\", \"defaultPayment\" : false, \"saved\" : true, \"billingAddress\" : { \"titleCode\" : \"mrs\", \"firstName\" : \"Jane\", \"lastName\" : \"Smith\", \"line1\" : \"test1\", \"line2\" : \"test2\", \"postalCode\" : \"12345\", \"phone\" : \"11123234545\", \"town\" : \"somecity\",\"country\":{\"isocode\" : \"US\"},\"region\":{\"isocode\" : \"US-NY\"}}}";
	...
	protected static final GOOD_PAYMENT = [
	...
	protected static final String GOOD_PAYMENT_JSON = "{\"accountHolderName\" : \"Jan Kowalski\", \"cardNumber\" : \"4111111111111111\", \"cardType\" : {\"code\":\"visa\"}, \"expiryMonth\" : \"03\", \"expiryYear\" : \"2020\", \"defaultPayment\" : true, \"saved\" : true,\"billingAddress\" : { \"titleCode\" : \"mr\", \"firstName\" : \"Jan\", \"lastName\" : \"Kowalski\", \"line1\" : \"Zwyciestwa 23\", \"line2\" : \"2 pietro\", \"postalCode\" : \"44100\", \"phone\" : \"11123234545\", \"town\" : \"New York\",\"country\":{\"isocode\" : \"US\"},\"region\":{\"isocode\" : \"US-NY\"}}}";
	protected static final String GOOD_PAYMENT_XML = "<paymentDetails><accountHolderName>Jan Kowalski</accountHolderName><cardNumber>4111111111111111</cardNumber><cardType><code>visa</code></cardType><expiryMonth>03</expiryMonth><expiryYear>2020</expiryYear><defaultPayment>true</defaultPayment><saved>true</saved><billingAddress><firstName>Jan</firstName><lastName>Kowalski</lastName><titleCode>mr</titleCode><country><isocode>US</isocode></country><region><isocode>US-NY</isocode></region><postalCode>44100</postalCode><phone>11123234545</phone><town>New York</town><line1>Zwyciestwa 23</line1><line2>2 pietro</line2></billingAddress></paymentDetails>"
	 ...
	 * @param payment a JSON object representing payment to be created that must contain all required fields; will be used as request body
	 * @param client REST client to be used
	 * @param customer customer for whom payment info is created
	 * @param cartId cart to which payment info is to be added.
	 * @param format format to be used
	 * @return payment info
	 */
	protected createPaymentInfo(paymentJSON, RESTClient client, customer, cartId, format = JSON) {
		HttpResponseDecorator response = client.post(
				path: getBasePathWithSite() + '/users/' + customer.id + '/carts/' + cartId + '/paymentdetails',
				body: paymentJSON,
				contentType: format,
