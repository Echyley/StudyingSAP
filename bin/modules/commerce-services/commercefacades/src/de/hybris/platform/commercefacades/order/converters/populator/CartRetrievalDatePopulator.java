 ...
 */
public class CartRetrievalDatePopulator implements Populator<CartModel, CartData>
{

	private static final Logger LOG = Logger.getLogger(CartRetrievalDatePopulator.class);
	...
	public void populate(final CartModel source, final CartData target) throws ConversionException
	{
		...
		{
			target.setEarliestRetrievalAt(source.getEarliestRetrievalDate());
