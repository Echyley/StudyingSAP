...
public class DefaultCustomerFacade implements CustomerFacade
{
	...
	public void updateFullProfile(final CustomerData customerData) throws DuplicateUidException
	{
		...
		if (Objects.nonNull(customer.getSitePreferences()))
		{
			for (final SitePreferenceModel sitePreference : customer.getSitePreferences())
			{
				if (sitePreference.getSite().equals(getBaseSiteService().getCurrentBaseSite()))
				{
					getModelService().save(sitePreference);
					break;
				}
			}
		}
