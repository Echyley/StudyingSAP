...
public class AddressPopulator implements Populator<AddressModel, AddressData>
{
	...
	protected void populateCountryAndFormattedAddress(final AddressModel source, final AddressData target)
	{
		...
		final StringBuilder formattedAddressStringBuilder = addressFormatConverter.convert(source);
		if(formattedAddressStringBuilder != null)
		{
			target.setFormattedAddress(formattedAddressStringBuilder.toString());
		}
	}
