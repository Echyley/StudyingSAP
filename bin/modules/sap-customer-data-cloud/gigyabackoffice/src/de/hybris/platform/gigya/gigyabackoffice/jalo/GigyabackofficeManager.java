 ...
 */
package de.hybris.platform.gigya.gigyabackoffice.jalo;
...
import de.hybris.platform.gigya.gigyabackoffice.constants.GigyabackofficeConstants;
 ...
 */
public class GigyabackofficeManager extends GeneratedGigyabackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(GigyabackofficeManager.class.getName());
	 ...
	 */
	public static GigyabackofficeManager getInstance()
	{
		return (GigyabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GigyabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GigyabackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GigyabackofficeManager called.");
		}
	}
