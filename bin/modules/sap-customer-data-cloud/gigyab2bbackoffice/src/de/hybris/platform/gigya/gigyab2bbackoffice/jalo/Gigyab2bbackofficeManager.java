 ...
 */
package de.hybris.platform.gigya.gigyab2bbackoffice.jalo;
...
import de.hybris.platform.gigya.gigyab2bbackoffice.constants.Gigyab2bbackofficeConstants;
 ...
 */
public class Gigyab2bbackofficeManager extends GeneratedGigyab2bbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Gigyab2bbackofficeManager.class);
	 ...
	 */
	public static Gigyab2bbackofficeManager getInstance()
	{
		return (Gigyab2bbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Gigyab2bbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Gigyab2bbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Gigyab2bbackofficeManager called.");
		}
	}
