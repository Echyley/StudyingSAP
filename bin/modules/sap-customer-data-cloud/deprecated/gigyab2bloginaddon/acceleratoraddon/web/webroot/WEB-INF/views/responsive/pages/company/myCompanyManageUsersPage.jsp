...
<%@ taglib prefix="org-common" tagdir="/WEB-INF/tags/addons/gigyab2bloginaddon/responsive/common" %>
...
<template:page pageTitle="${pageTitle}">
    <div class="account-section">
        <org-common:listHeadline url="" labelKey="text.company.manageusers.label" urlTestId="User_AddUser_button" showManageUI="true" showManageUIJS="js-open-org-mgmt-portal"
        	showManageUILabel="text.company.manageusers.button" />
        	
		<script type="text/javascript">
			var orgId = '${ycommerce:encodeJavaScript(orgId)}';
			var partnerId = '${ycommerce:encodeJavaScript(partnerId)}';
		</script>
            ...
            <c:when test="${not empty searchPageData.results}">
                <div class="account-section-content">
                    ...
                    <div class="account-overview-table">
                        <table class="responsive-table" aria-label="Users">
                            <tr class="responsive-table-head hidden-xs">
                                <th id="name"><spring:theme code="text.company.column.name.name"/></th>
                                <th id="roles"><spring:theme code="text.company.column.roles.name"/></th>
                                <th id="parent-unit"><spring:theme code="text.company.column.parentUnit.name"/></th>
                                <th id="cost-center"><spring:theme code="text.company.manageUser.user.costCenter"/></th>
                                <th id="status"><spring:theme code="text.company.status.title"/></th>
                            </tr>
