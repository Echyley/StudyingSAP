...
import de.hybris.platform.gigya.gigyab2bloginaddon.constants.Ygigyab2bloginaddonConstants;
import de.hybris.platform.util.JspContext;



/**
 * This is the extension manager of the Ygigyab2bloginaddon extension.
 */
public class Gigyab2bloginaddonManager extends GeneratedGigyab2bloginaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Gigyab2bloginaddonManager.class.getName());
	 ...
	 */
	public static Gigyab2bloginaddonManager getInstance()
	{
		return (Gigyab2bloginaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ygigyab2bloginaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Gigyab2bloginaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Gigyab2bloginaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Gigyab2bloginaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Gigyab2bloginaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
