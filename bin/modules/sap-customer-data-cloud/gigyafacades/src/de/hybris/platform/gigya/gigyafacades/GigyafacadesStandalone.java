 ...
 */
package de.hybris.platform.gigya.gigyafacades;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new de.hybris.platform.gigya.gigyafacades.GigyafacadesStandalone().run();"
 ...
 */
public class GigyafacadesStandalone {

	private static final Logger LOG = LoggerFactory.getLogger(GigyafacadesStandalone.class);
	...
	public static void main(final String[] args) {
		new GigyafacadesStandalone().run();
	}
