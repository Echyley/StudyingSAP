 ...
 */
package de.hybris.platform.gigya.gigyafacades.jalo;
...
/**
 * This is the extension manager of the Gigyafacades extension.
 */
public class GigyafacadesManager extends GeneratedGigyafacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(GigyafacadesManager.class);
	 ...
	 */
	public static GigyafacadesManager getInstance()
	{
		return (GigyafacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GigyafacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GigyafacadesManager() // NOPMD 
	{
		LOG.debug("constructor of GigyafacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of GigyafacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of GigyafacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
