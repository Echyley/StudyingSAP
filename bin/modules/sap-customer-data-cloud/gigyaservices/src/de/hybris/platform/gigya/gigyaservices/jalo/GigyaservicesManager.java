...
/**
 * This is the extension manager of the Gigyaservices extension.
 */
public class GigyaservicesManager extends GeneratedGigyaservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(GigyaservicesManager.class);
	 ...
	 */
	public static GigyaservicesManager getInstance()
	{
		return (GigyaservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GigyaservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GigyaservicesManager() // NOPMD 
	{
		LOG.debug("constructor of GigyaservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of GigyaservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of GigyaservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
