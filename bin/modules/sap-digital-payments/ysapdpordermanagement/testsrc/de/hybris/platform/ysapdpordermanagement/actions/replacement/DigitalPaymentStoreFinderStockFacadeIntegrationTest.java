...
public class DigitalPaymentStoreFinderStockFacadeIntegrationTest extends StoreFinderStockFacadeIntegrationTest
{
	@Override
	...
	{
		importCsv("/ysapdpordermanagement/test/impex/replacement/replacement-store-finder-stock-test-data.impex", "utf-8");
