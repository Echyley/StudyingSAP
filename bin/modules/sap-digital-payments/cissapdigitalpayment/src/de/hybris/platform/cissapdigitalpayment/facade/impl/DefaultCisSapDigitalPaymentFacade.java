...
public class DefaultCisSapDigitalPaymentFacade implements CisSapDigitalPaymentFacade
{
	...
	@Override
	public void setSapDigitalPaymentRegisterCardSession(String sessionId) {
		getSessionService().setAttribute(CisSapDigitalPaymentConstant.SAP_DIGITAL_PAYMENT_REG_CARD_SESSION_ID, sessionId);
	}
