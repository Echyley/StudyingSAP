...
public class DefaultExternalConfigurationParserTest
{
	...
	public void testSetRuntimeEnvironmentNull()
	{
		classUnderTest.setRuntimeEnvironment(null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testSetRuntimeEnvironmentEmptyString()
	{
		classUnderTest.setRuntimeEnvironment("");
	}
