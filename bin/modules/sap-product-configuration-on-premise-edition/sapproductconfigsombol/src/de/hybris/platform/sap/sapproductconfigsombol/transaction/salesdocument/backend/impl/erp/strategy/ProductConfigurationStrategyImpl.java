...
public class ProductConfigurationStrategyImpl implements ProductConfigurationStrategy
{
	...
	protected static final String UPDMOD = "UPDMOD";
	protected static final String ATAUT = "ATAUT";
	protected static final String HANDLE_ITEM = "HANDLE_ITEM";
	protected static final String ATNAM = "ATNAM";
	protected static final String ATVAL = "ATVAL";
			...
			final List<CharacteristicValue> characteristicValues)
	{
		if (handle.equals(refCharTableRead.getString(HANDLE_ITEM)))
		{
			...
			if (!CollectionUtils.isEmpty(valuesForContextAttribute))
			{
