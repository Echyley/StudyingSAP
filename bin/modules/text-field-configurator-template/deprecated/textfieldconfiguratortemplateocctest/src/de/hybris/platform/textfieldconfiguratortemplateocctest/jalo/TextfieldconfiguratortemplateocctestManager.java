 ...
 */
package de.hybris.platform.textfieldconfiguratortemplateocctest.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.textfieldconfiguratortemplateocctest.constants.TextfieldconfiguratortemplateocctestConstants;
...
/**
 * This is the extension manager of the Textfieldconfiguratortemplateocctest extension.
 */
public class TextfieldconfiguratortemplateocctestManager extends GeneratedTextfieldconfiguratortemplateocctestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TextfieldconfiguratortemplateocctestManager.class);
	 ...
	 */
	public static TextfieldconfiguratortemplateocctestManager getInstance()
	{
		return (TextfieldconfiguratortemplateocctestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextfieldconfiguratortemplateocctestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplateocctestManager()
	{
		LOG.debug("constructor of TextfieldconfiguratortemplateocctestManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TextfieldconfiguratortemplateocctestManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TextfieldconfiguratortemplateocctestManager called, current tenant: {}", getTenant().getTenantID());
	}
