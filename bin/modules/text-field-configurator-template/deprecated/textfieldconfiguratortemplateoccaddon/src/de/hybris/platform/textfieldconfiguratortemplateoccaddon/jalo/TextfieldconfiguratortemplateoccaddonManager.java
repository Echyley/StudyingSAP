 ...
 */
package de.hybris.platform.textfieldconfiguratortemplateoccaddon.jalo;
...
import de.hybris.platform.textfieldconfiguratortemplateoccaddon.constants.TextfieldconfiguratortemplateoccaddonConstants;



/**
 * This is the extension manager of the textfieldconfiguratortemplateoccaddon extension.
 */
public class TextfieldconfiguratortemplateoccaddonManager extends GeneratedTextfieldconfiguratortemplateoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextfieldconfiguratortemplateoccaddonManager.class.getName());
	 ...
	 */
	public TextfieldconfiguratortemplateoccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextfieldconfiguratortemplateoccaddonManager called.");
		}
	}
	 ...
	 */
	public static TextfieldconfiguratortemplateoccaddonManager getInstance()
	{
		return (TextfieldconfiguratortemplateoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextfieldconfiguratortemplateoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextfieldconfiguratortemplateoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TextfieldconfiguratortemplateoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
