 ...
 */
package de.hybris.platform.textfieldconfiguratortemplateaddon.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.textfieldconfiguratortemplateaddon.constants.TextfieldconfiguratortemplateaddonConstants;
...
/**
 * This is the extension manager of the Textfieldconfiguratortemplateaddon extension.
 */
public class TextfieldconfiguratortemplateaddonManager extends GeneratedTextfieldconfiguratortemplateaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextfieldconfiguratortemplateaddonManager.class.getName());
	 ...
	 */
	public static TextfieldconfiguratortemplateaddonManager getInstance()
	{
		return (TextfieldconfiguratortemplateaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TextfieldconfiguratortemplateaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplateaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextfieldconfiguratortemplateaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TextfieldconfiguratortemplateaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TextfieldconfiguratortemplateaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
