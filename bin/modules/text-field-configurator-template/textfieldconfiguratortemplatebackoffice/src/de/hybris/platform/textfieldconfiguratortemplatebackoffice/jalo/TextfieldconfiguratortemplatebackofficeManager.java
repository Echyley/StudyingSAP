 ...
 */
package de.hybris.platform.textfieldconfiguratortemplatebackoffice.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.textfieldconfiguratortemplatebackoffice.constants.TextfieldconfiguratortemplatebackofficeConstants;
 ...
 */
public class TextfieldconfiguratortemplatebackofficeManager extends GeneratedTextfieldconfiguratortemplatebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TextfieldconfiguratortemplatebackofficeManager.class.getName());
	 ...
	 */
	public static TextfieldconfiguratortemplatebackofficeManager getInstance()
	{
		return (TextfieldconfiguratortemplatebackofficeManager) Registry.getCurrentTenant().getJaloConnection()
				.getExtensionManager().getExtension(TextfieldconfiguratortemplatebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplatebackofficeManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TextfieldconfiguratortemplatebackofficeManager called.");
		}
	}
