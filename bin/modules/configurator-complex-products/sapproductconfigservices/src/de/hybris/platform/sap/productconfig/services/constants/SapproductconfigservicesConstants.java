...
{
	public static final String SESSION_NOT_BOUND_TO_CONFIGURATIONS = "SESSION_NOT_BOUND_TO_CONFIGURATIONS";

	public static final String EXPERT_MODE_STATE_IN_SESSION = "EXPERT_MODE_STATE_IN_SESSION";

	public static final String EXPERT_MODE_USER_GROUP = "sapproductconfigexpmodegroup";
