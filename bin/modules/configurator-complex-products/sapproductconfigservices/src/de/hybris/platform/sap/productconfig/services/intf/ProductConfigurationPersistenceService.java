...
public interface ProductConfigurationPersistenceService
{
	...
	/**
	 * read the {@link ProductConfigurationModel} associated to the given product code for the current user. In case of
	 * an anoymous user, the user seesion id is used.
	 *
	 * @param productCode
	 *           product Code
	 * @return product configuration persistence model
	...
	/**
	 * get the order entry to which the given config is currently assigned to. <b>throws an AmbigiousIdentifierException,
	 * if there exists more than one OrderEntry linked to the given configId.</b>
	 *
	 * @param configId
	...
	/**
	 * Get all order entries to which the given config is currently assigned to. In most scenarios this is exactly one or
	 * no entry at all.
	 *
	 * @param configId
	 *           product configuration id
	...
	/**
	 * Gets configurations that are neither related to any abstract order entry nor are related to any Product. So they
	 ...
	 * 
	 * @param model
	 *           ProductConfiguration representation in commerce persistence
	 * @return <code>true</code> if and only if related to any abstract order entry model
	 */
