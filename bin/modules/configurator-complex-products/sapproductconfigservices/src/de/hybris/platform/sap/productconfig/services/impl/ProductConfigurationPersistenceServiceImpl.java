...
/**
 * Default implementation for {@link ProductConfigurationPersistenceService}.
 */
public class ProductConfigurationPersistenceServiceImpl implements ProductConfigurationPersistenceService
{
	...
	public AbstractOrderEntryModel getAbstractOrderEntryByConfigPk(final String configPk, final boolean isDraft)
	{
		...
		final Map<String, Long> params = Collections.singletonMap(PARAM_NAME_CONFIG_PK, Long.valueOf(configPk));
		String query;
		if (isDraft)
		{
	...
	{
		final Map<String, Long> params = Collections.singletonMap(PARAM_NAME_CONFIG_PK,
				productConfigurationModel.getPk().getLong());
	...
	public ProductConfigurationModel getByProductCodeAndUser(final String productCode, final UserModel user)
	{
		...
		{
			params.put("userPk", user.getPk().getLong());
	...
	public AbstractOrderEntryModel getOrderEntryByPK(final String cartEntryKey)
	{
		...
		final Map<String, Long> params = Collections.singletonMap("cartEntryKey", Long.valueOf(cartEntryKey));
