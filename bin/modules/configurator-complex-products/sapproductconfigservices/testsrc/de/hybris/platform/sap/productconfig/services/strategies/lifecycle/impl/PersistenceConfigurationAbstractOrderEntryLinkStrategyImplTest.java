...
/**
 * Unit test for {@link PersistenceConfigurationAbstractOrderEntryLinkStrategyImpl}
 */
@UnitTest
public class PersistenceConfigurationAbstractOrderEntryLinkStrategyImplTest
{
	...
	public void setUp()
	{
		...
		classUnderTest.setConfigurationReleaseProductLinkStrategy(configurationReleaseProductLinkStrategy);
		...
		orderEntries = Arrays.asList(orderEntry);
	}

	@Test
	public void testConfigurationReleaseProductLinkStrategy()
	{
		assertEquals(configurationReleaseProductLinkStrategy, classUnderTest.getConfigurationReleaseProductLinkStrategy());
	}

	@Test
	public void testRemoveSessionArtifactsForCartEntry()
	{
		...
		verify(configurationReleaseProductLinkStrategy).releaseCartEntryProductRelation(orderEntry);
	...
	{
		given(persistenceService.getAllOrderEntriesByConfigId(CONFIG_ID)).willReturn(orderEntries);
		assertEquals(orderEntry, classUnderTest.getAbstractOrderEntryForConfigId(CONFIG_ID));
	}
}
