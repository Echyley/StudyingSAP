...
/**
 * Unit test for {@link ProductConfigurationVariantSearchServiceImpl}
 */
@UnitTest
public class ProductConfigurationVariantSearchServiceImplTest
{
	...
	public void setUp() throws NoValidSolrConfigException
	{
		...
		when(productConfigurationService.retrieveConfigurationOverview(CONFIG_ID)).thenReturn(configurationModel);
	...
	{
		final ProductSearchService searchService = new DefaultSolrProductSearchService<>();
