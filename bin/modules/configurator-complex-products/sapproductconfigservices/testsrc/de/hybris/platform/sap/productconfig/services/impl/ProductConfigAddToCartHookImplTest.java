...
/**
 * Unit test for {@link ProductConfigAddToCartHookImpl}
 */
@UnitTest
public class ProductConfigAddToCartHookImplTest
{
	...
	{
		classUnderTest.afterAddToCart(null, null); // should not crash
		verifyNoInteractions(configurationPricingOrderIntegrationService);
	}
