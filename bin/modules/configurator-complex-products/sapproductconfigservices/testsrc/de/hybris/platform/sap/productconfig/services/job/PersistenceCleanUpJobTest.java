...
/**
 * Unit test for {@link PersistenceCleanUpJob}
 */
@UnitTest
public class PersistenceCleanUpJobTest
{
	...
	{
		when(productConfigurationPersistenceService.isRelatedToAbstractOrderEntry(productConfiguration)).thenReturn(true);
		classUnderTest.cleanUpProductConfiguration(productConfiguration);
