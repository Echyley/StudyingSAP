...
/**
 * Unit test for {@link SwitchableProviderFactoryImpl}
 */
@UnitTest
...
public class SwitchableProviderFactoryImplTest
{
	...
	@InjectMocks
	private SwitchableProviderFactoryForTest overwrittenClassUnderTest;
	...
	private List<String> providerFactories;
	...
	public void setUp()
	{
		...
		overwrittenClassUnderTest.setRegisteredProviderFactories(providerFactories);
	...
	@Test
	public void testGetProviderFactoryViaConfiguredProperty()
	{
		assertEquals(anotherFactory, overwrittenClassUnderTest.getActiveProviderFactory());
	}

	@Test
	public void testGetProviderFactoryConfiguredPropertyNotExisting()
	{
		providerFactories.remove(ANOTHER_PROVIDER_FACTORY);
		overwrittenClassUnderTest.setRegisteredProviderFactories(providerFactories);
		assertEquals(defaultFactory, overwrittenClassUnderTest.getActiveProviderFactory());
	}


	private static class SwitchableProviderFactoryForTest extends SwitchableProviderFactoryImpl
	{

		@Override
		protected String getFactoryBeanNameConfiguredViaProperty()
		{
			return ANOTHER_PROVIDER_FACTORY;
		}
	}
}
