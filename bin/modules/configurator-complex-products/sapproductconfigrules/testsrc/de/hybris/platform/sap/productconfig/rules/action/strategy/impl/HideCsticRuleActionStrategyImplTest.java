...
@UnitTest
public class HideCsticRuleActionStrategyImplTest
{

	private HideCsticRuleActionStrategyImpl classUnderTest;
	...
	public void setUp()
	{
		classUnderTest = new HideCsticRuleActionStrategyImpl();
	...
	public void testEsxecuteAction()
	{
		...
		assertFalse(cstic.isVisible());
	}

	@Test
	public void testEsxecuteAction_alreadyHidden()
	{
