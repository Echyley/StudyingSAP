...
public class ConflictCheckerImpl implements ConflictChecker
{
	...
	public static final int ERROR_CODE_ARRAY_LENGTH = 2;
	public static final int ERROR_CODE_WITH_FIELDNAME_INDEX = 0;
	public static final int ERROR_CODE_INDEX = 1;
	...
	protected boolean checkMondatoryFieldsInSubGroup(final UiGroupData group, final String path, final BindingResult bindingResult,
			final UiGroupData subGroup)
	{
	...
	{
		final String[] errorCodes = new String[ERROR_CODE_ARRAY_LENGTH];

		switch (type)
		{
			case RADIO_BUTTON:
			case DROPDOWN:
				errorCodes[ERROR_CODE_WITH_FIELDNAME_INDEX] = DEFAULT_MISSING_MANDATORY_RADIO_CODE_WITH_FIELDNAME;
				errorCodes[ERROR_CODE_INDEX] = DEFAULT_MISSING_MANDATORY_RADIO_CODE;
				break;
			case CHECK_BOX_LIST:
				errorCodes[ERROR_CODE_WITH_FIELDNAME_INDEX] = DEFAULT_MISSING_MANDATORY_MULTI_CODE_WITH_FIELDNAME;
				errorCodes[ERROR_CODE_INDEX] = DEFAULT_MISSING_MANDATORY_MULTI_CODE;
				break;
			default:
				errorCodes[ERROR_CODE_WITH_FIELDNAME_INDEX] = DEFAULT_MISSING_MANDATORY_TEXT_CODE_WITH_FIELDNAME;
				errorCodes[ERROR_CODE_INDEX] = DEFAULT_MISSING_MANDATORY_TEXT_CODE;
				break;
		}
		return errorCodes;
	}
