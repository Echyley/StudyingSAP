...
public class NumericCheckerImplTest
{
	...
	@Test
	public void testValidateValue_DE_AssertionTrue() throws Exception
	{
		final DecimalFormatSymbols symbols = new DecimalFormatSymbols(Locale.GERMAN);
		assertTrue("Input is valid: true", classUnderTest.validateValue("123", symbols));
		assertTrue("Input is valid: true", classUnderTest.validateValue("123,95", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("12.395", symbols));
		assertTrue("Input is valid: true", classUnderTest.validateValue("1.423.895", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("+123,56", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("-123,56", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("1234565", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("123123456789123455", symbols));
		assertTrue("Input is valid: false", classUnderTest.validateValue("12348885,65", symbols));
	}

	@Test
	public void testValidateValue_DE_AssertionFalse() throws Exception
	{
		final DecimalFormatSymbols symbols = new DecimalFormatSymbols(Locale.GERMAN);
		assertFalse("Input is valid: false", classUnderTest.validateValue("123abc", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("123,95abc", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("12.395abc", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("1a2b3c", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("1....222", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("1,,,,222", symbols));
	}

	@Test
	public void testValidateValue_EN_AssertionTrue() throws Exception
	{
	...
	@Test
	public void testValidateValue_EN_AssertionFalse() throws Exception
	{
		final DecimalFormatSymbols symbols = new DecimalFormatSymbols(Locale.ENGLISH);
		assertFalse("Input is valid: false", classUnderTest.validateValue("123abc", symbols));
		assertFalse("Input is valid: false", classUnderTest.validateValue("123.95abc", symbols));
