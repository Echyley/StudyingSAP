...
public interface ConfigurationProvider
{
	 ...
	 *
	 * @param cachedModel
	 *                        already cached configuration model
	 * @param currentGroup
	 *                        group for which detailed information should be added to the cached configuration model
	 * @throws ConfigurationEngineException
	 */
	default void enrichModelWithGroup(final ConfigModel cachedModel, final String currentGroup)
			throws ConfigurationEngineException
	{
		throw new NotImplementedException("This function is not supported by this configuration provider");
	}
	...
	/**
	 * Retrieve the current state of the configuration model for the requested <code>configId</code> and
	 ...
	 *                        group for which detailed information should be added to the cached configuration model
	 * @param overviewOnly
	 *                        only for configuration overview: group detailed information is not required
	 * @param options
	 *                        options to consider while reading the configuration, such as additional/updated variant
	 *                        conditions for pricing
	 * @return The actual configuration
	 * @throws ConfigurationEngineException
	 *                                         Service has failed, e.g. because session timed out
	 */
	default ConfigModel retrieveConfigurationModel(final String configId, final String groupId, final boolean overviewOnly,
	...
	/**
	 * @return returns <code>true</code> if this configuration provider supports group based requests for configuration read
	 */
