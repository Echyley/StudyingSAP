...
public class TextConverterBaseImpl implements TextConverterBase
{
	...
	private static final Pattern pFormat = Pattern.compile("\\<[\\/\\w]\\w*\\>");
	private static final Pattern pMarkup = Pattern.compile("\\<.*?\\>");
	private static final Pattern pEscapeSeq = Pattern.compile("\\<(:?\\)|\\()\\>");
