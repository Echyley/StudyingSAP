...
public class ConfigModelFactoryImplTest
{
	...
	private void checkInstanceOfConfigModel(final String className)
	{
		final ConfigModel configModel = classUnderTest.createModelInstance(className,
	...
	{
		checkInstanceOfConfigModel("");
	}

	@Test
	public void testCreateModelInstanceWithNullTargetClassName()
	{
		checkInstanceOfConfigModel(null);
	}

	@Test
	public void testCreateModelInstance()
	{
		checkInstanceOfConfigModel("de.hybris.platform.sap.productconfig.runtime.interf.model.impl.ConfigModelImpl");
	}
