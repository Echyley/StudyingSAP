...
/**
 * Unit test for {@link UniqueKeyGeneratorImpl}
 */
@UnitTest
public class UniqueKeyGeneratorImplTest
{
	...
	private static final String GROUP_NAME_GEN = "_GEN";
	private static final String UIGROUP_ID = "1-THE_PRODUCT@" + GROUP_NAME_GEN;
	...
	private UniqueKeyGeneratorImpl classUnderTest;
	...
	{
		classUnderTest = new UniqueKeyGeneratorImpl();
	...
	{
		assertEquals(GROUP_NAME_GEN, classUnderTest.retrieveGroupName(UIGROUP_ID));
	}
