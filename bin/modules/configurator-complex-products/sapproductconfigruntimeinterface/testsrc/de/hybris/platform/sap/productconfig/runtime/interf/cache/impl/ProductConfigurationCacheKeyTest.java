...
public class ProductConfigurationCacheKeyTest
{
	...
	{
		assertNotEquals(new ProductConfigurationCacheKey(keys, CacheUnitValueType.SERIALIZABLE, "another type code", TENANT_ID),
				classUnderTest);
		assertNotEquals(new ProductConfigurationCacheKey(keys, CacheUnitValueType.SERIALIZABLE, TYPE_CODE, "another tenant"),
				classUnderTest);
	...
	public void testEqualsDifferentClass()
	{
		final DifferentCacheKey differentCacheKey = new DifferentCacheKey(keys, CacheUnitValueType.SERIALIZABLE, TYPE_CODE,
				TENANT_ID);
		assertNotEquals(differentCacheKey, classUnderTest);
	}

	@Test
	public void testEqualsCacheUnitValueTypeIsIgnored()
	{
		assertEquals(new ProductConfigurationCacheKey(keys, CacheUnitValueType.NON_SERIALIZABLE, TYPE_CODE, TENANT_ID),
				classUnderTest);
	}
	...
	public void testEqualsIsEqual()
	{
		final ProductConfigurationCacheKey anotherCacheKey = new ProductConfigurationCacheKey(keys, CacheUnitValueType.SERIALIZABLE,
				TYPE_CODE, TENANT_ID);
		assertEquals(anotherCacheKey, classUnderTest);
	}
