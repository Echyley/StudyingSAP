...
*/
	private void equalsTestOnFields(final Object obj1, final Object obj2, final String skipFields) throws Exception
	{
		...
		for (final Field field : fields)
		{
			...
			assertNotEquals(fieldName, obj1, obj2);
			assertNotEquals(fieldName, obj1.hashCode(), obj2.hashCode());

			field.set(obj2, obj);
			assertEquals(fieldName, obj1, obj2);
			assertEquals(fieldName, obj1.hashCode(), obj2.hashCode());
		}
	}
