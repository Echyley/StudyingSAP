...
public class CsticModelImplTest
{
	...
	{
		assertNotNull(cstic1);
		assertNotEquals(new DummyCsticModel(), cstic1);
		assertEquals(cstic1, cstic2);
	}
	...
	private static class DummyCsticModel extends CsticModelImpl
	{
		//dummy
	}
}
