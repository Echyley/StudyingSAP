...
public class CsticModelBuilderTest
{
	...
	private static final String ENTRY_FIELD_MASK = "_____";
	...
	@Test
	public void testWithEntryFieldMask()
	{
		final CsticModel csticModel = classUnderTest.withEntryFieldMask(ENTRY_FIELD_MASK).build();
		assertEquals(ENTRY_FIELD_MASK, csticModel.getEntryFieldMask());
	}
