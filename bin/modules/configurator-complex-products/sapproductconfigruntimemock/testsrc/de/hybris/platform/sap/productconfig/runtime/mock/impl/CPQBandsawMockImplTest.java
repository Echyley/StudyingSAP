...
/**
 * Unit test for {@link CPQBandsawMockImpl}
 */
@UnitTest
public class CPQBandsawMockImplTest
{
	...
	public void setUp()
	{
		...
		model.setKbKey(new KBKeyImpl("CONF_BANDSAW_ML"));
	...
	public void testCheckCstic()
	{
		...
		assertTrue(cstic.isConsistent());
		assertTrue(cstic.isComplete());
	}
	...
	public void testCupboardDefailt()
	{
		...
		assertFalse(cupboard.isVisible());
	}
	...
	public void testTiltTableDefault()
	{
		...
		assertFalse(tiltAngleL.isVisible());
		assertFalse(tiltAngleR.isVisible());
	}

	@Test
	public void testTilTableNegativValue()
	{
		final CsticModel tiltAngleL = instance.getCstic(CPQBandsawMockImpl.CONF_BS_TILT_ANGLE_L);
		assertEquals("-__", tiltAngleL.getEntryFieldMask());
	}
	...
	public void testTiltTableTrue()
	{
		...
		assertTrue(tiltAngleL.isVisible());
		assertTrue(tiltAngleR.isVisible());
	}
	...
	public void testGroupsCreated()
	{
		...
		assertEquals(1, genGroup.getCsticNames().size());
