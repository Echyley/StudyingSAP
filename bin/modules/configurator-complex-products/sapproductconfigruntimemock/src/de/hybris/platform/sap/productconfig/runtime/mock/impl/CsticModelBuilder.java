...
public class CsticModelBuilder
{
	...
	public static final int DEAULT_STRING_TYPE_LENGTH = 30;
	...
	public CsticModelBuilder stringType()
	{
		...
		cstic.setTypeLength(DEAULT_STRING_TYPE_LENGTH);
	...
	public CsticModelBuilder addAssignableValue(final CsticValueModel value)
	{
		final List<CsticValueModel> values = new ArrayList(cstic.getAssignableValues());
		values.add(value);
	...
	public CsticModelBuilder withPlaceHolder(final String placeHolder)
	{
		cstic.setPlaceholder(placeHolder);
		return this;
	}
	...
	public CsticModelBuilder visible()
	{
		cstic.setVisible(true);
		return this;
	}
	...
	public CsticModelBuilder incomplete()
	{
		cstic.setComplete(false);
		return this;
	}

	public CsticModelBuilder inconsistent()
	{
		cstic.setConsistent(false);
		return this;
	}

	public CsticModelBuilder withEntryFieldMask(final String entryFieldMask)
	{
		cstic.setEntryFieldMask(entryFieldMask);
		return this;
	}
}
