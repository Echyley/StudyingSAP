...
public class ConfigurationOverviewFacadeImpl implements ConfigurationOverviewFacade
{
	...
	private ConfigurationMessageMapper configMessagesMapper;
			...
			final ConfigurationOverviewData oldConfigOverview)
	{
		...
		getConfigMessagesMapper().mapMessagesFromModelToData(configOverview, configModel);
	...
	{
		return configMessagesMapper;
	}

	@Required
	public void setConfigMessagesMapper(final ConfigurationMessageMapper configMessagesMapper)
	{
		this.configMessagesMapper = configMessagesMapper;
	}
