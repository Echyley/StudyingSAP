...
/**
 * Unit test for {@link ProductConfigAddToCartStrategy}
 */
@UnitTest
public class ProductConfigAddToCartStrategyTest
{
	...
	public void setUp()
	{
		...
		createValidEntity();
		createCartEntry();
		Mockito.when(cartService.addNewEntry(Mockito.nullable(CartModel.class), Mockito.nullable(ProductModel.class), Mockito.anyLong(), Mockito.nullable(UnitModel.class),
