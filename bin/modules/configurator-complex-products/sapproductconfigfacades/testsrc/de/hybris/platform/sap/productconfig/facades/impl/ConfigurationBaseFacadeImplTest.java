...
/**
 * Unit test for {@link ConfigurationBaseFacadeImpl}
 */
@UnitTest
public class ConfigurationBaseFacadeImplTest
{
	...
	@Test
	public void testPopulateConfigDataFromModelConflictBehaviour()
	{
		configModel.setImmediateConflictResolution(true);
		classUnderTest.populateConfigDataFromModel(configData, configModel);
		assertTrue(configData.isImmediateConflictResolution());
	}
	...
	public void testGetConfigurationModelVariantProduct()
	{
		...
		given(variantProductModelMock.getCode()).willReturn("XXX");
		final ConfigModel configModel = classUnderTest.getConfigurationModel(kbKey);
