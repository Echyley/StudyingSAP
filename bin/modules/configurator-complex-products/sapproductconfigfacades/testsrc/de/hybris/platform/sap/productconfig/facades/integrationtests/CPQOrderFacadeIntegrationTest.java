...
public class CPQOrderFacadeIntegrationTest extends CPQFacadeLayerTest
{
			...
			throws CommerceCartModificationException, InvalidCartException, InvalidCredentialsException
	{
		 ...
		 */
		cpqService.updateConfiguration(cpqService.retrieveConfigurationOverview(configData.getConfigId()));
	}
	...
	protected void createCartEntry() throws CommerceCartModificationException
	{
		ConfigurationData configData = cpqFacade.getConfiguration(KB_KEY_Y_SAP_SIMPLE_POC);
		facadeConfigValueHelper.setCsticValue(configData, "YSAP_POC_SIMPLE_FLAG", "X", false);
		cpqFacade.updateConfiguration(configData);
