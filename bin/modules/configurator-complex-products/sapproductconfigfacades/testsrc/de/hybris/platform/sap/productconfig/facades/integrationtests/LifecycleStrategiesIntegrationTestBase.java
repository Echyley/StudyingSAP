...
public class LifecycleStrategiesIntegrationTestBase extends CPQFacadeLayerTest
{
	...
	protected String defaultUnitTestUser;
	...
	public void setUp() throws Exception
	{
		...
		prepareCPQData();
		anonymousUserName = UserManager.getInstance().getAnonymousCustomer().getName();
		defaultUnitTestUser = JaloSession.getCurrentSession().getUser().getName();
	}
	...
	public void testLinkToProduct() throws CommerceCartModificationException
	{
		...
		lifecycleChecker.checkProductConfiguration(configuration.getConfigId(), defaultUnitTestUser, PRODUCT_CODE_YSAP_SIMPLE_POC);
		...
		lifecycleChecker.checkProductConfiguration(configuration.getConfigId(), defaultUnitTestUser, null, cartItemHandle, false);
	}
	...
	public void testLinkToCartEntryForVariantThenRestore() throws CommerceCartModificationException
	{
		...
		lifecycleChecker.checkProductConfiguration(configuration.getConfigId(), defaultUnitTestUser, PRODUCT_CODE_CPQ_LAPTOP);
		...
		lifecycleChecker.checkProductConfiguration(restordConfiguration.getConfigId(), defaultUnitTestUser, null, cartItemHandle,
				false);
	}
	...
	public void testAddToCartThenConfigureTwice() throws CommerceCartModificationException
	{
		...
		lifecycleChecker.checkProductConfiguration(configData.getConfigId(), defaultUnitTestUser, PRODUCT_CODE_CPQ_LAPTOP);
		...
		lifecycleChecker.checkProductConfiguration(configData.getConfigId(), defaultUnitTestUser, null, cartItemHandle, false);
		lifecycleChecker.checkNumberOfConfigsPersisted(1);
		...
		lifecycleChecker.checkProductConfiguration(configData2.getConfigId(), defaultUnitTestUser, null, cartItemHandle, true);
		lifecycleChecker.checkProductConfiguration(configData.getConfigId(), defaultUnitTestUser, null, cartItemHandle, false);
		...
		lifecycleChecker.checkProductConfiguration(configData3.getConfigId(), defaultUnitTestUser, null, cartItemHandle, true);
		lifecycleChecker.checkProductConfiguration(configData.getConfigId(), defaultUnitTestUser, null, cartItemHandle, false);
		...
		lifecycleChecker.checkProductConfiguration(configData3.getConfigId(), defaultUnitTestUser, null, cartItemHandle, false);
	...
	public void testLinkToCartEntryThenRemove() throws CommerceCartModificationException, InvalidCredentialsException
	{
		// create default configuration ==>  config id is persisted
		final ConfigurationData configuration = cpqFacade.getConfiguration(KB_KEY_Y_SAP_SIMPLE_POC);
		lifecycleChecker.checkProductConfiguration(configuration.getConfigId(), defaultUnitTestUser,
		...
		lifecycleChecker.checkProductConfiguration(darftConfiguration.getConfigId(), defaultUnitTestUser, null, cartItemHandle,
				true);
	...
	public void testUpdateUserAfterLogIn() throws CommerceCartModificationException, InvalidCredentialsException
	{
		...
		lifecycleChecker.checkProductConfiguration(config1.getConfigId(), defaultUnitTestUser,
				KB_KEY_Y_SAP_SIMPLE_POC.getProductCode());
		lifecycleChecker.checkProductConfiguration(config2.getConfigId(), defaultUnitTestUser, KB_KEY_CPQ_LAPTOP.getProductCode());
		lifecycleChecker.checkProductConfiguration(config3.getConfigId(), defaultUnitTestUser,
				KB_KEY_CPQ_HOME_THEATER.getProductCode());
	...
	public void testSanityCheckToProductLinkPersistent() throws InvalidCredentialsException
	{
		...
		lifecycleChecker.checkProductConfiguration(configAnonymus.getConfigId(), anonymousUserName, PRODUCT_CODE_CPQ_LAPTOP);
		lifecycleChecker.checkNumberOfConfigsPersisted(2);
	...
	public void testSanityCheckToProductLinkDefault() throws InvalidCredentialsException
	{
		...
		// old for CPQ_LAPTOP should be deleted, the one created with the anonymousUserName user should remain
		lifecycleChecker.checkNumberOfConfigsPersisted(1);
		lifecycleChecker.checkConfigDeleted(config.getConfigId(), null);
		lifecycleChecker.checkProductConfiguration(configAnonymus.getConfigId(), USER_NAME, PRODUCT_CODE_CPQ_LAPTOP);
	...
	public void testReleaseConfigurationsOnSessionExpire() throws JaloSecurityException
	{
		...
		lifecycleChecker.checkProductConfiguration(config1.getConfigId(), anonymousUserName,
				KB_KEY_Y_SAP_SIMPLE_POC.getProductCode());
		lifecycleChecker.checkProductConfiguration(config2.getConfigId(), anonymousUserName, KB_KEY_CPQ_LAPTOP.getProductCode());
		lifecycleChecker.checkProductConfiguration(config3.getConfigId(), anonymousUserName,
				KB_KEY_CPQ_HOME_THEATER.getProductCode());
			...
			throws CommerceCartModificationException, InvalidCartException, InvalidCredentialsException
	{
		...
		lifecycleChecker.checkNumberOfConfigsPersisted(0);
		lifecycleChecker.checkConfigDeleted(configIdAfterCheckout, ret.cartItemHandle, false);
	}
	...
	protected PrepareProcessTestReturnContainer prepareProcessTest()
			throws CommerceCartModificationException, InvalidCredentialsException
	{
		// 1) anonymousUserName user configures and adds config to cart
		JaloSession.getCurrentSession().setUser(UserManager.getInstance().getAnonymousCustomer());
		...
		lifecycleChecker.checkNumberOfConfigsPersisted(1);
		lifecycleChecker.checkProductConfiguration(configIdBeforeCheckout, anonymousUserName, PRODUCT_CODE_YSAP_SIMPLE_POC);
		...
		final String cartItemHandle = cpqCartFacade.addConfigurationToCart(configData);
		lifecycleChecker.checkNumberOfConfigsPersisted(1);
		lifecycleChecker.checkProductConfiguration(configIdBeforeCheckout, anonymousUserName, null, cartItemHandle, false);
