...
/**
 * Unit test for {@link ClassificationSystemCPQAttributesProviderImpl}
 */
@UnitTest
public class ClassificationSystemCPQAttributesProviderImplTest
{
	...
	private final Map<String, ClassificationSystemCPQAttributesContainer> nameMap = new HashMap<>();
...

	{
		...
		classUnderTest.setClassificationAttributeDescriptionAccess(classificationAttributeDescriptionAccess);
		...
		when(classificationAttributeDescriptionAccess.getDescription(attribute)).thenReturn("description");
	...
	@Test
	public void testGetCsticMediaWithoutMediaFormatQualifiers()
	{
	...
	@Test
	public void testGetCsticValueMediaWithoutMediaFormatQualifiers()
	{
		final Map<String, Collection<MediaModel>> csticValueMedia = new HashMap<>();
		final Collection<MediaModel> media = new ArrayList<>();
		final MediaModel medium = new MediaModel();
		...
		when(mockCPQCsticImageFormatMapping.getCPQMediaFormatQualifiers()).thenReturn(Collections.EMPTY_MAP);
		final ClassificationSystemCPQAttributesContainer cpqAttributes = new ClassificationSystemCPQAttributesContainer("code",
				"name", null, Collections.emptyMap(), Collections.emptyMap(), Collections.emptyList(), csticValueMedia);
	...
	protected Collection<MediaModel> prepareDataForConvertMediaToImagesWithoutFormatQualifier(
	...
	public void testGetCPQAttributesWithNameMap()
	{
		final ClassificationSystemCPQAttributesContainer cpqAttributes = new ClassificationSystemCPQAttributesContainer("code",
				null, null, Collections.emptyMap(), Collections.emptyMap(), Collections.emptyList(), Collections.emptyMap());
		nameMap.put("name_en_US", cpqAttributes);
	...
	{
		final ClassificationSystemCPQAttributesContainer result = classUnderTest.getCPQAttributes("name", null);
		assertNotNull(result);
	}
	...
	public void testGetCPQAttributes()
	{
		...
		assertNotNull(result);
		assertEquals(cpqAttributes, result);
		assertEquals(cpqAttributes, nameMap.get(NAME + "_en_US"));
	}

	@Test
	public void testGetCPQAttributesForDifferentLocales()
	{
		catalogs.add(classificationSystem200);
		final ClassificationSystemCPQAttributesContainer result1 = classUnderTest.getCPQAttributes(NAME, nameMap);
		when(i18NService.getCurrentLocale()).thenReturn(Locale.GERMANY);
		final ClassificationSystemCPQAttributesContainer result12 = classUnderTest.getCPQAttributes(NAME, nameMap);
		assertEquals(2, nameMap.size());
	}

	@Test
	public void testGetCPQAttributesForSameLocales()
	{
		catalogs.add(classificationSystem200);
		final ClassificationSystemCPQAttributesContainer result1 = classUnderTest.getCPQAttributes(NAME, nameMap);
		final ClassificationSystemCPQAttributesContainer result12 = classUnderTest.getCPQAttributes(NAME, nameMap);
