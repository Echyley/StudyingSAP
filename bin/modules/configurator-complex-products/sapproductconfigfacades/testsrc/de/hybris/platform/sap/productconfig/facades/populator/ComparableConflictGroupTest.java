...
/**
 * Unit test for {@link ComparableConflictGroup}
 */
@UnitTest
public class ComparableConflictGroupTest
{
	...
	{
		prepareTestData();
		assertEquals(firstConflict, firstConflict);
	}
	...
	public void testEqualsSameRanking()
	{
		...
		firstConflict.getCstics().remove(cstic1);
		secondConflict.getCstics().remove(cstic2);
		assertEquals(firstConflict, secondConflict);
	}
	...
	{
		prepareTestData();
		assertNotEquals(firstConflict, secondConflict);
	}
	...
	{
		prepareTestData();
		assertNotEquals(firstConflict.hashCode(), secondConflict.hashCode());
	}
