...
public abstract class CPQFacadeLayerTest extends CPQServiceLayerTest
{
	...
	protected static final String LOGICAL_SYSTEM = "RR5CLNT910";
	...
	protected static final KBKeyData KB_KEY_CONF_CAMERA_SL;
	...
	static
	{
		...
		KB_KEY_CONF_CAMERA_SL = new KBKeyData();
		KB_KEY_CONF_CAMERA_SL.setProductCode("CONF_CAMERA_SL");
		KB_KEY_CONF_CAMERA_SL.setKbName("KB_KB_KEY_CONF_CAMERA_SL");
		KB_KEY_CONF_CAMERA_SL.setKbLogsys(LOGICAL_SYSTEM);
		KB_KEY_CONF_CAMERA_SL.setKbVersion(KB_VERSION);
		...
		KB_KEY_NUMERIC_PRODUCT.setKbName("000000000000056227");
		...
		KB_KEY_MIXER = new KBKeyData();
		KB_KEY_MIXER.setProductCode("KD990MIX");
		KB_KEY_MIXER.setKbName("KD990MIX");
	}
	...
	protected void removeB2BCartPopulator(final AbstractPopulatingConverter<CartModel, CartData> cartConverter)
	{
