 ...
 */
package com.sap.hybris.sapserviceorderbackoffice.jalo;
...
import com.sap.hybris.sapserviceorderbackoffice.constants.SapserviceorderbackofficeConstants;
 ...
 */
public class SapserviceorderbackofficeManager extends GeneratedSapserviceorderbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapserviceorderbackofficeManager.class.getName());
	 ...
	 */
	public static SapserviceorderbackofficeManager getInstance()
	{
		return (SapserviceorderbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapserviceorderbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapserviceorderbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapserviceorderbackofficeManager called.");
		}
	}
