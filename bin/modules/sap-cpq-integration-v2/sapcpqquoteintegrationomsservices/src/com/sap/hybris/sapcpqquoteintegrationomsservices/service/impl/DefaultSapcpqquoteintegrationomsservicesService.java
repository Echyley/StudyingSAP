 ...
 */
package com.sap.hybris.sapcpqquoteintegrationomsservices.service.impl;
...
public class DefaultSapcpqquoteintegrationomsservicesService implements SapcpqquoteintegrationomsservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpqquoteintegrationomsservicesService.class);
	...
	private static final String FIND_LOGO_QUERY = "SELECT {" + ItemModel.PK + "} FROM {"
	...
	{
		return DefaultSapcpqquoteintegrationomsservicesService.class.getResourceAsStream("/sapcpqquoteintegrationomsservices/sap-hybris-platform.png");
	}
