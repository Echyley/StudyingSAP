...
import com.sap.hybris.constants.SapcpqquoteintegrationaddonConstants;



/**
 * This is the extension manager of the Sapcpqquoteintegrationaddon extension.
 */
public class SapcpqquoteintegrationaddonManager extends GeneratedSapcpqquoteintegrationaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcpqquoteintegrationaddonManager.class.getName());
	 ...
	 */
	public static SapcpqquoteintegrationaddonManager getInstance()
	{
		return (SapcpqquoteintegrationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcpqquoteintegrationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcpqquoteintegrationaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcpqquoteintegrationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcpqquoteintegrationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcpqquoteintegrationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
