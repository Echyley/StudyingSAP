 ...
 *
 * @deprecated Since 6.0. Use {@link de.hybris.platform.b2bcommercefacades.company.impl.DefaultB2BCostCenterFacade},
 *             {@link de.hybris.platform.b2bcommercefacades.company.impl.DefaultB2BUserGroupFacade},
 *             {@link de.hybris.platform.b2bcommercefacades.company.impl.DefaultB2BUnitFacade},
 *             {@link de.hybris.platform.b2bcommercefacades.company.impl.DefaultB2BBudgetFacade},
 *             {@link de.hybris.platform.b2bcommercefacades.company.impl.DefaultB2BUserFacade},
 *             {@link de.hybris.platform.b2bapprovalprocessfacades.company.impl.DefaultB2BApprovalProcessFacade},
 *             {@link de.hybris.platform.b2bapprovalprocessfacades.company.impl.DefaultB2BApproverFacade} and
 *             {@link de.hybris.platform.b2bapprovalprocessfacades.company.impl.DefaultB2BPermissionFacade} instead.
 */
...
public class DefaultCompanyB2BCommerceFacade implements CompanyB2BCommerceFacade
{
	...
	private Populator<B2BBudgetData, B2BBudgetModel> b2BBudgetReversePopulator;
	private Populator<B2BCostCenterData, B2BCostCenterModel> b2BCostCenterReversePopulator;
	private Converter<B2BPermissionTypeEnum, B2BPermissionTypeData> b2BPermissionTypeDataConverter;
	private Populator<B2BPermissionData, B2BPermissionModel> b2BPermissionReversePopulator;
	...
	private Populator<B2BUnitData, B2BUnitModel> b2BUnitReversePopulator;
	...
	public B2BBudgetData getBudgetDataForCode(final String budgetCode)
	{
		...
		if (budgetModel != null)
		{
			...
			if (CollectionUtils.isNotEmpty(budgetModel.getCostCenters()) && b2BBudgetData != null)
			{
	...
	/**
	 * @deprecated Since 6.0. Use {@link B2BCompanyUtils#convertPageData(SearchPageData, Converter)} instead.
	 */
	@Deprecated(since = "6.0", forRemoval = true)
	...
	/**
	 * @deprecated Since 6.0. Use {@link B2BCompanyUtils#createB2BSelectionData(String, boolean, boolean)} instead.
	 */
	@Deprecated(since = "6.0", forRemoval = true)
	...
	/**
	 * @deprecated Since 6.0. Use {@link B2BCompanyUtils#populateRolesForCustomer(B2BCustomerModel, B2BSelectionData)}
	 *             instead.
	 */
	@Deprecated(since = "6.0", forRemoval = true)
	...
	@Required
	public void setB2BBudgetReversePopulator(final Populator<B2BBudgetData, B2BBudgetModel> b2bBudgetReversePopulator)
	{
	...
	@Required
	public void setB2BCostCenterReversePopulator(
			final Populator<B2BCostCenterData, B2BCostCenterModel> b2bCostCenterReversePopulator)
	{
	...
	@Required
	public void setB2BPermissionReversePopulator(
			final Populator<B2BPermissionData, B2BPermissionModel> b2bPermissionReversePopulator)
	{
	 ...
	 */
	@Required
	public void setB2BUnitReversePopulator(final Populator<B2BUnitData, B2BUnitModel> b2bUnitReversePopulator)
	{
		this.b2BUnitReversePopulator = b2bUnitReversePopulator;
	}
	...
	{
		b2BApproverService = b2bApproverService;
	}
