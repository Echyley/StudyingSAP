...
/**
 * @deprecated Since 6.0. Use {@link DefaultB2BUserGroupFacade} instead.
 */
@Deprecated(since = "6.0", forRemoval = true)
public class DefaultB2BCommerceB2BUserGroupFacade extends DefaultCompanyB2BCommerceFacade implements B2BCommerceB2BUserGroupFacade
{
	...
	{
		final SearchPageData<CustomerData> searchPageData = this.getPagedUserData(pageableData);
	...
	public B2BSelectionData removePermissionFromUserGroup(final String uid, final String permission)
	{
		...
		final B2BPermissionModel permissionModel = getB2BCommercePermissionService().removePermissionFromUserGroup(uid, permission);
	...
	@Override
	public CustomerData addMemberToUserGroup(final String usergroup, final String user)
	{
		...
		final CustomerData userData = this.getB2BUserConverter().convert(customerModel);
		if (userData != null)
		{
	...
	@Override
	public CustomerData removeMemberFromUserGroup(final String usergroup, final String user)
	{
		validateParameterNotNullStandardMessage("usergroup", usergroup);
		validateParameterNotNullStandardMessage("user", user);
