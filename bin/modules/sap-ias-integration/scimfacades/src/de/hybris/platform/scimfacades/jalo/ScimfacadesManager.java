 ...
 */
package de.hybris.platform.scimfacades.jalo;
...
/**
 * This is the extension manager of the Scimfacades extension.
 */
public class ScimfacadesManager extends GeneratedScimfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ScimfacadesManager.class);
	 ...
	 */
	public static ScimfacadesManager getInstance()
	{
		return (ScimfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ScimfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ScimfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of ScimfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ScimfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ScimfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
