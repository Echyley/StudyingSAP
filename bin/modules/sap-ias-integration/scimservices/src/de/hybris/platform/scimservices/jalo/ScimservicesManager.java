 ...
 */
package de.hybris.platform.scimservices.jalo;
...
import de.hybris.platform.scimservices.constants.ScimservicesConstants;



/**
 * This is the extension manager of the Scimservices extension.
 */
public class ScimservicesManager extends GeneratedScimservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ScimservicesManager.class);
	 ...
	 */
	public static ScimservicesManager getInstance()
	{
		return (ScimservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ScimservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ScimservicesManager() // NOPMD 
	{
		LOG.debug("constructor of ScimservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ScimservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ScimservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
