...
{
	private static final Logger LOG = LoggerFactory.getLogger(PunchOutUtils.class);
	private static final String XML_WITHOUT_STANDALONE = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";
	private static final String DOCTYPE = "<!DOCTYPE cXML SYSTEM \"http://xml.cXML.org/schemas/cXML/1.2.051/cXML.dtd\">";
	...
	public static final String SUPPORTED_TRANSACTION_URL_PATHS = "supportedTransactionURLPaths";
	...
	private static void safeClose(InputStream inputStream)
	{
		if (inputStream != null)
		{
			...
			{
				LOG.warn("internal error during safe close.");
			}
		}
	}
}
