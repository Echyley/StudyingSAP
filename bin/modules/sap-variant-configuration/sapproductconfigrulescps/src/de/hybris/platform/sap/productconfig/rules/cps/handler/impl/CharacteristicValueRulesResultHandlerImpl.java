...
public class CharacteristicValueRulesResultHandlerImpl implements CharacteristicValueRulesResultHandler
{
	...
	{
		final ProductConfigurationModel configModel = getPersistenceService().getByConfigId(configId, true);
		return configModel == null || configModel.getCharacteristicValueRulesResults() == null ? new ArrayList<>()
	...
	{
		return getModelService().create(CharacteristicValueRulesResultModel.class);
	}

	@Override
	public DiscountMessageRulesResultModel createMessageInstance()
	{
		return getModelService().create(DiscountMessageRulesResultModel.class);
	}
