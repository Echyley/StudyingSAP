...
public class ChangeableVariantIntegrationTest extends CPQFacadeLayerTest
{
	...
	private static final String VARIANT_CODE = "CONF_M_PIPE-30-15-ST";
	...
	private static KBKeyData KB_KEY_CONF_M_PIPE_30_15_ST;

	static
	{
		KB_KEY_CONF_M_PIPE_30_15_ST = new KBKeyData();
		KB_KEY_CONF_M_PIPE_30_15_ST.setProductCode(VARIANT_CODE);
	}
	...
	{
		final ConfigurationData configuration = cpqFacade.getConfiguration(KB_KEY_CONF_M_PIPE_30_15_ST);
