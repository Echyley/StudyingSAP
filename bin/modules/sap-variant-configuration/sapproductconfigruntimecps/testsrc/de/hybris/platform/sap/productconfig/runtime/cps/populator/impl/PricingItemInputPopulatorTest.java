...
/**
 * Unit test for {@link PricingItemInputPopulator}
 */
@UnitTest
public class PricingItemInputPopulatorTest
{
	...
	public void testFillVariantConditionsWithDiscounts()
	{
		...
		assertEquals(0, expectedFactor.compareTo(resultFactor));
	}
	...
	@Test(expected = IllegalStateException.class)
	public void testIsNotZeroErrorHandling()
	{
		classUnderTest.isNotZero("NotNumeric");
	}
