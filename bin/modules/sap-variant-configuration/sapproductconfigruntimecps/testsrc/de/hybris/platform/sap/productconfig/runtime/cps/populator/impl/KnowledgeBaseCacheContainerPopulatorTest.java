...
/**
 * Unit test for {@link KnowledgeBaseCacheContainerPopulator}
 */
@UnitTest
public class KnowledgeBaseCacheContainerPopulatorTest
{
	...
	@Test
	public void testPopulateProductsConversionNull()
	{
		final List<CPSMasterDataProduct> products = new ArrayList<>();
		final CPSMasterDataProduct product = new CPSMasterDataProduct();
		products.add(product);
		...
		Mockito.when(productConverter.convert(product)).thenReturn(null);
	...
	@Test
	public void testPopulateClassesConversionNull()
	{
		final List<CPSMasterDataClass> classes = new ArrayList<>();
		final CPSMasterDataClass clazz = new CPSMasterDataClass();
		classes.add(clazz);
		...
		Mockito.when(classConverter.convert(clazz)).thenReturn(null);
	...
	@Test
	public void testPopulateCharacteristicsConversionNull()
	{
		final List<CPSMasterDataCharacteristic> characteristics = new ArrayList<>();
		final CPSMasterDataCharacteristic characteristic = new CPSMasterDataCharacteristic();
		characteristics.add(characteristic);
		...
		Mockito.when(characteristicConverter.convert(characteristic)).thenReturn(null);
