...
/**
 * Unit test for {@link CPSConfigurationParentReferenceStrategyImpl}
 */
@UnitTest
public class CPSConfigurationParentReferenceStrategyImplTest
{
	...
	@Test
	public void testAddParentReferencesItem()
	{
		classUnderTest.addParentReferences(rootItem);
		//cannot set the configuration reference
		assertNull(rootItem.getParentConfiguration());
	}
}
