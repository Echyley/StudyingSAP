...
/**
 * Unit test for {@link InstancePopulator}
 */
@UnitTest
public class InstancePopulatorTest
{
	...
	@Test
	public void testPopulateRootUOMToMasterDataCacheWithParentConfiguration()
	{
	...
	@Test
	public void testPopulateRootUOMToMasterDataCacheWithoutParentConfiguration()
	{
		source.setParentConfiguration(null);
		classUnderTest.populateRootUOMToMasterDataCache(source, ctxt);
		// populate of UOM was not executed when parent is null
		assertNull(kbContainer.getRootUnitOfMeasure());
	}
