...
public interface ConfigurationMasterDataService
{
	...
	/**
	 * Get fallback master data by KB id if fallback locale is maintained for current locale and fallback is enabled.
	 * Otherwise returns null.
	 *
	 * @param kbId
	 *           id of the knowledgebase
	 * @return fallback knowledgebase data for the given id
	 */
	CPSMasterDataKnowledgeBaseContainer getFallbackMasterData(final String kbId);
