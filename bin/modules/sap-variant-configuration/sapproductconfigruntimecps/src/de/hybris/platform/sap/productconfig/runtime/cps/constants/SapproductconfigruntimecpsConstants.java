...
public final class SapproductconfigruntimecpsConstants extends GeneratedSapproductconfigruntimecpsConstants
{
	...
	/**
	 * Default constant that is used to replace an empty domain value internally. Will be overwritten from
	 * sapproductconfigruntimecps.emptyValueReplacement property.
	 */
	public static final String REPLACE_EMPTY_DOMAIN_VALUE = "_EMPTY";
