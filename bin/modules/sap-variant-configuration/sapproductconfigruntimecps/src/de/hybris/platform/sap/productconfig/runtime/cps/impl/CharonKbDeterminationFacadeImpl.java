...
public class CharonKbDeterminationFacadeImpl implements CharonKbDeterminationFacade
{
	...
	{
		final CPSCommerceExternalConfiguration externalConfigStructured;
		try
		{
		...
		return new KBKeyImpl(productCode, cpsKBKey.getName(), cpsKBKey.getLogsys(), cpsKBKey.getVersion());
	}
