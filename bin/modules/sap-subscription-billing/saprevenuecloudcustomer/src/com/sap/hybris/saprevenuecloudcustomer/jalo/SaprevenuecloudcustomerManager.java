 ...
 */
package com.sap.hybris.saprevenuecloudcustomer.jalo;
...
/**
 * This is the extension manager of the Saprevenuecloudcustomer extension.
 */
public class SaprevenuecloudcustomerManager extends GeneratedSaprevenuecloudcustomerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SaprevenuecloudcustomerManager.class);
	 ...
	 */
	public static SaprevenuecloudcustomerManager getInstance()
	{
		return (SaprevenuecloudcustomerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaprevenuecloudcustomerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaprevenuecloudcustomerManager() // NOPMD
	{
		LOG.debug("constructor of SaprevenuecloudcustomerManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SaprevenuecloudcustomerManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SaprevenuecloudcustomerManager called, current tenant: {}", getTenant().getTenantID());
	}
