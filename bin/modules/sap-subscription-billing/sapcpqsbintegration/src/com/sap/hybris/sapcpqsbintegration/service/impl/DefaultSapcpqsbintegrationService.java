...
/**
 * Default implementation of {@link SapcpqsbintegrationService}
 */
public class DefaultSapcpqsbintegrationService implements SapcpqsbintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpqsbintegrationService.class);
	...
	{
		return DefaultSapcpqsbintegrationService.class.getResourceAsStream("/sapcpqsbintegration/sap-hybris-platform.png");
	}
