 ...
 */
package com.sap.hybris.saprevenuecloudproduct.jalo;
...
/**
 * This is the extension manager of the Saprevenuecloudproduct extension.
 */
public class SaprevenuecloudproductManager extends GeneratedSaprevenuecloudproductManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SaprevenuecloudproductManager.class);
	 ...
	 */
	public static SaprevenuecloudproductManager getInstance()
	{
		return (SaprevenuecloudproductManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaprevenuecloudproductConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaprevenuecloudproductManager() // NOPMD 
	{
		LOG.debug("constructor of SaprevenuecloudproductManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SaprevenuecloudproductManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SaprevenuecloudproductManager called, current tenant: {}", getTenant().getTenantID());
	}
