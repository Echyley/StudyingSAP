 ...
 */
package com.sap.hybris.ysapcpircomsfulfillment.service.impl;
...
/**
 * Default implementation of {@link YsapcpircomsfulfillmentService}
 */
public class DefaultYsapcpircomsfulfillmentService implements YsapcpircomsfulfillmentService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultYsapcpircomsfulfillmentService.class);
	...
	private final static String FIND_LOGO_QUERY = "SELECT {" + ItemModel.PK + "} FROM {"
			+ CatalogUnawareMediaModel._TYPECODE + "} WHERE {" + MediaModel.CODE + "}=?code";
	...
	{
		return DefaultYsapcpircomsfulfillmentService.class.getResourceAsStream("/ysapcpircomsfulfillment/sap-hybris-platform.png");
	}
