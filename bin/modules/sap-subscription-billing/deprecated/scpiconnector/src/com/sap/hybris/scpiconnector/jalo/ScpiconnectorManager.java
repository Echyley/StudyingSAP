 ...
 */
package com.sap.hybris.scpiconnector.jalo;
...
/**
 * This is the extension manager of the Scpiconnector extension.
 */
public class ScpiconnectorManager extends GeneratedScpiconnectorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ScpiconnectorManager.class);
	 ...
	 */
	public static ScpiconnectorManager getInstance()
	{
		return (ScpiconnectorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ScpiconnectorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ScpiconnectorManager() // NOPMD 
	{
		LOG.debug("constructor of ScpiconnectorManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ScpiconnectorManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ScpiconnectorManager called, current tenant: {}", getTenant().getTenantID());
	}
