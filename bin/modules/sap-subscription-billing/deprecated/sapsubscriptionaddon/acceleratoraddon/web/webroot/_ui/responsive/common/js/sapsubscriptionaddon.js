...
if ($("#quickOrder").length > 0) {
    ...
    $(document).ready(function() {
    	...
    	const extensionPeriod = "#extensionPeriod";
        ...
        $(document).on("click", '#viewCharges', function(e){
            e.preventDefault();
            const entryNumber =  $(this).data("entryNumber");
        ...
        $(document).on("click", '#detailedCharges', function(e){
            e.preventDefault();
            const ratePlanId =  $(this).data("ratePlanId");
            ACC.colorbox.open('Detailed Charges',{
                        html : $(document).find("#pricepanel_"+ratePlanId).html(),
                        maxWidth:"150%",
                        width:"1250px",
                        initialWidth :"380px"
                    });
         ...
         $(document).on("click", '#detailedChargesWithDiscounts', function(e){
            e.preventDefault();
            var url = $(this).data("viewChargesUrl");
            var formData = getFormData($("#subscriptionRatePlanForm"));
            ACC.colorbox.open('Detailed Charges With Discounts',{
                type: "post",
                href: url,
                data: formData,
                maxWidth:"150%",
