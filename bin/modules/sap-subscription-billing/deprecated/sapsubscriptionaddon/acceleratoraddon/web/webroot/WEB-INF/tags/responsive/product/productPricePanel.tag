			...
			<c:otherwise>
				<c:choose>
					<c:when test="${not empty product.subscriptionTerm}">
                        ...
                        <%--Minimum Term--%>
                        <c:if test="${not empty product.minimumTerm}">
                            <div class="tr">
                                <div class="td">
                                     <spring:theme code="text.product.minimumTerm"/>: ${product.minimumTerm} &nbsp;<spring:theme code="text.product.usage.months"/>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${not empty product.subscriptionValidTerm}">
                            <div class="tr">
                                <div class="td">
                                     <spring:theme code="text.product.subscriptionValidTerm"/>: ${product.subscriptionValidTerm} &nbsp;<spring:theme code="text.product.usage.months"/>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${not empty product.renewalTerm}">
                            <div class="tr">
                                <div class="td">
                                     <spring:theme code="text.product.renewalTerm"/>: ${product.renewalTerm} &nbsp;<spring:theme code="text.product.usage.months"/>
                                </div>
                            </div>
                        </c:if>
                        <br>
                            ...
                            <c:choose>
								...
								<c:when test="${usageCharge['class'].simpleName eq 'PerUnitUsageChargeData' and usageCharge.usageChargeType.code == 'percentage_usage_charge'}">
									<c:forEach items="${usageCharge.usageChargeEntries}" var="usageChargeEntry">
                                        ...
                                        <div class="tr">
				                        	<div class="td">
				                        		<spring:theme code="text.product.usage.includedratio"/> :
				                        	</div>
				                            <div class="td">
				                        		${usageCharge.ratio} &nbsp;
				                            </div>
