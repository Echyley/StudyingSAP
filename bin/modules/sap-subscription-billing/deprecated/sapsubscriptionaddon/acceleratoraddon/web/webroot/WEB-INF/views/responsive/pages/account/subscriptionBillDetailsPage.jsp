							...
							<div class="col-sm-6 col-md-4 order-billing-address">
								...
								<c:forEach items="${bill.charges}" var="charge">
									<div class="table">
	                                        ...
	                                        <c:if test="${charge.netAmount!=null}">
											<div class="value-order">
												<div class="tr">
													<div class="td">
														<spring:theme
                                            ...
                                            <c:if test="${charge.grossAmount!=null}">
	                                        <div class="value-order">
                                            	<div class="tr">
                                            		<div class="td">
                                            			<spring:theme
                                            				code="text.account.subscriptions.bill.grossAmount" /> :
                                            				</div>
                                            			<div class="td">
                                            		<format:price priceData="${charge.grossAmount}"></format:price>
                                            	    </div>
                                                 </div>
                                            </div>
                                             </c:if>
							       ...
							       <c:forEach items="${bill.credits}" var="credit">
                            									<div class="table">
                            											...
                            											<div class="order-ship-to"
                            												...
                            												<div class="label-order">
                            													<div class="tr">
                            														<div class="td">
                            															<c:if test="${not empty credit.name}">
                            																${credits.name}
                            															</c:if>&nbsp;
                            														<spring:theme
                            																code="text.account.subscriptions.bill.credits"/>
                            														</div>
                            													</div>
                            												</div>
                            											</div>
                            	                                        <c:if test="${credit.netAmount!=null}">
                            											<div class="value-order">
                            												<div class="tr">
                            													<div class="td">
                            														<spring:theme
                            													...
                            													<div class="td">
                            														<format:price priceData="${credit.netAmount}"></format:price>
                            													</div>
                            												</div>
                            											</div>
                                                                        </c:if>
                                                                        <c:if test="${credit.grossAmount!=null}">
                            	                                        <div class="value-order">
                                                                        	<div class="tr">
                                                                        		<div class="td">
                                                                        			<spring:theme
                                                                        			...
                                                                        			<div class="td">
                                                                        		<format:price priceData="${credit.grossAmount}"></format:price>
                                                                        	    </div>
                                                                             </div>
                                                                        </div>
                                                                         </c:if>
                            											...
                            											<div class="value-order">
                            												<div class="tr">
                            													...
                            													<div class="td">
                            														<fmt:formatDate value="${credit.fromDate}" dateStyle="long" timeStyle="short" type="date" />
                            														<c:if test="${credit.toDate!=null}">
                            															&nbsp;<spring:theme code="text.account.subscription.bill.tillDate" />&nbsp;
                            															<fmt:formatDate value="${credit.toDate}" dateStyle="long" timeStyle="short" type="date" />
                            														</c:if>
                            													</div>
                            												</div>
                            											</div>
                            											<c:if test="${credit.usage!=null}">
                            												<div class="value-order">
                            													<div class="tr">
                            														<div class="td">
                            															<spring:theme code="text.account.subscription.bill.usage" /> :
