...
public class SAPSubscriptionAddonDefaultExpressCheckoutIntegrationCheckoutTest extends DefaultExpressCheckoutIntegrationCheckoutTest{
	...
	@Override
	@Test
	public void testExpressCheckoutForPickupOnlyCart() {
		assertTrue(true);
	}
	
	@Override
	@Test
	public void testExpressCheckoutForShippingCart() {
		assertTrue(true);
	}
}
