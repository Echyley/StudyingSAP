...
import de.hybris.platform.sap.sapsubscriptionaddon.constants.SapsubscriptionaddonConstants;



/**
 * This is the extension manager of the Sapsubscriptionaddon extension.
 */
public class SapsubscriptionaddonManager extends GeneratedSapsubscriptionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapsubscriptionaddonManager.class.getName());
	 ...
	 */
	public static SapsubscriptionaddonManager getInstance()
	{
		return (SapsubscriptionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapsubscriptionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapsubscriptionaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapsubscriptionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapsubscriptionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapsubscriptionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
