 ...
 */
package com.sap.hybris.sapimpeximportadapter.jalo;
...
/**
 * This is the extension manager of the Sapimpeximportadapter extension.
 */
public class SapimpeximportadapterManager extends GeneratedSapimpeximportadapterManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapimpeximportadapterManager.class);
	 ...
	 */
	public static SapimpeximportadapterManager getInstance()
	{
		return (SapimpeximportadapterManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapimpeximportadapterConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapimpeximportadapterManager() // NOPMD 
	{
		LOG.debug("constructor of SapimpeximportadapterManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapimpeximportadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapimpeximportadapterManager called, current tenant: {}", getTenant().getTenantID());
	}
