 ...
 */
package com.sap.hybris.scpiconnectorbackoffice.jalo;
...
import com.sap.hybris.scpiconnectorbackoffice.constants.ScpiconnectorbackofficeConstants;
 ...
 */
public class ScpiconnectorbackofficeManager extends GeneratedScpiconnectorbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ScpiconnectorbackofficeManager.class.getName());
	 ...
	 */
	public static ScpiconnectorbackofficeManager getInstance()
	{
		return (ScpiconnectorbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ScpiconnectorbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ScpiconnectorbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ScpiconnectorbackofficeManager called.");
		}
	}
