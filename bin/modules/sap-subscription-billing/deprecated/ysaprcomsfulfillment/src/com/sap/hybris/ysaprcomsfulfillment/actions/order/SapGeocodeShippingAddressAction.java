 ...
 */
public class SapGeocodeShippingAddressAction extends AbstractProceduralAction<OrderProcessModel>
{
    private static final Logger LOG = Logger.getLogger(SapGeocodeShippingAddressAction.class);
