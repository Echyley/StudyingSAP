 ...
 */
package com.sap.hybris.ysaprcomsfulfillment.constants;

/**
 * Constants used in ysaprcomsfulfillment extension, e.g. process name, event name, ...
 */
@SuppressWarnings("deprecation")
public final class YsaprcomsfulfillmentConstants extends GeneratedYsaprcomsfulfillmentConstants
{
