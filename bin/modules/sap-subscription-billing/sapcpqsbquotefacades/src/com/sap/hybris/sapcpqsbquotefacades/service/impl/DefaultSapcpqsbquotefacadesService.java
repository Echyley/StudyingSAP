...
/**
 * Default implementation of {@link SapcpqsbquotefacadesService}
 */
public class DefaultSapcpqsbquotefacadesService implements SapcpqsbquotefacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapcpqsbquotefacadesService.class);
	...
	{
		return DefaultSapcpqsbquotefacadesService.class.getResourceAsStream("/sapcpqsbquotefacades/sap-hybris-platform.png");
	}
