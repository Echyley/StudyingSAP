...
public class DefaultSubscriptionServiceTest {
    ...
    public void cancelSubscription() throws SubscriptionServiceException {
        ...
        defaultSubscriptionService.cancelSubscription(SUBSCRIPTION_ID, cancellationRequest);
        Mockito.verify(defaultSubscriptionService).cancelSubscription(SUBSCRIPTION_ID, cancellationRequest);
    }
