...
public class SapRevenueCloudOrderConversionServiceTest {
    ...
    public void convertOrderToSapCpiOrder_b2bCustomer_success() {
        ...
        lenient().doReturn(b2BUnit).when(mockB2bUnitService).getParent(b2BCustomerModel);
        lenient().when(mockB2bUnitService.getRootUnit(b2BUnit)).thenReturn(rootUnit);
        lenient().when(mockConfigurationService.getConfiguration()).thenReturn(mockConfiguration);
    ...
    public void populatePaymentDetails_defaultPayment_success() {
        ...
        verify(sapRevenueCloudOrderConversionService).populatePaymentDetails(sapCpiOutboundOrderModel, paymentInfoModel2);
    }
    ...
    public void populatePaymentDetails_creditCardPaymentInfoModel_success() {
        ...
        verify(sapRevenueCloudOrderConversionService).populatePaymentDetails(sapCpiOutboundOrderModel, paymentInfoModel);
    }
    ...
    public void populateOrderItems_success() {
        ...
        lenient().when(mockCommercePriceService.getSubscriptionPricePlanForProduct(any(ProductModel.class)))
        ...
        verify(sapRevenueCloudOrderConversionService).populateOrderItems(sapCpiOutboundOrderModel, orderModel);
    }
}