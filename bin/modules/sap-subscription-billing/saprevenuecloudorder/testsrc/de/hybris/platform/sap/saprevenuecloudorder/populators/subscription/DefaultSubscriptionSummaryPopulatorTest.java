...
public class DefaultSubscriptionSummaryPopulatorTest {
    ...
    public void setup(){
        ...
        pricingParameter.setCode("one Time");
        pricingParameter.setValue("100");
        ...
        final List<ExternalObjectReference> externalObjectReferenceList = new LinkedList<>();
        ExternalObjectReference externalObjectReference = new ExternalObjectReference();
        externalObjectReference.setExternalId("123");
        externalObjectReference.setExternalIdTypeCode("testcode");
        externalObjectReference.setExternalSystemId("commerce.com");
        ...
        item.setExternalObjectReferences(externalObjectReferenceList);
        items.add(item);
    ...
    public void populate_success() throws SubscriptionServiceException {
        ...
        Assert.assertEquals(productModel.getName(),target.getName());
